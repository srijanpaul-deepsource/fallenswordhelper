import{i as n}from"./interceptSubmit-6c866cd4.js"
...
import{T as g,a6 as b,x as k,q as w,v as L,a7 as v,u as _,$ as y,I as x,D as C,Q as O,A as P,B as j,a8 as q,a9 as S}from"./calfSystem-bfc1f6c0.js"
...
return t%=60,`${T(e," hours, ")+t} mins`}(n)}function nn(){const n=C("#pCC table").insertRow(-1)
!function(n){const t=n.insertCell(-1)
t.height=25,P("Last Reset:",t)}(n),function(n){const t=n.insertCell(-1)
t.align="right",j(Z(),t)}(n)}function tn(){n(),x("trackLadderReset")&&nn(),X()}export default tn
//# sourceMappingURL=ladder-c5393019.js.map
