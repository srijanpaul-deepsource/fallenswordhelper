import{b2 as e,t as n,I as t,bF as a,a9 as s,a5 as l,_ as i,av as r,y as o,o as f,f as u,v as c}from"./calfSystem-bfc1f6c0.js"
import{c as h}from"./currentGuildId-92fe6d54.js"
import{i as d}from"./intValue-e4ce6bb5.js"
import{a as p,g as v}from"./levelHighlight-3a72b3fa.js"
import{n as m}from"./numberIsNaN-2f104aa2.js"
import{l as g,p as y}from"./lvlTests-4fdba93f.js"
import{l as M}from"./loadDataTables-e7b030ee.js"
import{o as L}from"./onlinePlayersPage-4607b348.js"
import{g as b,s as P}from"./idb-d8a4a427.js"
...
for(let n=2;n<=G;n+=1)L(n).then(e)}function F(e){$("#fshOutput",_).append(e)}function V(e){F(` ${z+1}`)
const t=c(e),a=$("#pCC input.custominput",t).first()
!function(e,t){const a=t.attr("value")
$('#pCC img[src$="/world/icon_action_view.png',e).parent().parent().parent().each(n(S,a))}(t,a),z+=1,1===z&&A(V,a),z===G&&(P("fsh_onlinePlayers",D),H(D))}function W(e){"fshRefresh"===e.target.id&&($("#fshRefresh",_).hide(),z=0,D={},L(1).then(V),i("lastOnlineCheck",s),F("Parsing online players...")),"fshReset"===e.target.id&&function(e){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",e).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",e).val(r.onlinePlayerMaxLvl),O()}(_)}function B(){_.html(`<span><b>Online Players</b></span>${function(){const e=t("lastOnlineCheck")
return s-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),b("fsh_onlinePlayers").then(H),f(_[0],W),u(_[0],"keyup",k)}function E(e){o()||(_=e?$(e):$("#pCC"),M().then(B))}export default E
//# sourceMappingURL=injectOnlinePlayers-00d1b8b5.js.map
