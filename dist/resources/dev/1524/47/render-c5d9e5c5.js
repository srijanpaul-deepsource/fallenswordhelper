import{t,I as n,b2 as s,c as e,T as f,b as o,p as u,C as a,ah as c,l as r,B as i,z as l,e as p}from"./calfSystem-bfc1f6c0.js"
import{r as b}from"./roundToString-042f58fd.js"
import{p as d}from"./playerName-3c8c8393.js"
...
const r=function(){let t=o("h1",u)
return t=0!==t.length?a(t[0]):d(),t}()
...
let s,e
n?(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=n[0].match(/([+-]?[.\d]+)/)):(s="unknown",e="1"),j.buffs[a(t)]=[parseFloat(e),s],j.count+=1}(t):(j.count-=1,delete j.buffs[s]),j.count>0?N():(i("&nbsp;",l("buffCost")),j.buffCostTotalText="")}function L(t){return t.tagName&&"SPAN"!==t.tagName?L(t.parentNode):t}function A(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&$(t)}(j)
...
//# sourceMappingURL=render-c5d9e5c5.js.map
