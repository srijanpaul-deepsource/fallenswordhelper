...
import{a4 as a,t as s,ah as r,V as n,B as o,p as c,h as i,m as l,f as u,o as d}from"./calfSystem-bfc1f6c0.js"
import{c as g}from"./createInput-02002827.js"
import{c as f}from"./createSelect-9df19b0f.js"
import{c as p}from"./createTable-57eae8d3.js"
import{l as h,d as E}from"./lastActivityToDays-f1677a5c.js"
import{c as m}from"./createTBody-6a96517d.js"
import{c as b}from"./createTr-a7569eaa.js"
import{g as A}from"./guildStore-0e0c654d.js"
import{a as y}from"./addCommas-27b35f1c.js"
...
return e})(),i=K("sort"),l=K("slice"),u=K("filter"),d=K("search")
...
i(s,a),i(t,s)
const r=ot({table:e})
u(a,"change",(t=>{r.changePageSize(Number(t.target.value))}))}(n,m),function(t,a){const s=l({className:"fsh-search-wrapper"}),r=g({dataset:{stSearch:"name, rank_name",stSearchFlags:"i"},placeholder:"Enter search term",required:!0,type:"text"}),n=e({innerHTML:"&times;",type:"button"}),o=rt({table:a})
d(n,(()=>{r.value="",r.focus(),o.search("")})),i(s,r),i(s,n),i(t,s)}(n,m),function(t,e,a){const s=l()
i(t,s),ot({table:e}).onSummaryChange((({page:t,size:e,filteredCount:r})=>{let n=0
r&&(n=1),o(`showing ${(t-1)*e+n} - ${Math.min(r,t*e)} of ${r} (${a.length} total)`,s)}))}(E,m,a),function(t,a){const s=l(),r=e({innerHTML:"«"}),n=e({innerHTML:"‹"}),c=e({disabled:!0,innerHTML:"1"}),u=e({innerHTML:"›"}),g=e({innerHTML:"»"})
let f=1
const p=ot({table:a})
p.onSummaryChange((({page:t,size:e,filteredCount:a})=>{r.disabled=!p.isPreviousPageEnabled(),n.disabled=!p.isPreviousPageEnabled(),u.disabled=!p.isNextPageEnabled(),g.disabled=!p.isNextPageEnabled(),o(t,c),f=Math.ceil(a/e)})),d(r,(()=>p.selectPage(1))),d(n,(()=>p.selectPreviousPage())),d(u,(()=>p.selectNextPage())),d(g,(()=>p.selectPage(f))),i(s,r),i(s,n),i(s,c),i(s,u),i(s,g),i(t,s)}(E,m)
...
//# sourceMappingURL=whosGotWhat-df68189e.js.map
