import{r as e,A as t,t as n,al as s,ab as o,_ as a,as as i,C as c,m as r,P as l,W as m,i as p,at as u,D as d,h as f,o as g,p as b,z as h,c as v,au as C,B as S,a6 as E,j,H as k,y as N,J as x}from"./calfSystem-c07e3259.js"
import{r as y,g as A}from"./rnd-e579b276.js"
import{p as $,s as B}from"./pubsub-c8931f26.js"
import{c as L}from"./createInput-a08cdf48.js"
import{c as q}from"./createTable-b1dbea45.js"
import{g as I}from"./getArrayByClassName-abf6bba3.js"
import{i as F}from"./insertElementAfter-6171d8e9.js"
import{i as P}from"./insertHtmlAfterEnd-3b1fe1ac.js"
...
return 0===s&&h(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],L({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function W(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function G(e){return[e.value,e.text]}function K(e,t,s){const o=function(e,t,s){const o=q({id:"fshFastCompose"})
return D(o,s),e.reduce(n(W,t,s),o)}(d("#composing-template-multi option").map(G),t,s)
f(e,o),g(b,M),B("quickcreate",n(J,o))}function O(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-e9158ea7.js.map
