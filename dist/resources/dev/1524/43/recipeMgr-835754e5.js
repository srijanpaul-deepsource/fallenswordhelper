import{d as t}from"./doSortParams-a28ca507.js"
import{I as e,aG as n,B as i,z as r,g as s,v as a,i as o,t as c,C as d,ai as p,aI as u,M as f,m,h,u as l,y as g,o as $,p as b}from"./calfSystem-3cb2f93e.js"
import{s as v,g as x}from"./idb-c9ce87e3.js"
import{s as _}from"./shouldBeArray-4c9f25ec.js"
import{a as y}from"./stringSort-9e5fee14.js"
...
return N(i)}function z(t){return/\/folder_on\./.test(t.getAttribute("src"))}function M(t,e){return 0!==e}function G(t){return t.value}function D(t,e,n){return u(`${t}&page=${n}`).then(e)}function H(t,e,n){return function(t){return s("option",f("customselect",r("pCC",t))[0]).filter(M).map(G)}(t).map(c(D,e,n))}function J(t,e,n){const i=a(n),r=function(t){return B(t).find(z).parentNode.href}(i),s=c(q,t,e),o=H(i,r,s)
...
return i&&o(t,`Skipping folder "${n}"  as it has the word "quest" in folder name.<br>`),!i}function Q(t,e){return u(e.parentNode.href).then(t)}function U(t,e,n){const i=c(J,t,e),r=function(t,e,n){return B(a(e)).filter(K).filter(c(O,t)).map(c(Q,n))}(t,n,i)
...
//# sourceMappingURL=recipeMgr-835754e5.js.map
