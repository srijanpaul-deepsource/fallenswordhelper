import{aZ as n,t as e,I as t,bA as a,a8 as s,a6 as l,a0 as i,ar as r,y as o,o as f,f as u,v as c}from"./calfSystem-3cb2f93e.js"
import{c as h}from"./currentGuildId-a71d60fb.js"
import{i as d}from"./intValue-fefb28df.js"
import{a as p,g as v}from"./levelHighlight-59ab7a56.js"
import{n as m}from"./numberIsNaN-885a5556.js"
import{l as g,p as y}from"./lvlTests-948a22c7.js"
import{l as M}from"./loadDataTables-351ff0a1.js"
import{o as L}from"./onlinePlayersPage-2e0f56f1.js"
import{g as b,s as P}from"./idb-c9ce87e3.js"
...
$('#pCC img[src$="/world/icon_action_view.png',n).parent().parent().parent().each(e(H,a))}(t,a),z+=1,1===z&&S(W,a),z===A&&(P("fsh_onlinePlayers",D),G(D))}function Z(n){"fshRefresh"===n.target.id&&($("#fshRefresh",_).hide(),z=0,D={},L(1).then(W),i("lastOnlineCheck",s),V("Parsing online players...")),"fshReset"===n.target.id&&function(n){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",n).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",n).val(r.onlinePlayerMaxLvl),O()}(_)}function B(){_.html(`<span><b>Online Players</b></span>${function(){const n=t("lastOnlineCheck")
return s-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),b("fsh_onlinePlayers").then(G),f(_[0],Z),u(_[0],"keyup",k)}function E(n){o()||(_=n?$(n):$("#pCC"),M().then(B))}export default E
//# sourceMappingURL=injectOnlinePlayers-9b64aff9.js.map
