import{n as t,u as s,v as a,D as e,N as n,H as r,$ as i,m as l,h as c,a as o,t as d,a5 as u,aj as f,B as m,ak as p,i as v,y as h,b,p as j,c as g,K as y,aa as C,C as A}from"./calfSystem-186455ab.js"
import{g as B}from"./getMembrList-c6679e1f.js"
import{a as D}from"./addCommas-fa3f11ee.js"
import{a as k}from"./allthen-e8de2991.js"
import{g as w}from"./guild-7919b015.js"
import{i as S}from"./intValue-1ce02c09.js"
import{c as T}from"./createTable-4ac162e1.js"
import{r as R}from"./replaceChild-b7da266a.js"
import{i as x}from"./insertHtmlAfterEnd-f3689d6c.js"
import{l as G}from"./loadDataTables-0667a93b.js"
...
function E(s){return t("tfoot",s)}function L(t){return w({subcmd:"advisor",subcmd2:"view",period:t})}function M(t){return{player:{level:0,name:r(t.cells[0])},stats:[3,4,5,6,7,9,1,2,8].map((s=>{return a=t.cells[s],S(r(a))
...
k(s,d(tt,t)),p("guildAdvisor.injectAdvisorWeekly")}(t):B(!1).then(d(et,t))}function rt(){if(h())return
const t=b("table",j)[1]
t&&G().then((()=>nt(t)))}export default rt
//# sourceMappingURL=guildAdvisor-fa4b0524.js.map
