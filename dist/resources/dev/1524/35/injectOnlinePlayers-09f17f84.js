import{aS as n,t as e,I as t,bz as a,a8 as s,a6 as l,a0 as i,ai as r,y as o,o as f,f as u,v as c}from"./calfSystem-186455ab.js"
import{c as h}from"./currentGuildId-7dd95943.js"
import{i as d}from"./intValue-1ce02c09.js"
import{a as p,g as v}from"./levelHighlight-92a5e76a.js"
import{n as m}from"./numberIsNaN-1e8b4508.js"
import{l as g,p as y}from"./lvlTests-b430a512.js"
import{l as M}from"./loadDataTables-0667a93b.js"
import{o as L}from"./onlinePlayersPage-ec876df5.js"
import{g as b,s as P}from"./idb-97f66b86.js"
...
$('#pCC img[src$="/world/icon_action_view.png',n).parent().parent().parent().each(e(H,a))}(t,a),D+=1,1===D&&A(W,a),D===S&&(P("fsh_onlinePlayers",z),G(z))}function B(n){"fshRefresh"===n.target.id&&($("#fshRefresh",_).hide(),D=0,z={},L(1).then(W),i("lastOnlineCheck",s),V("Parsing online players...")),"fshReset"===n.target.id&&function(n){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",n).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",n).val(r.onlinePlayerMaxLvl),O()}(_)}function E(){_.html(`<span><b>Online Players</b></span>${function(){const n=t("lastOnlineCheck")
return s-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),b("fsh_onlinePlayers").then(G),f(_[0],B),u(_[0],"keyup",k)}function F(n){o()||(_=n?$(n):$("#pCC"),M().then(E))}export default F
//# sourceMappingURL=injectOnlinePlayers-09f17f84.js.map
