import{a as t}from"./addGuildLogWidgets-63885f80.js"
import{a as e}from"./addLogColoring-cd83cb50.js"
import{a as s}from"./all-be4763d3.js"
import{u as i,t as n,bs as o,bt as a,y as d,B as c,p as r,o as h,g as l,A as f,z as u,I as p,v as m,D as b,C as g,K as k,i as y,H as w}from"./calfSystem-c464cb1d.js"
import{c as j}from"./createTable-8b5b7f23.js"
import{e as L}from"./eventHandler5-00bcdb12.js"
import{f as R}from"./functionPasses-5a92ba59.js"
import{h as N}from"./hideElement-512851a2.js"
import{p as v}from"./parseDateAsTimestamp-858e07af.js"
import{s as G}from"./selfIdIs-6d227f88.js"
import{t as x}from"./toggleForce-4ff42c01.js"
import{g as H,s as T}from"./idb-870991e0.js"
import"./dataRows-ddba9ba2.js"
import"./playerName-c64906b6.js"
import"./searchPlayerHref-3fbab12d.js"
...
const e=b('input[name="page"]',_)
e&&(z=Number(e.value),U=Number(/\d+/.exec(g(e.parentNode))[0]),1===z&&($=Math.min(U,F)),f(`Loading ${z} of ${$}...`,M))}(t),Y()}function X(t){Q.push([0].concat(t))}function Z(){T("fsh_guildLog",K)}function tt(t,e){return e[1]!==t}function et(t){return t.slice(1,5)}function st(t,e){const s=t.insertCell(-1)
...
r.replaceChild(q,s),e("myGuildLog",1,3),t()}()}function ct(t){J(t),function(){const t=[]
...
K.checks[e]=!K.checks[e],Z(),Q.forEach(n(rt,e,!K.checks[e]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){K.checks=D.slice(0),ot(),Q.forEach(ft)}function pt(t){N(t[5]),N(t[6])}function mt(){K.checks=O.slice(0),ot(),Q.forEach(pt)}function bt(){K.log=!1,Z(),f("Loading Page 1 ...",M),Q=[],V=!0,c("",u("fshInjectHere")),I(1).then(ct)}function gt(t){!function(t){K=t||K,K.checks=K.checks||D.slice(0)}(t),c(E,r),B=u("fshNewGuildLog"),M=u("fshOutput"),h(B,L([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),bt]])),ot(),F=Number(p("newGuildLogHistoryPages")),$=F,I(1).then(ct)}function kt(){d()||H("fsh_guildLog").then(gt)}export default kt
//# sourceMappingURL=newGuildLog-8c9dc6ff.js.map
