import{S as t,i as o,s as e,e as s,t as a,g as i,a as n,b as c,l as r,n as l,d as u,f as p,r as m,q as f}from"./index-b63851a0.js"
import{I as d,T as b,aF as h,aw as g,c as j,c9 as k,O as x,ca as y,bN as T,bC as q,s as v,X as $,D as S}from"./calfSystem-c464cb1d.js"
import{c as G}from"./currentGuildId-72946831.js"
import{a as w}from"./getIsOwnGuild-90e12db9.js"
import{a as B}from"./profile-64e993f7.js"
import{o as J}from"./openQuickBuffByName-3ae950c8.js"
...
function i(t){$("profile","quick button",t)}return[o,e,a,function(t){t.target.blur(),i("quickbuff"),J(a)},function(){i("join groups"),k()},function(){i("auctions"),x(`${y}&type=-3&tid=${s}`)},function(){i("secure trade"),x(`${T}${a}`)},function(){i("recall items"),x(`${q}${a}`)},function(){i("rank"),x(`${v}members&subcmd2=changerank&member_id=${s}`)}]}class C extends t{constructor(t){super(),o(this,t,A,N,e,{})}}function D(){const t=S('#profileLeftColumn img[src*="/avatars/"][width="200"]')
t&&new C({anchor:t.nextElementSibling,target:t.parentNode})}export default D
//# sourceMappingURL=profileInjectQuickButton-49dd3f8e.js.map
