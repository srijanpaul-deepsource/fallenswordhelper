import{u as e,C as t,D as n,bH as s,I as a,V as r,a0 as i,z as o,q as c,H as l,c as u,m as f,bL as d,bJ as b,B as p,bQ as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-c464cb1d.js"
import{f as $}from"./functionPasses-5a92ba59.js"
import{s as w}from"./shouldBeArray-0b48195f.js"
import{i as N}from"./insertElementAfterBegin-1e95816f.js"
import{c as x}from"./createSpan-79ff8b4f.js"
...
A.bounty.push(n)}}(e)}function P(){return A&&r-A.lastUpdate>H||T&&r-T.lastUpdate>H}function E(e){const t=e[6]
...
function J(){return f({className:"minibox"})}function K(){b("bountyList",A),p("",q)
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=r,n&&M(n),j=!0}(e),K())}function Y(e){const t=L(e)
F(t),u.enableWantedList&&(V(t),D<I?R(D+1).then(Y):Q())}const Z=[()=>!A,()=>!T,()=>S]
function _(e,t){A=s("bountyList"),T=s("wantedList"),H=a("bountyListRefreshTime"),S=a("bwNeedsRefresh"),S||P()&&(S=!0),Z.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,W=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(Y)):function(e,t){t&&(T.isRefreshed=!1,Q()),e&&(A.isRefreshed=!1,K())}(e,t)}function ee(e){e.target===X&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=J(),N(d,G)),u.enableActiveBountyList&&(q=J(),N(d,q)),q&&v(q,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-fee5d4ca.js.map
