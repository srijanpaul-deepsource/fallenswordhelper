...
import{ag as e,E as a,e as s,t as r,ah as o,d as i,R as c,x as f,q as l,y as d,X as u,ai as m,aj as p}from"./calfSystem-d56087e1.js"
import{s as v,g as h}from"./idb-a1e4e2c2.js"
import{i as b}from"./intValue-ba9b9e5a.js"
import{c as g}from"./changeMinMax-a6e17992.js"
import{f as x,a as y,m as L,t as M}from"./assets-40e3d434.js"
import{l as T,p as j}from"./lvlTests-a778f69b.js"
import{i as _}from"./interceptSubmit-1b6b81ff.js"
import{l as k}from"./loadDataTables-851264f9.js"
import{c as w}from"./currentGuildId-1893e725.js"
import{s as q}from"./setTipped-f59a320f.js"
...
e&&(!function(n,t){F.moves[n[1]]&&3===F.moves[n[1]]&&t.addClass("moveMax")}(e,t),n.attr("data-order",e[1]))}function V(n,t){const e=$(t),a=e.children()
...
1===t.children(i).length&&t.attr("data-order",t.find("td").first().text().replace(/[,\s]/g,""))}(a)}const X=n=>[n,Number(n.previousElementSibling.value)]
...
var e})(n,e)&&Q(t)}function W(n,t,e){q(e.players.map(r(P,n)).join("<br>"),t),t.classList.add("tip-static"),n&&"Join"===t.value&&function(n,t,e){e.players.filter((t=>t.guild_id===n)).length===e.max_players/4&&Q(t)}(n,t,e)}const Y=[e,n=>c(n.players),n=>n.players.length>0]
function Z(n,[t,,e]){Y.every((n=>n(e)))&&W(n,t,e)}function nn(n){if(!n||!n.s||!e(n.r))return
const t=function(n){return a('#arenaTypeTabs tr:not([style="display: none;"]) input[type="submit"]').map(X).map(r(K,n))}(n)
...
$("a",e).contents().unwrap(),$(t).prepend($("<thead/>").append(e))}function on(){B(),D(),$.fn.dataTable.ext.search.push(z),$.fn.dataTable.ext.search.push(A)}function cn(n,[t,o,i]){const c=$('table[width="635"]',n)
c.each(rn),function(n){F=n||{},C=F.id||{},F.id={}}(t),function(n){n.children("tbody").children("tr").each(V)}(c),function(n){if(!e(n))return
...
v("fsh_arenaFull",o)}(o),nn(i),on(),c.DataTable(M),function(n){$(tn,n).off("click"),n.on("click",tn,en)}(n)}function fn(n,t){m("arena.process"),a('#arenaTypeTabs tr[style="display: none;"]').forEach((n=>n.remove())),cn(n,t),_(),p("arena.process")}function ln(){if(d())return
...
//# sourceMappingURL=arena-a2bdc8b8.js.map
