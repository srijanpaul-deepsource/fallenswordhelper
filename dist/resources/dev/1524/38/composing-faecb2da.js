import{r as e,B as t,t as n,an as s,ad as o,a0 as a,au as i,D as c,m as r,Q as l,X as m,i as p,av as u,E as d,h as f,o as g,p as h,A as b,c as v,aw as C,C as S,a8 as E,j,I as k,z as N,K as x}from"./calfSystem-d56087e1.js"
import{r as A,g as y}from"./rnd-e8cb70da.js"
import{p as $,s as B}from"./pubsub-6238033b.js"
import{c as I}from"./createInput-0182b589.js"
import{c as L}from"./createTable-5e7fa021.js"
import{g as q}from"./getArrayByClassName-e1c1fd86.js"
import{i as F}from"./insertElementAfter-d412efe4.js"
import{i as T}from"./insertHtmlAfterEnd-9b0a51ca.js"
import{i as w}from"./insertElementBefore-71272774.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],I({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function X(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function G(e){return[e.value,e.text]}function J(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
...
0===t?W(!0):(W(!1),a(C,t))}(),d("input[id^=create-]:not(#create-multi)",h).forEach(Y),g(h,Z),function(){if(k("moveComposingButtons")){const e=N("composing-error-dialog").previousElementSibling
...
//# sourceMappingURL=composing-faecb2da.js.map
