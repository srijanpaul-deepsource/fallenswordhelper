import{N as o,t as n,o as t,a6 as e,z as c,f as r,a0 as a,aJ as f}from"./calfSystem-817ceb25.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],N(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function L(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(j)}function F(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(L,o))}(e.prefName),o(e.theTable.rows).forEach(n(T,e)),t(e.theTable,I)}export{F as c}
//# sourceMappingURL=collapse-7b0b11bf.js.map
