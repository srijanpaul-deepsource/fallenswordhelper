import{a as e}from"./addLogColoring-f638f665.js"
import{e as n,ag as t,E as s,bd as a,be as r,F as o,D as i,A as c,bf as f,H as l,i as u,x as d,u as m,t as p,v as h,z as g,C as b,X as w,$ as y,V as j,aC as _,bg as v,ab as C,h as P,m as k,o as $,bh as L,I as x,N as T,a7 as E,bi as B,a0 as G,y as R}from"./calfSystem-eeb1d862.js"
import{i as S}from"./insertHtmlAfterEnd-2ce9b6d9.js"
import{c as A}from"./currentGuildId-5370ff7a.js"
import{g as N}from"./getMembrList-8d90010d.js"
import{c as I}from"./closestTr-8d5ed3dd.js"
import{a as z}from"./addCommas-fc2f471e.js"
import{p as D}from"./parseDateAsTimestamp-00baed52.js"
import{g as M,s as Y}from"./idb-874d144e.js"
import{c as H}from"./createStyle-c3852d42.js"
import{m as O}from"./myStats-fb0c0c4d.js"
import{b as Q}from"./buffObj-ae031e44.js"
import{c as X}from"./closestTd-68ce308d.js"
import{c as Z}from"./csvSplit-482f2ccd.js"
import{o as F}from"./openQuickBuffByName-d4740e2d.js"
...
function U([e,n]){S(e,` | <a href="${r}${n}">Attack</a>`)}function ee(e){return`<a href="${f}${l(e)}" data-tooltip="Add to Ignore List">Ignore</a>`}function ne([e,,n]){c("Report",n),S(n,` | ${ee(e)}`)}function te([e,n]){u(n.cells[1].children[0],`<font size="1"><br>[ ${ee(e)} ]</font>`)}function se(e){return d({cmd:"combat",subcmd:"view",combat_id:e})}function ae(e){return Number(e.getAttribute("background").match(/\/(\d+)/)[1])}function re(e,n){const t=new RegExp(`${n} = (\\d+)`)
...
return{attacker:fe(t),defender:le(t),id:Number(e),specials:ce(n)}}function de(e){const n=b(e.children[1])
return{gold_gain:re(n,"goldGain"),gold_stolen:re(n,"goldStolen"),pvp_prestige_gain:re(n,"prestigeGain"),pvp_rating_change:re(n,"pvpRatingChange"),winner:re(n,"winner"),xp_gain:re(n,"xpGain")}}function me(e,n){return{...ue(e,n),...de(n)}}function pe(e,n){const t=h(n)
return{r:me(e,g("pCC",t)),s:!0}}function he(e){return function(e){return m({cmd:"combat",subcmd:"view",combat_id:e})}(e).then(p(pe,e))}let ge,be
...
const t=j-86400
return!e.lastCheck||e.lastCheck<t?function(e){const t=j-604800,s=n(e).filter(p(we,t)),a={..._(s),lastCheck:j}
...
function Ve(e,n){x(n[0])&&n[1](e)}function We(e){!function(e){$(e,Oe)}(e),Je.forEach(p(Ve,e))}function qe(){e("PlayerLog",1),function(){if(R())return
const e=i("#pCC > table:last-of-type")
e&&We(e)}()}export default qe
//# sourceMappingURL=playerLog-c1b99223.js.map
