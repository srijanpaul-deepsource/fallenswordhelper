import{u as e,C as t,D as n,bK as s,I as r,V as i,_ as a,z as o,q as c,H as l,c as u,m as d,bO as b,bM as f,B as p,bR as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-f7cf24f6.js"
import{f as $}from"./functionPasses-d25a8b97.js"
import{s as w}from"./shouldBeArray-df37b06b.js"
import{i as N}from"./insertElementAfterBegin-b6d22612.js"
import{c as x}from"./createSpan-0636b0fd.js"
...
A.bounty.push(n)}}(e)}function P(){return A&&i-A.lastUpdate>M||T&&i-T.lastUpdate>M}function E(e){const t=e[6]
...
function U(e,t){var n;(function(e,t){return"[active]"!==l(t.cells[6])&&O.some((n=>n(e,t)))})(e,t)&&T.bounty.push((n=t.cells,c(B(n),{offerer:l(n[1].children[0].children[0]),tickets:l(n[5]),accept:E(n)})))}let q,G,K,X,z,D
function I(){return d({className:"minibox"})}function V(){f("bountyList",A),p("",q)
...
X=x({className:"xxsLink",textContent:"Reset"}),m(e,X),m(G,e)
let t=""
...
J(t),u.enableWantedList&&(F(t),z<D?R(z+1).then(Q):_())}const Y=[()=>!A,()=>!T,()=>S]
function Z(e,t){A=s("bountyList"),T=s("wantedList"),M=r("bountyListRefreshTime"),S=r("bwNeedsRefresh"),S||P()&&(S=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=i,j=!1,W=w("wantedNames"),a("bwNeedsRefresh",!1),R(1).then(Q)):function(e,t){t&&(T.isRefreshed=!1,_()),e&&(A.isRefreshed=!1,V())}(e,t)}function ee(e){e.target===K&&(f("bountyList",null),Z(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),Z(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=I(),N(b,G)),u.enableActiveBountyList&&(q=I(),N(b,q)),q&&v(q,ee),G&&v(G,ee),Z(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-7412390a.js.map
