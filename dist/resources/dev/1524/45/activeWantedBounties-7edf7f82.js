import{u as e,C as t,D as n,bM as s,I as a,V as r,_ as i,z as o,q as c,H as l,c as u,m as b,bQ as f,bO as d,B as p,bT as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-6a3c85e0.js"
import{f as $}from"./functionPasses-f44e4b46.js"
import{s as w}from"./shouldBeArray-b3f850bb.js"
...
function K(){return b({className:"minibox"})}function Q(){d("bountyList",T),p("",q)
...
var n
y(q,t)}function V(){d("wantedList",A),p("",G)
...
function Z(e,t){T=s("bountyList"),A=s("wantedList"),M=a("bountyListRefreshTime"),S=a("bwNeedsRefresh"),S||P()&&(S=!0),Y.some($)?(A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=r,j=!1,W=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(J)):function(e,t){t&&(A.isRefreshed=!1,V()),e&&(T.isRefreshed=!1,Q())}(e,t)}function ee(e){e.target===X&&(d("bountyList",null),Z(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(d("wantedList",null),Z(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=K(),N(f,G)),u.enableActiveBountyList&&(q=K(),N(f,q)),q&&v(q,ee),G&&v(G,ee),Z(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-7edf7f82.js.map
