import{n as t,u as s,v as a,D as e,aq as n,H as r,$ as i,m as l,h as c,a as o,t as d,a4 as u,au as f,B as m,av as p,i as v,y as h,b,p as g,c as j,M as y,a9 as C,C as A}from"./calfSystem-6a3c85e0.js"
import{g as B}from"./getMembrList-1f7b49fe.js"
import{a as D}from"./addCommas-c0fbc0a2.js"
import{a as w}from"./allthen-b379c12a.js"
import{g as S}from"./guild-7eedd9cd.js"
import{i as k}from"./intValue-a6f9b475.js"
import{c as T}from"./createTable-e4a467a3.js"
import{r as R}from"./replaceChild-20c3e527.js"
import{i as x}from"./insertHtmlAfterEnd-219827a9.js"
import{l as G}from"./loadDataTables-a27cef97.js"
...
function W(t,s){return s[t]?`<a href="${u}${s[t].id}">${t}</a>`:t}function q(t,s){return s[t]?s[t].level:""}function J(t,s){return s[t]?`<div class="fshAdvRank">${s[t].rank_name.trim()}</div>`:""}function P(t,s,a){$(t).DataTable({autoWidth:!1,columnDefs:[{targets:[1,3,4,5,6,7,8,9,10,11],orderSequence:["desc","asc"]}],columns:N,data:s,deferRender:!0,initComplete:a,lengthMenu:[[25,50,-1],[25,50,"All"]],pageLength:25,stateDuration:0,stateSave:!0})}function X(t,s){o(3,d(R,t,s))}function I(t,s,a){const e=l(),n=T({className:"fshDataTable fshXSmall hover"})
return c(e,n),c(n,s),o(3,P,[n,a,d(X,e,t)]),e}function O(t,s,a){return v(t.lastElementChild.lastElementChild,` day ${s},`),a.r}function V(t,s){return(a=s,i(E,H,a)).then(d(O,t,s))
...
return[W(s.player.name,t),q(s.player.name,t),J(s.player.name,t)].concat(a)}function tt(t,[s,...a]){const e=function(t){return t.slice(1).reduce(K,t[0]).map(Q)}(a)
...
return a.splice(0,1,W(a[0],t),q(a[0],t),J(a[0],t)),a}function et(t,s){f("guildAdvisor.injectAdvisorDaily")
...
//# sourceMappingURL=guildAdvisor-e00ce5fb.js.map
