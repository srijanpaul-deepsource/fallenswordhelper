...
import{y as n,d as o,t as e,g as a,ay as i,u as p,O as s,ax as c}from"./calfSystem-b31aba65.js"
import{m as u}from"./assets-b1b89ba1.js"
import"./all-2b32eb82.js"
const l=[]
let r,d
function f(t,n){return p({cmd:"arena",subcmd:"dopickmove",move_id:t,slot_id:n})}function m(t){return t.value}function v(t,n){if(t!==l[n])return r.eq(n).attr({src:i,width:"25",height:"25"}),f("x",n)}function h(t,n){if("x"!==t&&t!==l[n])return f(t,n)}function b(){s(`${c}setup`)}function g(n){const o=n.map(h)
t(o,b)}function k(){const n=a("select",d).map(m),o=n.map(v)
...
$(`option[value=${e}]`,a).prop("selected",!0),t.append(a)}function C(t){$(t.target).off(),r=$('#pCC a[href*="=pickmove&"] img')
...
//# sourceMappingURL=setup-e4fc8977.js.map
