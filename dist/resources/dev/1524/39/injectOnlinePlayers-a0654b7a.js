import{aY as n,t as e,I as t,bz as a,a8 as s,a6 as l,a0 as i,ar as r,y as o,o as f,f as c,v as u}from"./calfSystem-b31aba65.js"
import{c as h}from"./currentGuildId-c379e204.js"
import{i as d}from"./intValue-f6303c59.js"
import{a as p,g as v}from"./levelHighlight-71ef41d8.js"
import{n as m}from"./numberIsNaN-d0e4b349.js"
import{l as g,p as y}from"./lvlTests-f49fda0d.js"
import{l as M}from"./loadDataTables-7c33b9c3.js"
import{o as L}from"./onlinePlayersPage-b676c95c.js"
import{g as b,s as P}from"./idb-71729176.js"
...
return s-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),b("fsh_onlinePlayers").then(H),f(_[0],Y),c(_[0],"keyup",k)}function E(n){o()||(_=n?$(n):$("#pCC"),M().then(B))}export default E
//# sourceMappingURL=injectOnlinePlayers-a0654b7a.js.map
