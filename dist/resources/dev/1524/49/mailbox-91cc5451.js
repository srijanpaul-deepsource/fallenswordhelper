...
import{x as n,$ as e,y as s,p as i,g as a,P as c,t as r,k as o,m as f,h as m,o as u,e as l,l as d,B as p,Q as h,z as b}from"./calfSystem-9ab64478.js"
import{c as k}from"./createInput-48825441.js"
import{c as g}from"./createLabel-9685a247.js"
import{c as j}from"./createUl-cc8c2e09.js"
import{a as v}from"./allthen-f7cedfa7.js"
import{i as x}from"./indexAjaxJson-b31a9d3b.js"
import{i as T}from"./insertElementBefore-c7161beb.js"
import{j as y,o as B}from"./jsonFail-5c43064b.js"
...
n&&p("",n)}function N(t,n){y(n,t)||h(n.r)&&function(t,n){n.r.forEach(H),B(`${n.r.length.toString()} item(s) taken.`,t)}(t,n)}function S(t,n){var s;(s=n,e(M,L,s)).then(r(N,t))}function z(n,e,s){d("fshBls",s.target)&&function(n,e,s){const i=s.dataset.id,{invIds:a}=n[i]
...
!function(t,n){l(n).forEach(r(C,t))}(s,t),m(n,s),u(s,r(z,t,e))}function F(t){const n=f({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),e=function(t){const n=f(),e=j()
...
//# sourceMappingURL=mailbox-91cc5451.js.map
