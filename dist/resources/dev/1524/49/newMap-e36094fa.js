import{c as t,m as e,z as a,A as n,h as r,t as o,i,o as s,aS as u,Q as l,aT as c,aU as f,aV as d,a0 as m,b as h,f as p,E as b,D as g,T as v,aC as y,I as k,aW as w,C,aP as L,a8 as D,aX as A,x as M,B as V,aY as S,aN as N,aZ as H,a_ as B,a$ as x,b0 as G,b1 as T,b2 as E,aI as j,aR as P,b3 as I,a5 as O,V as R,v as F,af as _,a6 as q,b4 as K,b5 as Y,P as z,u as U,b6 as W,b7 as Q,b8 as J,b9 as X,aO as Z,q as tt,a as et,M as at,ba as nt,bb as rt,bc as ot,bd as it,be as st,l as ut,at as lt,$ as ct,au as ft,aa as dt,bf as mt,bg as ht,bh as pt,bi as bt,bj as gt,bk as vt,bl as yt}from"./calfSystem-9ab64478.js"
import{i as kt}from"./insertElementAfter-766d923a.js"
import{t as wt}from"./toggleForce-d61da182.js"
import{c as Ct}from"./createSpan-7ce539c8.js"
import{i as Lt}from"./insertTextBeforeEnd-d4183c50.js"
import{a as Dt,r as At}from"./roundToString-98c640ba.js"
import{a as $t}from"./addCommas-1f67a5b9.js"
import{d as Mt,q as Vt}from"./quickbuffSuccess-4779e2a7.js"
import{p as St}from"./playerName-b4c2ff3f.js"
import{g as Nt,s as Ht}from"./idb-9da90398.js"
import{c as Bt}from"./createStyle-a3ebff9c.js"
import{g as xt}from"./getArrayByClassName-a799501a.js"
import{e as Gt}from"./executeAll-779c0127.js"
import{c as Tt}from"./createButton-a944a33d.js"
import{e as Et}from"./eventHandler5-653e18d2.js"
import{i as jt}from"./insertElementBefore-c7161beb.js"
import{c as Pt}from"./createInput-48825441.js"
import{c as It}from"./createLabel-9685a247.js"
import{o as Ot}from"./openQuickBuffByName-2b4b1ff5.js"
import{a as Rt}from"./all-bb953856.js"
import{a as Ft}from"./allthen-f7cedfa7.js"
import{d as _t,g as qt}from"./getGroupStats-c44f3ff8.js"
import{g as Kt}from"./getMercStats-e65edbdb.js"
import{g as Yt}from"./getProfile-f5771e2a.js"
import{g as zt}from"./getMembrList-ad7be9d5.js"
import{h as Ut}from"./hideElement-3021ab25.js"
import{n as Wt}from"./numberIsNaN-9a364388.js"
import{r as Qt}from"./reduceBuffArray-05963b78.js"
import{r as Jt}from"./rnd-1618b1ea.js"
import{h as Xt}from"./hasClasses-cbeb6cdc.js"
import{v as Zt}from"./valueText-99c24f27.js"
import{g as te}from"./guild-3e01f77e.js"
import{g as ee,a as ae}from"./getTitanString-719b1e7a.js"
import{p as ne}from"./padZ-3a27e144.js"
import{c as re}from"./createTable-54039451.js"
import{t as oe}from"./testQuant-55fb1392.js"
import{g as ie}from"./groupViewStats-f83dbb09.js"
import{m as se}from"./myStats-eafccf98.js"
import{a as ue}from"./huntingBuffs-ac62bf09.js"
import{b as le}from"./simpleCheckbox-7ced9047.js"
import{b as ce}from"./bitwiseAnd-e091ed55.js"
import{s as fe}from"./shouldBeArray-24afb37a.js"
import"./getBuff-8f664a72.js"
...
de&&wt(de,!0)}function Le(t,e){me?wt(me,!1):function(t){me=t.children[3],me.className="fshBlue",n("CA ",me),he=Ct(),r(me,he),Lt(me," active")}(t),n(e.level,he)}function De(t,e){e?Le(t,e):me&&wt(me,!0)}function Ae(t,e){pe?wt(pe,!1):function(t){pe=t.children[4],pe.className="fshRed",n("Doubler ",pe),be=Ct(),r(pe,be),Lt(pe," active")}(t),n(e.level,be)}function $e(t,e){e?Ae(t,e):pe&&wt(pe,!0)}function Me(t,e,a){ge?wt(ge,!1):function(t){ge=t.children[2],n("Damage bonus: ",ge),ve=Ct(),r(ge,ve),Lt(ge,"%")}(t),n(function(t,e){if(t){const a=Math.min(.01*Math.round(Math.floor(e/5)*Number(t.level)),20)
return Dt(a,2).toString()}return"0"}(e,Number(a)),ve)}function Ve(t,e,a){e?Me(t,e,a):ge&&wt(ge,!0)}function Se(t,e){n($t(t),e)}function Ne(t,e){ye?wt(ye,!1):function(t){ye=t.children[1],n("Kill Streak: ",ye),ke=Ct(),r(ye,ke)}(t),Se(e,ke)}function He(t,e,a,n){e||a?Ne(t,n):ye&&wt(ye,!0)}function Be(t,e){return e.name===t}function xe(t){const{buffs:e}=GameData.player()
if(e)return e.find(o(Be,t))}const Ge=["red","orange","yellow"]
let Te,Ee
function je(t){Vt(t)&&GameData.fetch(u)}function Pe(){xe("Summon Shield Imp")||Mt([St()],[55]).then(je)}const Ie=["imp-0","imp-1","imp-1"]
...
t&&(Re(t,Qe,ze),He(t,ze,Xe,Ze),Ve(t,ze,Ze),De(t,We),$e(t,Ue),aa(t,Je))}function oa(t,e){var a
...
function $a(t){return function(e,a,n,r){const o=Aa[e];(function(t){return t&&L(t)})(o)&&function(t){return D(t)||0===t}(r)?o(t)(e,a,n,r):t(e,a,n,r)}}async function Ma(t){var e
...
const r=a.length
for(let t=0;t<r;t++)n+=`<tr style="border-top:1px solid #CD9E4B;"><td>${t+1}</td><td><a href="${S}${a[t].guild.id}"><img src="${y}guilds/${a[t].guild.id}_mini.png" width="16" height="16"></a></td><td><a href="${N}${a[t].player.name}">${a[t].player.name}</a></td><td>${a[t].value}</td></tr>`
n+="</table>",V(n,t)}function Va(){const t=a("world-event-contrib")
V("Loading...",t),Ma(t),$(t).dialog({title:"Top 100 Event Contributers",minWidth:300,height:300,zIndex:9999})}function Sa(t){t.remove()}function Na(t,e){!function(t){(function(t){return t.response&&t.response.msg&&t.response.msg.startsWith("Creature did not exist at that location")})(t)&&GameData.fetch(H+B)}(e),b(".creature-4 > .quickCombat > .verbs").forEach(Sa)}function Ha(){window.GameController&&GameController.Realm&&!GameController.Realm.footprintTileList&&(GameController.Realm.footprintTileList=[])}function Ba(t,e,a){return It({className:`fshCurveEle fshCurveLbl fshPoint tip-static ${t}`,dataset:{tipped:e},htmlFor:a})}function xa(t){const a=e({className:"fshToggle"}),n=Pt({checked:t.prefVal,id:t.checkId,type:"checkbox"})
r(a,n)
...
function Wa(){Ga||(Ga=e({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),Ya(),s(Ga,Et(Ua)),p(Ga,"change",Et(za)),jt(Ga,a("worldCoord")))}function Qa(t,e){Ta&&e.b.minlevel&&(Ha(),n(e.b.minlevel,Ta))}function Ja(t,e){Ea&&n(e.b,Ea)}function Xa(t){return!t||!t.response||!t.response.data}let Za,tn,en,an,nn,rn,on,sn,un,ln,cn,fn,dn,mn,hn,pn,bn,gn,vn,yn,kn,wn,Cn,Ln,Dn,An,$n,Mn,Vn,Sn,Nn,Hn,Bn,xn,Gn
...
r(Za,s),Cn=a("DC225"),Ln=a("DC175"),Dn=a("GroupAttack"),An=a("GroupAttackBuffed"),$n=a("GroupDefense"),Mn=a("GroupDefenseBuffed"),Vn=a("GroupArmor"),Sn=a("GroupArmorBuffed"),Nn=a("GroupDamage"),Hn=a("GroupDamageBuffed"),Bn=a("GroupHP"),xn=a("GroupHPBuffed")}let _n
...
Se(a+e,Mn),function(t){Se(sr.armor+Math.floor(sr.armor*q(t.Sanctuary,0)*.001),Sn)}(t)
...
Se(sr.damage+a-n,Hn)}(t,n)}function hr(){n("Processing attacking group stats ... ",Gn),ur&&(sr.attack-=ur.attack,sr.defense-=ur.defense,sr.armor-=ur.armor,sr.damage-=ur.damage,sr.hp-=ur.hp),Se(sr.attack,Dn),Se(sr.defense,$n),Se(sr.armor,Vn),Se(sr.damage,Nn),Se(sr.hp,Bn)
...
const t=Lr()
Ft(t,pr)}function Ar(t,e){Xa(e)||(lr=e.response.data,lr.defenders.length>0&&(En(lr),z(en,"click",Dr)))}function $r(t){$("#statbar-gold").css("background-color",t)}function Mr(){$("#HelperSendTotal").html($t(k("currentGoldSentTotal"))),Number(GameData.player().gold)>cr?$r("red"):$r("inherit")}function Vr(){cr=k("goldAmount"),$("#statbar-gold-tooltip-general").append(`<dt class="stat-gold-sendTo">Send To:</dt><dd id="HelperSendTo">${k("goldRecipient")}</dd><dt class="stat-gold-sendAmt">Amount:</dt><dd id="HelperSendAmt">${$t(cr)}</dd><dt class="stat-gold-sendTo">Send?</dt><dd><input id="HelperSendGold" value="Send!" class="custombutton" type="submit"><input type="hidden" id="xc" value=""</dd><dt class="stat-gold-sendTotal">Total Sent:</dt><dd id="HelperSendTotal">${$t(k("currentGoldSentTotal"))}</dd>`),$("#HelperSendGold").on("click",J),Mr(),$.subscribe(X,Mr)}function Sr(t){return Z({cache:!1,url:"fetchdata.php",data:tt(t,{fshrnd:Jt()}),dataType:"json"})}const Nr=[]
function Hr(t){return Xa(t)||Nr.push(t),t}function Br(t,e){return t===Number(e.response.data.id)}function xr(t,e){t(e)}function Gr(t,e){const a=Nr.find(o(Br,t))
return a?function(t){return new Promise((e=>{et(3,xr,[e,t])}))}(a):Sr({a:1,id:t,passback:e}).then(Hr)}let Tr,Er,jr,Pr,Ir,Or
...
return a&&(n.className="fshBlue"),function(t,e){e.forEach(o(Xr,t))}(n,e),n}function to(t,e){Zr(t,e[0],e[1])}function eo(t,e){e.forEach(o(to,t))}let ao,no,ro,oo,io,so,uo,lo,co,fo,mo,ho,po,bo,go,vo,yo,ko,wo,Co,Lo,Do,Ao,$o,Mo,Vo,So,No
function Ho(){no=_e("Current"),ro=_e("Kills"),oo=_e("Member"),io=_e("% of Total"),so=_e("Status"),uo=_e("Titan HP"),lo=_e("Total"),co=_e("Your Guild")}function Bo(){for(;yo.rows.length>7;)yo.deleteRow(7)}function xo(){const t=Ct()
...
ko=e({className:"fshActionBox titanInfo"}),fo=Ct(),mo=Ct(),ho=Ct(),po=Ct(),bo=Ct(),go=Ct(),vo=Ct(),yo=re({className:"fshCenter"}),Ho(),eo(yo,[[[[2,uo,!0],[4,co,!0]]],[[[2,xo()],[4,ho]]],[[[2,no,!0],[4,Go(po)]],!0],[[[2,lo,!0],[4,Go(bo)]],!0],[[[2,so,!0],[4,go]],!0],[[[6,vo]]],[[[2,oo,!0],[2,ro,!0],[2,io,!0]]]]),r(ko,yo),r(t,ko)}}function Po(t){return t<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(t){const e=new Date(dt+1e3*t)
...
n=-1!==t?a.substring(0,t):a}else n=`You purchased ${t.response.data.name} for ${$t(t.response.data.cost)} gold.`
i(So,`${n}<br>`)}function Xo(){GameData.doAction(14,3,{id:Lo.id,item_id:Lo.itemId},0),Ao.close()}function Zo(){const t=oe(Mo.value)
if(!t)return
const e=[]
for(let a=1;a<t;a+=1)e.push(Sr({a:14,d:0,id:Lo.id,item_id:Lo.itemId}).then(Jo))
Ft(e,Xo)}function ti(){$o?n("",So):($o=e({className:"fshClear",textContent:"Select how many to quick-buy:"}),Mo=Pt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),r($o,Mo),Vo=Tt({textContent:"Quick-buy"}),s(Vo,Zo),r($o,Vo),So=e(),r($o,So),r(Do,$o))}function ei(t,e){Lo=e,Do=Do||a("shopDialogConfirm"),Do&&(Ao=Ao||$(Do).data("hcsWorldDialogShopConfirm"),Ao&&ti())}function ai(t){No[t.name]?No[t.name].seen&&(No[t.name].seen+=1):(No[t.name]={seen:1},function(t,e){e.creature_class=t.creature_class,e.image_id=t.image_id,e.level=Number(t.level),e.type=t.type}(t,No[t.name]))}function ni(t,e,a){return e?t(e,a):a}function ri(t,e){const a=t||{}
return a.min=ni(Math.min,a.min,e),a.max=ni(Math.max,a.max,e),a}const oi=["attack","armor","damage","defense","hp"]
function ii(t,e,a){const n=ri(e[a],Number(t[a]));(function(t,e){return!t||t.min!==e.min||t.max!==e.max})(e[a],n)&&(e[a]=n)}function si(t,e){t[e.name]=ri(t[e.name],Number(e.value))}function ui(t){No||(No={}),ai(t),function(t,e){oi.forEach(o(ii,t,e))}(t,No[t.name]),function(t,e){(function(t){return t.enhancements&&t.enhancements.length>0})(t)&&(e.enhancements=e.enhancements||{},t.enhancements.forEach(o(si,e.enhancements)))}(t,No[t.name]),Ht("fsh_monsterLog",No)}function li(t){No=t||{}}const ci=[]
function fi(e){var a
...
t.overallArmorValue=e+Math.floor(t.player.armorValue*t.player.sanctuaryLevel*.001)}(t),function(t){t.player.sanctuaryLevel>0&&(t.extraNotes+=`Sanc Bonus Armor = ${Math.floor(t.player.armorValue*t.player.sanctuaryLevel*.001)}<br>`)}(t),function(t){t.terrorizeEffect=Math.floor(t.creature.damage*t.player.terrorizeLevel*.001)}(t),function(t){t.player.terrorizeLevel>0&&(t.extraNotes+=`Terrorize Creature Damage Effect = ${-1*t.terrorizeEffect}<br>`)}(t),t.creature.damage-=t.terrorizeEffect,function(t){t.creatureDamageDone=Math.ceil(t.generalVariable*t.creature.damage-t.overallArmorValue+t.overallHPValue)}(t),Di(t)}function $i(t){const e=function(t){return t.callback.groupExists?t.callback.groupAttackValue:t.player.attackValue}(t)
...
return 3===t.combatEvaluatorBias?t.overallAttackValue-Math.ceil(e)-50:t.overallAttackValue-Math.ceil(t.attackVariable*e)}(t)}function Mi(t){t.lowestCALevelToStillHit=Math.max(Math.ceil((t.counterAttackBonusAttack-t.hitByHowMuch+1)/t.player.attackValue/.0025),0),t.lowestCALevelToStillKill=Math.max(Math.ceil((t.counterAttackBonusDamage-t.damageDone+1)/t.player.damageValue/.0025),0)}function Vi(t){Mi(t),t.lowestFeasibleCALevel=Math.max(t.lowestCALevelToStillHit,t.lowestCALevelToStillKill),t.extraNotes+=`Lowest CA to still 1-hit this creature = ${t.lowestFeasibleCALevel}<br>`,0!==t.lowestFeasibleCALevel&&function(t){t.extraAttackAtLowestFeasibleCALevel=Math.floor(.0025*t.player.attackValue*t.lowestFeasibleCALevel),t.extraDamageAtLowestFeasibleCALevel=Math.floor(.0025*t.player.damageValue*t.lowestFeasibleCALevel),t.extraNotes+=`Extra CA Att/Dam at this lowered CA level = ${t.extraAttackAtLowestFeasibleCALevel} / ${t.extraDamageAtLowestFeasibleCALevel}<br>`}(t),t.extraStaminaPerHitAtLowestFeasibleCALevel=function(t){return t.player.counterAttackLevel>0?Math.ceil(.0025*(1+t.player.doublerLevel/50)*t.lowestFeasibleCALevel):0}(t),t.extraStaminaPerHitAtLowestFeasibleCALevel<t.extraStaminaPerHit?t.extraNotes+=`Extra Stam Used at this lowered CA level = ${t.extraStaminaPerHitAtLowestFeasibleCALevel}<br>`:t.extraNotes+="No reduction of stam used at the lower CA level<br>"}function Si(t){(function(t){return t.player.counterAttackLevel>0&&1===t.numberOfHitsRequired})(t)&&Vi(t),function(t){return"-"===t.numberOfHitsRequired||1!==t.numberOfHitsRequired}(t)&&function(t){Mi(t),function(t){t.lowestCALevelToStillHit>175?t.extraNotes+="Even with CA175 you cannot hit this creature<br>":0!==t.lowestCALevelToStillHit&&(t.extraNotes+=`You need a minimum of CA${t.lowestCALevelToStillHit} to hit this creature<br>`)}(t),function(t){t.lowestCALevelToStillKill>175?t.extraNotes+="Even with CA175 you cannot 1-hit kill this creature<br>":0!==t.lowestCALevelToStillKill&&(t.extraNotes+=`You need a minimum of CA${t.lowestCALevelToStillKill} to 1-hit kill this creature<br>`)}(t)}(t)}function Ni(t){!function(t){const e=function(t){return t.callback.groupExists?t.callback.groupHPValue:t.player.hpValue}(t),{fortitudeLevel:a}=t.player
...
t.overallDamageValue>=t.generalVariable*t.creature.armor&&(e=t.overallDamageValue-t.generalVariable*t.creature.armor),t.numberOfHitsRequired=Math.ceil(t.hpVariable*t.creature.hp/e)}else t.numberOfHitsRequired="-"}function Hi(t){return t.callback.groupExists?t.callback.groupDefenseValue:t.player.defenseValue}function Bi(t){t.overallDefenseValue=Hi(t)+Math.floor(Hi(t)*t.player.constitutionLevel*.001)+t.nightmareVisageAttackMovedToDefense,function(t){t.player.constitutionLevel>0&&(t.extraNotes+=`Constitution Bonus Defense = ${Math.floor(Hi(t)*t.player.constitutionLevel*.001)}<br>`)}(t),function(t){t.player.flinchLevel>0&&(t.extraNotes+=`Flinch Bonus Attack Reduction = ${Math.floor(t.creature.attack*t.player.flinchLevel*.001)}<br>`)}(t),t.creatureHitByHowMuch=Math.floor(t.attackVariable*t.creature.attack-t.creature.attack*t.player.flinchLevel*.001-t.overallDefenseValue),3===t.combatEvaluatorBias&&(t.creatureHitByHowMuch=Math.floor(t.creature.attack-t.creature.attack*t.player.flinchLevel*.001-t.overallDefenseValue-50))}function xi(t){t.extraNotes="",function(t){t.player.superEliteSlayerLevel>0&&(t.extraNotes+=`SES Stat Reduction Multiplier = ${t.player.superEliteSlayerMultiplier}<br>`)}(t),function(t){t.holyFlameBonusDamage=0,"Undead"===t.creature.class&&(t.holyFlameBonusDamage=Math.max(Math.floor((t.player.damageValue-t.creature.armor)*t.player.holyFlameLevel*.002),0),t.player.holyFlameLevel>0&&(t.extraNotes+=`HF Bonus Damage = ${t.holyFlameBonusDamage}<br>`))}(t),function(t){t.deathDealerBonusDamage=Math.floor(t.player.damageValue*(Math.min(.01*Math.floor(t.player.killStreakValue/5)*t.player.deathDealerLevel,20)/100))}(t),function(t){t.counterAttackBonusAttack=Math.floor(.0025*t.player.attackValue*t.player.counterAttackLevel),t.counterAttackBonusDamage=Math.floor(.0025*t.player.damageValue*t.player.counterAttackLevel)}(t),function(t){t.extraStaminaPerHit=0,t.player.counterAttackLevel>0&&(t.extraStaminaPerHit=Math.ceil(.0025*(1+t.player.doublerLevel/50)*t.player.counterAttackLevel))}(t),function(t){t.player.deathDealerLevel>0&&(t.extraNotes+=`DD Bonus Damage = ${t.deathDealerBonusDamage}<br>`)}(t),function(t){t.player.counterAttackLevel>0&&(t.extraNotes+=`CA Bonus Attack/Damage = ${t.counterAttackBonusAttack} / ${t.counterAttackBonusDamage}<br>CA Extra Stam Used = ${t.extraStaminaPerHit}<br>`)}(t)}let Gi,Ti,Ei,ji,Pi,Ii,Oi,Ri,Fi,_i
...
return function(t){return!t||!t.actions||0===t.actions.length}(e)?t:(e.actions=e.actions.filter(o(ws,function(t){return t.realm&&t.realm.minlevel||GameData.realm().minlevel}(e))),JSON.stringify(e))}function Ls(e,a){t.hideSubLvlCreature&&function(t){return t.data&&t.data.d&&ce(t.data.d,B)}(a)&&(e.dataFilter=Cs)}function Ds(e){t[e[0]]=fe(e[1])}function As(e){t[e]=fe(e)}function $s(){[["buffs","huntingBuffs"],["buffs2","huntingBuffs2"],["buffs3","huntingBuffs3"]].forEach(Ds),["doNotKillList"].forEach(As)}function Ms(e){t[e[0]]=k(e[1])}function Vs(e){t[e]=k(e)}function Ss(){[["buffsName","huntingBuffsName"],["buffs2Name","huntingBuffs2Name"],["buffs3Name","huntingBuffs3Name"],["showBuffs","showHuntingBuffs"]].forEach(Ms),["enabledHuntingMode","hideSubLvlCreature","showTitanInfo","showBuffInfo","showMonsterLog","showCreatureInfo"].forEach(Vs)}function Ns(t){$(`#actionList li.creature-${t.toString()} a.create-group`).hide()}const Hs=["hideChampionsGroup","hideElitesGroup","hideSEGroup","hideTitanGroup","hideLegendaryGroup"]
function Bs(t,e){var a
k(t)&&(a=e+1,$.subscribe(A,o(Ns,a)),Ns(e+1))}function xs(t,e){"ACT_REPAIR"===e&&GameData.fetch(yt+u+H+B)}function Gs(t){T(t.target)}const Ts=[function(){ks(),$s(),Ss()
const e=ms()
$.ajaxPrefilter("JSON",Ls),t.hideSubLvlCreature&&GameData.fetch(B),function(e){ss()
const a=o(vs,e)
$.subscribe(c,a),t.showBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),_i=k("hidePlayerActions"),$.subscribe(A,cs),cs()},function(){W(),Q&&Vr()},function(){$.subscribe(bt,is)},function(){Hs.forEach(Bs)},function(){k("enableCreatureColoring")&&r(document.body,Bt("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(A,La),La(),function(){const t=GameData.doAction
GameData.doAction=$a(t)}()},function(){Nt("fsh_monsterLog").then(li),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",hi),hi()},function(){$.subscribe(vt,xs)},function(){k("keepLogs")&&Nt("fsh_combatLog").then(ka)},function(){window.initialGameData&&Qo(0,window.initialGameData),$.subscribe(`${mt} ${ht}`,Qo)},function(){$.subscribe(pt,ei)},function(){$.subscribe(Y,Ar)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){T("#mapTooltip")},function(){Wa(),$.subscribe(x,Qa),$.subscribe(G,Ja)},function(){ra(),$.subscribe(`${c} ${f}`,ra),$.subscribe(d,oa)},function(){s(a("buffList"),Gs)},function(){p(a("actionList"),"mouseover",Qr)},function(){const t=h("body")[0]
p(t,"keydown",fa),p(t,"keyup",da)}]
function Es(){Gt(Ts),$.subscribe(w,Na),function(){const t=$("#world-event-badge")
t.length&&(t.off(),s(t[0],Va))}()}export default Es
//# sourceMappingURL=newMap-e36094fa.js.map
