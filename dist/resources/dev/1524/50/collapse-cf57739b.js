import{at as o,t as n,o as t,a6 as e,z as a,f as c,a0 as r,aP as f}from"./calfSystem-b3667af8.js"
...
u[a]=e(u[a],{})
const c=u[a]
c.rows=c.rows||[],N(n,t,c,o)}function j(o){o.header.classList.toggle("fshPoint")}function L(o){h=!h,r(o,h),h?l():u.forEach(x),u.forEach(j)}function P(e){d=e.headInd,function(o){const t=a(o)
h=t.checked,c(a(o),"change",n(L,o))}(e.prefName),o(e.theTable.rows).forEach(n(b,e)),t(e.theTable,T)}export{P as c}
//# sourceMappingURL=collapse-cf57739b.js.map
