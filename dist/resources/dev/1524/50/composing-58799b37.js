import{r as e,B as t,t as n,aC as s,af as o,a0 as a,aJ as i,D as c,m as r,P as l,T as m,i as p,aK as u,E as f,h as d,o as g,p as h,A as b,c as v,aL as C,C as S,aa as E,j,I as k,z as N,M as x}from"./calfSystem-b3667af8.js"
import{r as A,g as y}from"./rnd-82127452.js"
import{p as L,s as $}from"./pubsub-c8c2b136.js"
import{c as B}from"./createInput-18c4c6d4.js"
import{c as I}from"./createTable-e47cc154.js"
import{g as q}from"./getArrayByClassName-2345f1a3.js"
import{i as T}from"./insertElementAfter-7851228c.js"
import{i as F}from"./insertHtmlAfterEnd-b696788c.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],B({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function R(e,t,s,o){return e.reduce(n(K,o),s.insertRow(-1)),s}function G(e){return[e.value,e.text]}function O(e,t,s){const o=function(e,t,s){const o=I({id:"fshFastCompose"})
return D(o,s),e.reduce(n(R,t,s),o)}(f("#composing-template-multi option").map(G),t,s)
d(e,o),g(h,J),$("quickcreate",n(H,o))}function U(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-58799b37.js.map
