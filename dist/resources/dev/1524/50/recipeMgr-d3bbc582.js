import{d as t}from"./doSortParams-697a30b0.js"
import{I as e,aM as n,B as i,z as r,g as s,v as a,i as o,t as c,C as d,an as u,aO as p,M as m,m as f,h,u as l,y as g,o as b,p as $}from"./calfSystem-b3667af8.js"
import{s as v,g as x}from"./idb-22dd2687.js"
import{s as _}from"./shouldBeArray-3d5b7aae.js"
import{a as y}from"./stringSort-17d6893b.js"
import{a as N}from"./all-9b215cd1.js"
...
n.items=E(d,"/inventory/2x3."),n.components=E(d,"/inventory/1x1mini."),[n.target]=E(d,"/hellforge/2x3."),e.recipe.push(n)}function M(t,e,n){o(t,`Found blueprint "${d(n)}".<br>`)
...
return s("a",e)}(a(n)).map(c(M,t,e))
return N(i)}function z(t){return/\/folder_on\./.test(t.getAttribute("src"))}function L(t,e){return 0!==e}function O(t){return t.value}function D(t,e,n){return p(`${t}&page=${n}`).then(e)}function G(t,e,n){return function(t){return s("option",m("customselect",r("pCC",t))[0]).filter(L).map(O)}(t).map(c(D,e,n))}function H(t,e,n){const i=a(n),r=function(t){return I(t).find(z).parentNode.href}(i),s=c(q,t,e),o=G(i,r,s)
return o.push(s(n)),N(o)}function J(t){return"-1"!==u(t.parentNode.search,"folder_id")}function K(t,e){const n=d(e.parentNode.nextElementSibling.nextElementSibling.firstChild),i=/quest/i.test(n)
return i&&o(t,`Skipping folder "${n}"  as it has the word "quest" in folder name.<br>`),!i}function Q(t,e){return p(e.parentNode.href).then(t)}function U(t,e,n){const i=c(H,t,e),r=function(t,e,n){return I(a(e)).filter(J).filter(c(K,t)).map(c(Q,n))}(t,n,i)
...
//# sourceMappingURL=recipeMgr-d3bbc582.js.map
