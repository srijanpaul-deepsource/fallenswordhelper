import{u as e,C as t,D as n,bL as s,I as r,U as i,Z as a,z as o,q as c,H as l,c as u,m as d,bP as b,bN as f,B as p,bS as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-cbf77dd7.js"
import{f as $}from"./functionPasses-a26e09ef.js"
import{s as w}from"./shouldBeArray-0e85836d.js"
import{i as N}from"./insertElementAfterBegin-7e75dc58.js"
import{c as x}from"./createSpan-14225166.js"
...
A.bounty.push(n)}}(e)}function M(){return A&&i-A.lastUpdate>S||T&&i-T.lastUpdate>S}function U(e){const t=e[6]
...
function K(){return d({className:"minibox"})}function Z(){f("bountyList",A),p("",q)
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=i,n&&H(n),j=!0}(e),Z())}function V(e){const t=L(e)
Q(t),u.enableWantedList&&(J(t),D<I?R(D+1).then(V):F())}const Y=[()=>!A,()=>!T,()=>P]
function _(e,t){A=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),P=r("bwNeedsRefresh"),P||M()&&(P=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=i,j=!1,W=w("wantedNames"),a("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,Z())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=K(),N(b,G)),u.enableActiveBountyList&&(q=K(),N(b,q)),q&&v(q,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-dd50d3d8.js.map
