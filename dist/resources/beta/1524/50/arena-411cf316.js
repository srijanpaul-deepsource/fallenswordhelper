...
import{al as e,E as a,e as s,t as r,av as o,d as c,x as i,q as f,y as l,S as d,I as u,aw as m,ax as p}from"./calfSystem-617f9a5d.js"
import{s as v,g as h}from"./idb-443c992c.js"
import{i as b}from"./intValue-76dfee09.js"
import{c as g}from"./changeMinMax-5835769c.js"
import{f as x,a as y,m as L,t as M}from"./assets-64d5f82f.js"
import{l as T,p as j}from"./lvlTests-2c3872b9.js"
import{i as _}from"./interceptSubmit-6761ad9f.js"
import{l as k}from"./loadDataTables-cdc37e7e.js"
import{c as w}from"./currentGuildId-3b40ad81.js"
...
1===t.children(c).length&&t.attr("data-order",t.find("td").first().text().replace(/[,\s]/g,""))}(a)}const K=n=>[n,Number(n.previousElementSibling.value)]
...
3!==t?a.order([3,"asc"],[t,e]).draw():a.order([3,e]).draw()}(t,t.index(),e)}function an(n){return i(f({cmd:"arena"},n))}function sn(){return an({subcmd:"view"})}function rn(n,t){const e=$("tr",t).first()
$("a",e).contents().unwrap(),$(t).prepend($("<thead/>").append(e))}function on(){R(),D(),$.fn.dataTable.ext.search.push(O)}function cn(n,[t,o,c]){const i=$('table[width="635"]',n)
i.each(rn),function(n){S=n||{},C=S.id||{},S.id={}}(t),function(n){n.children("tbody").children("tr").each(V)}(i),function(n){if(!e(n))return
...
v("fsh_arenaFull",o)}(o),nn(c),on(),i.DataTable(M),function(n){$(tn,n).off("click"),n.on("click",tn,en)}(n)}function fn(n,t){const e=u("betaOptIn")
...
//# sourceMappingURL=arena-411cf316.js.map
