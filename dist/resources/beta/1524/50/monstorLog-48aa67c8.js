...
import{q as e,aB as s,a$ as n,e as a,a7 as r,c as i,j as o,p as c,B as f,z as l,o as h,t as d,l as u}from"./calfSystem-617f9a5d.js"
import{d as m}from"./doSortParams-b3a6a5e2.js"
import{p,s as g,a as y}from"./stringSort-beaef255.js"
import{g as b,s as C}from"./idb-443c992c.js"
...
s=j(s),n=j(n)
return g(s-n)}let S,B
function A(){f("<span>No monster information! Please enable entity log and travel a bit to see the world</span>",S)}function E(t){return`<tr><td class="fshCenter">${t.image}</td><td>${t.name}</td><td class="fshCenter">${t.creature_class}</td><td class="fshCenter">${t.level}</td><td class="fshCenter">${t.attack}</td><td class="fshCenter">${t.defense}</td><td class="fshCenter">${t.armor}</td><td class="fshCenter">${t.damage}</td><td class="fshCenter">${t.hp}</td><td class="fshCenter">${t.enhancements}</td></tr>`}function _(){const t=l("entityTableOutput")
B&&t&&f(B.map(E).join(""),t)}function P(t){m(t)
!function(t){"string"===t?B.sort(y):B.sort(w)}(function(t){return t.getAttribute("sortType")||"string"}(t)),_()}function O(t){const{target:e}=t
if("clearEntityLog"===e.id)return C("fsh_monsterLog",""),void A();(function(t){return u("fshLink",t)&&t.hasAttribute("sortkey")})(e)&&P(e)}function T(t){t?(!function(t){B=n(t).map(d(L,t))}(t),i.sortBy="level",i.sortAsc=!0,B.sort(w),B&&(f('<table cellspacing="0" cellpadding="0" border="0" width="100%"><tr class="fshBlack fshWhite"><td width="90%" class="fshCenter"><b>Entity Information</b></td><td width="10%">[<span id="clearEntityLog" class="fshPoint">Clear</span>]</td></tr></table><table cellspacing="1" cellpadding="2" border="0"><thead><tr class="fshVerySoftOrange"><th width="25%" class="fshLink" sortkey="name" colspan="2">Entity</th><th class="fshCenter fshLink" sortkey="creature_class">Class</th><th class="fshCenter fshLink" sortkey="level" sorttype="number">Lvl</th><th class="fshCenter">Attack</th><th class="fshCenter">Defence</th><th class="fshCenter">Armor</th><th class="fshCenter">Damage</th><th class="fshCenter">HP</th><th class="fshCenter">Enhancements</th></tr></thead><tbody id="entityTableOutput"></tbody></table>',S),h(S,O)),_()):A()}function x(t){o()&&function(t){S=t||c,S&&b("fsh_monsterLog").then(T)}(t)}export default x
//# sourceMappingURL=monstorLog-48aa67c8.js.map
