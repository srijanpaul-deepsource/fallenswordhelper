import{d as t}from"./doSortParams-b3a6a5e2.js"
import{I as e,aL as n,B as i,z as r,g as s,v as a,i as o,t as c,C as d,am as u,aN as p,M as m,m as f,h,u as l,y as g,o as b,p as $}from"./calfSystem-617f9a5d.js"
import{s as v,g as x}from"./idb-443c992c.js"
import{s as N}from"./shouldBeArray-1a51523e.js"
import{a as _}from"./stringSort-beaef255.js"
import{a as y}from"./all-9b215cd1.js"
...
return y(i)}function z(t){return/\/folder_on\./.test(t.getAttribute("src"))}function M(t,e){return 0!==e}function D(t){return t.value}function G(t,e,n){return p(`${t}&page=${n}`).then(e)}function H(t,e,n){return function(t){return s("option",m("customselect",r("pCC",t))[0]).filter(M).map(D)}(t).map(c(G,e,n))}function J(t,e,n){const i=a(n),r=function(t){return I(t).find(z).parentNode.href}(i),s=c(q,t,e),o=H(i,r,s)
return o.push(s(n)),y(o)}function K(t){return"-1"!==u(t.parentNode.search,"folder_id")}function O(t,e){const n=d(e.parentNode.nextElementSibling.nextElementSibling.firstChild),i=/quest/i.test(n)
return i&&o(t,`Skipping folder "${n}"  as it has the word "quest" in folder name.<br>`),!i}function Q(t,e){return p(e.parentNode.href).then(t)}function U(t,e,n){const i=c(J,t,e),r=function(t,e,n){return I(a(e)).filter(K).filter(c(O,t)).map(c(Q,n))}(t,n,i)
...
//# sourceMappingURL=recipeMgr-f438136f.js.map
