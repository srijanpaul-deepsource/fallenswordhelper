import{a as t}from"./addGuildLogWidgets-8d5391dc.js"
import{a as e}from"./addLogColoring-1e4d32bb.js"
import{a as s}from"./all-be4763d3.js"
import{u as i,t as n,br as a,bs as o,y as c,B as d,p as r,o as h,g as l,A as f,z as u,I as p,v as m,D as g,C as b,K as k,i as y,H as w}from"./calfSystem-ab393688.js"
import{c as j}from"./createTable-fc2f2ae0.js"
import{e as L}from"./eventHandler5-56775d0c.js"
import{f as R}from"./functionPasses-5a92ba59.js"
import{h as N}from"./hideElement-512851a2.js"
import{p as v}from"./parseDateAsTimestamp-e9cd3714.js"
import{s as G}from"./selfIdIs-70806dca.js"
import{t as x}from"./toggleForce-4ff42c01.js"
import{g as H,s as T}from"./idb-4a088c10.js"
import"./dataRows-52e3a5bd.js"
import"./playerName-17cbc946.js"
import"./searchPlayerHref-c8f494ae.js"
...
if(W(n,a)){V=!1
break}Q.push([100*z+t,n,i,a,C(a)])}}(t)}function J(t){!function(t){_=m(t)
...
d(e,s),s.className="row"}function it(t){!function(t){const e=q.insertRow(-1)
t.push(e),K.checks[t[4]]||(e.className="fshHide"),st(e,'<i class="fas fa-user-friends" style="color: rgb(122,95,46);"></i>'),st(e,`<nobr>${t[2]}</nobr>`),st(e,t[3])}(t),function(t){const e=q.insertRow(-1)
t.push(e),K.checks[t[4]]||(e.className="fshHide")
const s=e.insertCell(-1)
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=K.checks[t.getAttribute("item")]}function at(){l("input",B).forEach(nt),Z()}function ot(t,e){return t[0]-e[0]}function ct(){V&&Q.sort(ot),f("Loading complete.",M),K.log=Q.filter(n(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=j({id:"fshInjectHere",className:"width_full"}),y(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const s=u("fshInjectHere")
r.replaceChild(q,s),e("myGuildLog",1,3),t()}()}function dt(t){J(t),function(){const t=[]
...
K.checks[e]=!K.checks[e],Z(),Q.forEach(n(rt,e,!K.checks[e]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){K.checks=D.slice(0),at(),Q.forEach(ft)}function pt(t){N(t[5]),N(t[6])}function mt(){K.checks=O.slice(0),at(),Q.forEach(pt)}function gt(){K.log=!1,Z(),f("Loading Page 1 ...",M),Q=[],V=!0,d("",u("fshInjectHere")),I(1).then(dt)}function bt(t){!function(t){K=t||K,K.checks=K.checks||D.slice(0)}(t),d(E,r),B=u("fshNewGuildLog"),M=u("fshOutput"),h(B,L([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),gt]])),at(),F=Number(p("newGuildLogHistoryPages")),$=F,I(1).then(dt)}function kt(){c()||H("fsh_guildLog").then(bt)}export default kt
//# sourceMappingURL=newGuildLog-e35a2ffc.js.map
