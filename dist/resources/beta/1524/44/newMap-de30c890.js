import{c as t,m as e,z as a,A as n,h as r,t as o,i,o as s,aN as u,aO as l,aP as c,aQ as f,Z as d,b as m,f as h,E as p,D as b,S as g,ax as v,I as y,aR as k,C as w,aK as L,aS as C,aT as D,aU as A,aV as M,aW as V,aX as S,aD as N,aM as H,B,aY as G,a3 as x,U as T,v as E,ab as j,a4 as P,aZ as I,a_ as O,P as R,u as F,a$ as _,b0 as q,b1 as K,b2 as Y,aJ as z,q as U,a as Q,M as W,b3 as J,b4 as Z,b5 as X,b6 as tt,b7 as et,l as at,ao as nt,$ as rt,ap as ot,a6 as it,b8 as st,b9 as ut,ba as lt,bb as ct,bc as ft,bd as dt,be as mt,bf as ht,bg as pt}from"./calfSystem-a8d582b6.js"
import{i as bt}from"./insertElementAfter-c54d943a.js"
import{t as gt}from"./toggleForce-46f497a3.js"
import{c as vt}from"./createSpan-f56cc9ef.js"
import{i as yt}from"./insertTextBeforeEnd-fdca4ae8.js"
import{a as kt,r as wt}from"./roundToString-8b06d154.js"
import{a as Lt}from"./addCommas-aab57e5e.js"
import{d as Ct,q as Dt}from"./quickbuffSuccess-7d1acd77.js"
import{p as At}from"./playerName-9ba8ea6b.js"
import{i as Mt}from"./isArray-e57269b2.js"
import{g as Vt,s as $t}from"./idb-d8c9a883.js"
import{c as St}from"./createStyle-d4f6dc05.js"
import{g as Nt}from"./getArrayByClassName-fd115cb0.js"
import{e as Ht}from"./executeAll-4e27c022.js"
import{c as Bt}from"./createButton-ae7066ba.js"
import{e as Gt}from"./eventHandler5-6afdc1e7.js"
import{i as xt}from"./insertElementBefore-7c440c87.js"
import{c as Tt}from"./createInput-8922c2cd.js"
import{c as Et}from"./createLabel-68fb1b3a.js"
import{o as jt}from"./openQuickBuffByName-05198165.js"
import{a as Pt}from"./all-8d04560c.js"
import{a as It}from"./allthen-c5cfa8a4.js"
import{d as Ot,g as Rt}from"./getGroupStats-57cae0bc.js"
import{g as Ft}from"./getMercStats-f8b2a592.js"
import{g as _t}from"./getProfile-d9b6d52e.js"
import{g as qt}from"./getMembrList-ba181b15.js"
...
import{h as Qt}from"./hasClasses-6e9fb120.js"
import{v as Wt}from"./valueText-27359b90.js"
import{g as Jt}from"./guild-7b16d85c.js"
import{g as Zt,a as Xt}from"./getTitanString-e08d7584.js"
import{p as te}from"./padZ-634214b3.js"
import{c as ee}from"./createTable-3028e219.js"
import{t as ae}from"./testQuant-4528e278.js"
import{g as ne}from"./groupViewStats-dd96a5b4.js"
import{m as re}from"./myStats-a3bdf6c3.js"
import{a as oe}from"./huntingBuffs-a24683f3.js"
import{b as ie}from"./simpleCheckbox-3dcaad11.js"
import{b as se}from"./bitwiseAnd-9ac724a1.js"
import{s as ue}from"./shouldBeArray-70713134.js"
import"./getBuff-710781bd.js"
import"./buffObj-1b3bee9b.js"
import"./fshOpen-d480412d.js"
import"./chunk-d354fb99.js"
import"./createLi-66d1f3a4.js"
import"./createUl-39044721.js"
...
let Be,Ge
function xe(t){Dt(t)&&GameData.fetch(u)}function Te(){Ne("Summon Shield Imp")||Ct([At()],[55]).then(xe)}const Ee=["imp-0","imp-1","imp-1"]
...
n(t,Fe),t>0&&setTimeout(Ze,500)}function Xe(t,e){e?Je(t,e):Re&&gt(Re,!0)}function ta(){qe=Ne("Death Dealer"),Ke=Ne("Doubler"),Ye=Ne("Counter Attack"),ze=Ne("Summon Shield Imp"),Ue=function(){const t=GameData.player().teleportCooldown
...
t&&(Pe(t,ze,qe),$e(t,qe,Qe,We),Ae(t,qe,We),we(t,Ye),Ce(t,Ke),Xe(t,Ue))}function aa(t,e){var a
...
Ta=Ma({prefVal:a,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(Va)}const Oa=[[t=>t===xa,function(){d("playNewMessageSound",!y("playNewMessageSound"))}],[t=>t===Ta,function(){t.huntingMode=!t.huntingMode,d("huntingMode",t.huntingMode)}]],Ra=[[t=>t===Na,function(t){V(t),GameData.doAction(12,401,{},0)}],[t=>t===Ha,function(){jt(At())}],[t=>t===Ba,function(){window.open(`${S+N}map`,"fsMap")}],[t=>t===Ga,function(){const t=GameData.realm()
window.open(`${H}realms${N}view&realm_id=${t.id}`,"mapUfsg")}]]
function Fa(){Va||(Va=e({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),Ia(),s(Va,Gt(Ra)),h(Va,"change",Gt(Oa)),xt(Va,a("worldCoord")))}function _a(t,e){$a&&e.b.minlevel&&(Da(),n(e.b.minlevel,$a))}function qa(t,e){Sa&&n(e.b,Sa)}function Ka(t){return!t||!t.response||!t.response.data}let Ya,za,Ua,Qa,Wa,Ja,Za,Xa,tn,en,an,nn,rn,on,sn,un,ln,cn,fn,dn,mn,hn,pn,bn,gn,vn,yn,kn,wn,Ln,Cn,Dn,An,Mn,Vn
...
r(n,Ya)}const Nn=[t=>"lastUpdate"!==t,t=>!Qa.includes(t),t=>Wa[t].last_login,t=>Number(Wa[t].last_login)<Ja,t=>Number(Wa[t].last_login)>Za,t=>Wa[t].level<400||Wa[t].level>421,t=>Wa[t].level<441||Wa[t].level>450]
function Hn(t,e){return e(t)}function Bn(t){return Nn.every(o(Hn,t))}function Gn(t){return`<a href="${x}${Wa[t].id}">${t}</a>`}function xn(t){Wa=t,Ja=T-120,Za=T-604800
const e=G(Wa).filter(Bn).map(Gn)
i(Ya,`<div class="fshFloatLeft fshRelicLowDiv"><table class="relicT"><thead><tr><th>${e.length.toString()} Offline guild members not at relic:</th></tr></thead><tbody><tr><td>${e.join(" ")}</td></tr></tbody></table></div>`)}function Tn(t){Kt(Ua)
const n=y("hideRelicOffline")
t.is_owner&&!n&&qt(!0).then(xn),i(za,'<table class="relicT"><thead><tr><th colspan="2">Processing</th></tr></thead><tbody><tr><td class="fshGreen" colspan="2" id="ProcessingStatus">Parsing defending guild stats ...</td></tr></tbody><thead><tr><th colspan="2">Assumptions</th></tr></thead><tbody><tr><td colspan="2" class="fshGrey">Above calculations include Constitution, Fortitude, Nightmare Visage, Chi Strike, Sanctuary, Terrorize and Flinch bonus calculations (in that order) on both the defending group and attacking group.</td></tr></tbody></table>'),Vn=a("ProcessingStatus")
...
r(Ya,o),Xa=a("relicCount"),tn=a("LDPercentage"),en=a("LDCloaked"),an=a("attackValue"),nn=a("attackValueBuffed"),rn=a("defenseValue"),on=a("defenseValueBuffed"),sn=a("armorValue"),un=a("armorValueBuffed"),ln=a("damageValue"),cn=a("damageValueBuffed"),fn=a("hpValue"),dn=a("hpValueBuffed"),mn=a("defendersCloaked"),hn=a("defendersProcessed")
...
return function(t,e){In.forEach(o(On,t,e))}(a,t),function(t,e){Rn.forEach(o(Fn,t,e))}(a,e),a.superEliteSlayerMultiplier=kt(.002*a.superEliteSlayerLevel,2),Yt(a.armorValue)&&function(t){t.attackValue=Pn(t.attackBonus,t.levelValue),t.defenseValue=Pn(t.defenseBonus,t.levelValue),t.armorValue=Pn(t.armorBonus,t.levelValue),t.damageValue=Pn(t.damageBonus,t.levelValue),t.hpValue=t.hpBonus}(a),a}let qn,Kn,Yn,zn,Un,Qn,Wn,Jn,Zn,Xn,tr,er,ar,nr
function rr(t){return Math.round(t*En)}function or(){Me(qn,an),Me(Yn,rn),Me(zn,sn),Me(Un,ln),Me(Wn,fn),n(Jn,mn),Zn+=1,n(Zn,hn)}function ir(t){const e=function(t){return Math.ceil(tr.attack*(.0025*P(t["Nightmare Visage"],0)))}(t)
...
Me(Qn-e,cn)}(t),n("Done.",Vn)}function ur(){n("Processing defending guild stats ... ",Vn),qn+=rr(Xn.attackValue),Yn+=rr(Xn.defenseValue),zn+=rr(Xn.armorValue),Un+=rr(Xn.damageValue),Wn+=rr(Xn.hpValue),or()
const t=Math.ceil(qn*(.0025*Xn.nightmareVisageLevel))
!function(t){Kn=qn-t,Me(Kn,nn)}(t)
const e=Math.ceil(Yn*(1+.001*Xn.constitutionLevel))
...
return GameData.player().hasGroup&&t.push(F({cmd:"guild",subcmd:"groups"}).then(hr)),t=t.concat(Qa.map(pr)),t}function gr(){Tn(ar),qn=0,Yn=0,zn=0,Un=0,Wn=0,Jn=0,Zn=0
const t=br()
...
return a&&(n.className="fshBlue"),function(t,e){e.forEach(o(Kr,t))}(n,e),n}function zr(t,e){Yr(t,e[0],e[1])}function Ur(t,e){e.forEach(o(zr,t))}let Qr,Wr,Jr,Zr,Xr,to,eo,ao,no,ro,oo,io,so,uo,lo,co,fo,mo,ho,po,bo,go,vo,yo,ko,wo,Lo,Co
...
return`${te(e.getHours())}:${te(e.getMinutes())} ${te(e.getDate())}/${ot[e.getMonth()]}/${e.getFullYear()}`}(t)}</span>`}function Bo(t){return wt(Zt(t.max_hp-t.current_hp,t.kills),2)}function Go(t){return wt(100*t.kills/t.max_hp,2)}function xo(t){[[t.current_hp,ro],[t.max_hp,oo],[t.kills,io],[Bo(t),so],[Go(t),uo]].forEach((([t,e])=>{n(t,e)})),B(function(t){return Xt(t.kills,t.max_hp,t.current_hp)}(t),lo),B(Ho(t.cooldown),co)}function To(t,e){return[[[2,Oe(e.player.name)],[2,Oe(e.kills.toString())],[2,Oe(`${wt(100*e.kills/t.kills,2)}%`)]]]}function Eo(t){return t.realm&&t.creature.base_id===ho&&t.realm===Qr}function jo(t){const e=t.find(Eo)
...
It(e,Ko)}function zo(){yo?n("",Lo):(yo=e({className:"fshClear",textContent:"Select how many to quick-buy:"}),ko=Tt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),r(yo,ko),wo=Bt({textContent:"Quick-buy"}),s(wo,Yo),r(yo,wo),Lo=e(),r(yo,Lo),r(go,yo))}function Uo(t,e){bo=e,go=go||a("shopDialogConfirm"),go&&(vo=vo||$(go).data("hcsWorldDialogShopConfirm"),vo&&zo())}function Qo(t){Co[t.name]?Co[t.name].seen&&(Co[t.name].seen+=1):(Co[t.name]={seen:1},function(t,e){e.creature_class=t.creature_class,e.image_id=t.image_id,e.level=Number(t.level),e.type=t.type}(t,Co[t.name]))}function Wo(t,e,a){return e?t(e,a):a}function Jo(t,e){const a=t||{}
...
Yi(t,e,{groupExists:!0,groupAttackValue:n[0].value,groupDefenseValue:n[1].value,groupArmorValue:n[2].value,groupDamageValue:n[3].value,groupHPValue:n[4].value})}function Wi(t,e,a){a&&function(t){return rt(fi,li,t)}(a).then(o(Qi,t,e))}function Ji(t,e){rt(di).then(Ui).then(o(Wi,t,e))}function Zi(t,e){t.player.hasGroup&&Ji(t,e),Yi(t,e,{groupExists:!1})}function Xi(t,e){Ni||(Ni=a("dialog-viewcreature")),Ni&&(_i(""),qi(""),function(t){return t.response&&t.response.data}(e)&&(Ri(e.response.data.name,Ni),re(!0).then(o(Zi,e))))}function ts(){const e=[,[t.buffs,t.buffsName],[t.buffs2,t.buffs2Name],[t.buffs3,t.buffs3Name]][t.enabledHuntingMode]
Mt(e)&&([xi,Ti]=e)}function es(e){"enabledHuntingMode"===e.target.name&&(t.enabledHuntingMode=e.target.value,d("enabledHuntingMode",t.enabledHuntingMode),ts(),GameData.fetch(u))}function as(t){const e=W("verbs",t)
...
return xt(t,i),o}function ss(t,e){return t[e.name]=!0,t}function us(t,e,a){return t[a.trim()]||e.push(a),e}function ls(t){B("",t)}function cs(t,e){const a=e.b.reduce(ss,{}),n=xi.reduce(o(us,a),[])
n.length>0?function(t,e){B(`You are missing some ${Ti} hunting buffs<br>(${e.join(", ")})`,t)}(t,n):ls(t)}function fs(e,a,n){xi&&function(e,a,n){t.showBuffs?cs(e,n):ls(e)}(e,0,n)}const ds=[{generalVariable:1.1053,hpVariable:1.1},{generalVariable:1.1,hpVariable:1.053},{generalVariable:1.053,hpVariable:1},{generalVariable:1.1053,hpVariable:1}]
function ms(){var e
...
//# sourceMappingURL=newMap-de30c890.js.map
