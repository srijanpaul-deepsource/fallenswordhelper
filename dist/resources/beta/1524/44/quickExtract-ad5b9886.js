import{y as t,B as e,h as n,o as i,p as s,t as r,aY as a,z as o,ax as c,bt as f}from"./calfSystem-a8d582b6.js"
import{c as d}from"./createTable-3028e219.js"
import{d as l}from"./daUseItem-aa7b1f89.js"
import{e as m}from"./eventHandler5-6afdc1e7.js"
import{g as u}from"./getInventory-32842db0.js"
import{j as p}from"./jConfirm-db352051.js"
import{j as h,o as b}from"./jsonFail-df6266d8.js"
import{s as x}from"./selfIdIs-c093665f.js"
...
e(`extracting all ${n.length} resources`,t.parentNode),n.forEach(w)}function F(t){p("Extract Resources","Are you sure you want to extract all similar items?",r(D,t))}function Y(t){return function(t){return I&&-1!==t.folder_id}(t)||function(t){return!v&&t.is_in_st}(t)}function q(t,e){return Y(e)||(t[e.item_id]?t[e.item_id].invIDs.push(e.inv_id):t[e.item_id]={invIDs:[e.inv_id],inv_id:e.inv_id,item_name:e.item_name}),t}function A(t,e){const n=$[e]
...
t+=a($).reduce(A,""),e(t,y),g=o("qeresult")}function M(t){return"Zombie Coffin"===t.item_name||12===t.type||16===t.type}function H(t){_=t.player_id,j=t.items.filter(M),C()}function O(){v=!v,C()}function R(){I=!I,C()}function T(t){return t.id.startsWith("fshExtr")}function z(r){if(t())return
const a=r||s
...
//# sourceMappingURL=quickExtract-ad5b9886.js.map
