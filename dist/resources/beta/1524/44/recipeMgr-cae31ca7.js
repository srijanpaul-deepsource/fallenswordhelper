import{d as t}from"./doSortParams-f44d8040.js"
import{I as e,aH as n,B as i,z as r,g as s,v as a,i as o,t as c,C as d,ai as p,aJ as u,M as m,m as f,h,u as l,y as g,o as b,p as $}from"./calfSystem-a8d582b6.js"
import{s as v,g as x}from"./idb-d8c9a883.js"
import{s as _}from"./shouldBeArray-70713134.js"
import{a as y}from"./stringSort-1917623b.js"
import{a as N}from"./all-8d04560c.js"
...
return N(i)}function z(t){return/\/folder_on\./.test(t.getAttribute("src"))}function M(t,e){return 0!==e}function H(t){return t.value}function J(t,e,n){return u(`${t}&page=${n}`).then(e)}function D(t,e,n){return function(t){return s("option",m("customselect",r("pCC",t))[0]).filter(M).map(H)}(t).map(c(J,e,n))}function G(t,e,n){const i=a(n),r=function(t){return I(t).find(z).parentNode.href}(i),s=c(q,t,e),o=D(i,r,s)
...
return i&&o(t,`Skipping folder "${n}"  as it has the word "quest" in folder name.<br>`),!i}function Q(t,e){return u(e.parentNode.href).then(t)}function U(t,e,n){const i=c(G,t,e),r=function(t,e,n){return I(a(e)).filter(K).filter(c(O,t)).map(c(Q,n))}(t,n,i)
...
//# sourceMappingURL=recipeMgr-cae31ca7.js.map
