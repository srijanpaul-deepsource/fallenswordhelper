import{r as e,B as t,t as n,aw as s,ac as o,_ as a,aC as i,D as c,m as r,Q as l,T as m,i as p,aD as u,E as d,h as f,o as g,p as h,A as b,c as v,aE as C,C as S,a7 as E,j,I as k,z as N,M as x}from"./calfSystem-1d588248.js"
import{r as A,g as y}from"./rnd-2b9883c8.js"
import{p as $,s as B}from"./pubsub-33134906.js"
import{c as I}from"./createInput-7d18793e.js"
import{c as L}from"./createTable-70d127ad.js"
import{g as q}from"./getArrayByClassName-8fef58fe.js"
import{i as T}from"./insertElementAfter-2b08ccae.js"
import{i as F}from"./insertHtmlAfterEnd-8414b2b7.js"
import{i as w}from"./insertElementBefore-23d4e956.js"
...
s&&n&&(n.error?t(`<div class="fshScs">${n.error}</div>`,s):Q(e))}function D(t){var s;(s=t.value,e({cache:!1,dataType:"json",data:{cmd:"composing",subcmd:"createajax",template_id:s,fshrnd:A()}})).then(n(_,t))}function M(e,n){n.id=`proc-${n.id}`,t("",e),e.classList.add("fshSpinner","fshSpinner12","fshComposingSpinner"),D(n),$("quickcreate")}function z(e,t){e.classList.add(`left-${t.toString()}`)}function H(e){z(e,o(".quickCreate .sendLink").length)}function R(e){const t=e.target,{templateId:n}=t.dataset
n&&function(e,t){m("composing","FastComposeButton")
const n=o('[id|="composing-template"]:not(#composing-template-multi)')
if(!(n.length<e.value))for(let s=0;s<e.value;s+=1)n[s].value=t,M(n[s].nextElementSibling.nextElementSibling,n[s])}(t,n)}function G(e,t,n,s){var o,a
...
return z(o,s),e.reduce(n(J,t,s),o)}(d("#composing-template-multi option").map(K),t,s)
f(e,o),g(h,R),B("quickcreate",n(H,o))}function U(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-cd285492.js.map
