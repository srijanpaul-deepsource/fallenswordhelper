import{c as t,m as e,z as a,A as n,h as r,t as o,i,o as s,aR as u,aS as l,aT as c,aU as f,_ as d,b as m,f as h,E as p,D as b,S as g,aB as v,I as y,aV as k,C as w,aO as L,a7 as C,aW as D,aX as A,aY as M,aZ as V,a_ as S,aH as H,aQ as N,B,a$ as G,a4 as T,U as x,v as E,ae as j,a5 as P,b0 as I,b1 as O,P as R,u as F,b2 as _,b3 as q,b4 as Y,b5 as K,aN as z,q as U,a as Q,M as W,b6 as J,b7 as X,b8 as Z,b9 as tt,ba as et,l as at,as as nt,$ as rt,at as ot,a9 as it,bb as st,bc as ut,bd as lt,be as ct,bf as ft,bg as dt,bh as mt,bi as ht,bj as pt}from"./calfSystem-8af1dca2.js"
import{i as bt}from"./insertElementAfter-62f0d2ad.js"
import{t as gt}from"./toggleForce-5151034c.js"
import{c as vt}from"./createSpan-0e686680.js"
import{i as yt}from"./insertTextBeforeEnd-e1a8b428.js"
import{a as kt,r as wt}from"./roundToString-a22b7b5d.js"
import{a as Lt}from"./addCommas-5de3e9c4.js"
import{d as Ct,q as Dt}from"./quickbuffSuccess-7a376d0f.js"
import{p as At}from"./playerName-7218c72a.js"
import{i as Mt}from"./isArray-f9d2634e.js"
import{g as Vt,s as $t}from"./idb-30d71a28.js"
import{c as St}from"./createStyle-6339f1bb.js"
import{g as Ht}from"./getArrayByClassName-11de01ae.js"
import{e as Nt}from"./executeAll-ff401d51.js"
import{c as Bt}from"./createButton-a1d9b50b.js"
import{e as Gt}from"./eventHandler5-0af2fe99.js"
import{i as Tt}from"./insertElementBefore-5adb1609.js"
import{c as xt}from"./createInput-75b7145b.js"
import{c as Et}from"./createLabel-02b3d8e2.js"
import{o as jt}from"./openQuickBuffByName-ad6d10b7.js"
import{a as Pt}from"./all-f24d81d0.js"
import{a as It}from"./allthen-d828bb84.js"
import{d as Ot,g as Rt}from"./getGroupStats-8593f997.js"
import{g as Ft}from"./getMercStats-16277974.js"
import{g as _t}from"./getProfile-9774b117.js"
import{g as qt}from"./getMembrList-cb94da61.js"
...
import{h as Qt}from"./hasClasses-7e69153f.js"
import{v as Wt}from"./valueText-ad23c08d.js"
import{g as Jt}from"./guild-08a09d6e.js"
import{g as Xt,a as Zt}from"./getTitanString-e6d381cf.js"
import{p as te}from"./padZ-b9e73e86.js"
import{c as ee}from"./createTable-0267c13e.js"
import{t as ae}from"./testQuant-471ee892.js"
import{g as ne}from"./groupViewStats-11eeb586.js"
import{m as re}from"./myStats-ad917b7b.js"
import{a as oe}from"./huntingBuffs-2bdb364f.js"
import{b as ie}from"./simpleCheckbox-1071aa74.js"
import{b as se}from"./bitwiseAnd-47494c9b.js"
import{s as ue}from"./shouldBeArray-c0e8ef84.js"
import"./getBuff-d3b42e1e.js"
import"./buffObj-7ab8e1a0.js"
import"./fshOpen-b549d330.js"
import"./chunk-7ed9b1d2.js"
import"./createLi-77d13fd9.js"
import"./createUl-c13e9145.js"
...
return kt(a,2).toString()}return"0"}(e,Number(a)),pe)}function Ae(t,e,a){e?De(t,e,a):he&&gt(he,!0)}function Me(t,e){n(Lt(t),e)}function Ve(t,e){be?gt(be,!1):function(t){be=t.children[1],n("Kill Streak: ",be),ge=vt(),r(be,ge)}(t),Me(e,ge)}function $e(t,e,a,n){e||a?Ve(t,n):be&&gt(be,!0)}function Se(t,e){return e.name===t}function He(t){const{buffs:e}=GameData.player()
if(e)return e.find(o(Se,t))}const Ne=["red","orange","yellow"]
let Be,Ge
function Te(t){Dt(t)&&GameData.fetch(u)}function xe(){He("Summon Shield Imp")||Ct([At()],[55]).then(Te)}const Ee=["imp-0","imp-1","imp-1"]
...
Be.className=function(t){return Ee[t]||"fshGreen"}(a),n(a,Ge)}function Pe(t,e,a){e||a?je(t,e):Be&&gt(Be,!0)}function Ie(t){return 0===t.type}function Oe(t){return vt({textContent:t})}let Re,Fe,_e,qe,Ye,Ke,ze,Ue,Qe,We
...
n(t,Fe),t>0&&setTimeout(Xe,500)}function Ze(t,e){e?Je(t,e):Re&&gt(Re,!0)}function ta(){qe=He("Death Dealer"),Ye=He("Doubler"),Ke=He("Counter Attack"),ze=He("Summon Shield Imp"),Ue=function(){const t=GameData.player().teleportCooldown
...
1===t.length&&t.css("background-color",Ne[t.text()]||"#ad8043")}(),ta()
const t=ye([qe,Ye,Ke,ze,Ue,Qe])
t&&(Pe(t,ze,qe),$e(t,qe,Qe,We),Ae(t,qe,We),we(t,Ke),Ce(t,Ye),Ze(t,Ue))}function aa(t,e){var a
...
Ht("creature",t).forEach(ya)}function wa(t){const e=GameData.actions()[t]
...
return r(a,i),r(t.worldName,a),n}let Va,$a,Sa,Ha,Na,Ba,Ga,Ta,xa
...
ja(e=Va),Ha=Pa("fshFormGroup","Quick Create Attack Group",e),Na=Pa("fshQuickBuff","Open Quick Buff Popup",e),Ba=Pa("fshRealmMap","Open Realm Map",e),Ga=Pa("fshTempleOne","Search map in Ultimate FSG",e),function(t){if(y("showSpeakerOnWorld")){const e=y("playNewMessageSound")
...
xa=Ma({prefVal:a,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(Va)}const Oa=[[t=>t===Ta,function(){d("playNewMessageSound",!y("playNewMessageSound"))}],[t=>t===xa,function(){t.huntingMode=!t.huntingMode,d("huntingMode",t.huntingMode)}]],Ra=[[t=>t===Ha,function(t){V(t),GameData.doAction(12,401,{},0)}],[t=>t===Na,function(){jt(At())}],[t=>t===Ba,function(){window.open(`${S+H}map`,"fsMap")}],[t=>t===Ga,function(){const t=GameData.realm()
window.open(`${N}realms${H}view&realm_id=${t.id}`,"mapUfsg")}]]
function Fa(){Va||(Va=e({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),Ia(),s(Va,Gt(Ra)),h(Va,"change",Gt(Oa)),Tt(Va,a("worldCoord")))}function _a(t,e){$a&&e.b.minlevel&&(Da(),n(e.b.minlevel,$a))}function qa(t,e){Sa&&n(e.b,Sa)}function Ya(t){return!t||!t.response||!t.response.data}let Ka,za,Ua,Qa,Wa,Ja,Xa,Za,tn,en,an,nn,rn,on,sn,un,ln,cn,fn,dn,mn,hn,pn,bn,gn,vn,yn,kn,wn,Ln,Cn,Dn,An,Mn,Vn
function $n(t){return t.player_name}function Sn(t){!function(t){Qa=t.defenders.map($n)}(t),Ka?B("",Ka):Ka=e({className:"body"}),function(t){za=e({className:"fshFloatLeft fshRelicLeftDiv"}),r(Ka,za),t.is_owner&&r(za,Ot(Qa)),Ua=Bt({className:"custombutton",textContent:"Fetch Stats"}),r(za,Ua)}(t)
const n=a("dialog-relic")
r(n,Ka)}const Hn=[t=>"lastUpdate"!==t,t=>!Qa.includes(t),t=>Wa[t].last_login,t=>Number(Wa[t].last_login)<Ja,t=>Number(Wa[t].last_login)>Xa,t=>Wa[t].level<400||Wa[t].level>421,t=>Wa[t].level<441||Wa[t].level>450]
function Nn(t,e){return e(t)}function Bn(t){return Hn.every(o(Nn,t))}function Gn(t){return`<a href="${T}${Wa[t].id}">${t}</a>`}function Tn(t){Wa=t,Ja=x-120,Xa=x-604800
...
r(Ka,o),Za=a("relicCount"),tn=a("LDPercentage"),en=a("LDCloaked"),an=a("attackValue"),nn=a("attackValueBuffed"),rn=a("defenseValue"),on=a("defenseValueBuffed"),sn=a("armorValue"),un=a("armorValueBuffed"),ln=a("damageValue"),cn=a("damageValueBuffed"),fn=a("hpValue"),dn=a("hpValueBuffed"),mn=a("defendersCloaked"),hn=a("defendersProcessed")
...
return function(t,e){In.forEach(o(On,t,e))}(a,t),function(t,e){Rn.forEach(o(Fn,t,e))}(a,e),a.superEliteSlayerMultiplier=kt(.002*a.superEliteSlayerLevel,2),Kt(a.armorValue)&&function(t){t.attackValue=Pn(t.attackBonus,t.levelValue),t.defenseValue=Pn(t.defenseBonus,t.levelValue),t.armorValue=Pn(t.armorBonus,t.levelValue),t.damageValue=Pn(t.damageBonus,t.levelValue),t.hpValue=t.hpBonus}(a),a}let qn,Yn,Kn,zn,Un,Qn,Wn,Jn,Xn,Zn,tr,er,ar,nr
function rr(t){return Math.round(t*En)}function or(){Me(qn,an),Me(Kn,rn),Me(zn,sn),Me(Un,ln),Me(Wn,fn),n(Jn,mn),Xn+=1,n(Xn,hn)}function ir(t){const e=function(t){return Math.ceil(tr.attack*(.0025*P(t["Nightmare Visage"],0)))}(t)
...
Me(Qn-e,cn)}(t),n("Done.",Vn)}function ur(){n("Processing defending guild stats ... ",Vn),qn+=rr(Zn.attackValue),Kn+=rr(Zn.defenseValue),zn+=rr(Zn.armorValue),Un+=rr(Zn.damageValue),Wn+=rr(Zn.hpValue),or()
const t=Math.ceil(qn*(.0025*Zn.nightmareVisageLevel))
!function(t){Yn=qn-t,Me(Yn,nn)}(t)
const e=Math.ceil(Kn*(1+.001*Zn.constitutionLevel))
...
return a&&(n.className="fshBlue"),function(t,e){e.forEach(o(Yr,t))}(n,e),n}function zr(t,e){Kr(t,e[0],e[1])}function Ur(t,e){e.forEach(o(zr,t))}let Qr,Wr,Jr,Xr,Zr,to,eo,ao,no,ro,oo,io,so,uo,lo,co,fo,mo,ho,po,bo,go,vo,yo,ko,wo,Lo,Co
...
return r(e,t),yt(e,"%"),e}function $o(){ho=null,mo&&!at("fshHide",mo)&&(gt(mo,!0),n("",ro),n("",oo),n("",io),n("",so),n("",uo),B("",lo),B("",co),Ao())}function So(t){return 0===t.type&&(ho=t.base_creature_id,!0)}function Ho(){if(mo)gt(mo,!1)
else{const t=a("actionContainer")
mo=e({className:"fshActionBox titanInfo"}),ro=vt(),oo=vt(),io=vt(),so=vt(),uo=vt(),lo=vt(),co=vt(),fo=ee({className:"fshCenter"}),Do(),Ur(fo,[[[[2,eo,!0],[4,no,!0]]],[[[2,Mo()],[4,io]]],[[[2,Wr,!0],[4,Vo(so)]],!0],[[[2,ao,!0],[4,Vo(uo)]],!0],[[[2,to,!0],[4,lo]],!0],[[[6,co]]],[[[2,Xr,!0],[2,Jr,!0],[2,Zr,!0]]]]),r(mo,fo),r(t,mo)}}function No(t){return t<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(t){const e=new Date(it+1e3*t)
return`${te(e.getHours())}:${te(e.getMinutes())} ${te(e.getDate())}/${ot[e.getMonth()]}/${e.getFullYear()}`}(t)}</span>`}function Bo(t){return wt(Xt(t.max_hp-t.current_hp,t.kills),2)}function Go(t){return wt(100*t.kills/t.max_hp,2)}function To(t){[[t.current_hp,ro],[t.max_hp,oo],[t.kills,io],[Bo(t),so],[Go(t),uo]].forEach((([t,e])=>{n(t,e)})),B(function(t){return Zt(t.kills,t.max_hp,t.current_hp)}(t),lo),B(No(t.cooldown),co)}function xo(t,e){return[[[2,Oe(e.player.name)],[2,Oe(e.kills.toString())],[2,Oe(`${wt(100*e.kills/t.kills,2)}%`)]]]}function Eo(t){return t.realm&&t.creature.base_id===ho&&t.realm===Qr}function jo(t){const e=t.find(Eo)
e&&(To(e),function(t){if(Ao(),!t.contributors)return
const e=t.contributors.map(o(xo,t))
Ur(fo,e)}(e))}function Po(e){return t.showTitanInfo&&Mt(e)&&e.some(So)}function Io(t,e){(function(t){return t&&t.s&&Mt(t.r)})(e)&&(jo(e.r),Po(GameData.realm().dynamic)?po=window.setTimeout(t,3e4):$o())}function Oo(){rt(qr).then(o(Io,Oo))}function Ro(t){po&&(window.clearTimeout(po),po=null),Po(t)?(Ho(),Oo()):$o()}function Fo(t){var e
...
1===e.length&&([Vi]=e)}}(e),Vi&&($i=t.trim(),Oi())}function Fi(){Bi||(Ni||(Ni=e(),r(Hi,Ni),r(Hi,e({innerHTML:'<span class="fshFooter">*Does include CA, DD, HF, DC, Flinch, Super Elite Slayer, NMV, Sanctuary, Constitution, Fortitude, Chi Strike and Terrorize (if active) and allow for randomness (1.1053). Constitution, NMV, Fortitude and Chi Strike apply to group stats.</span>'}))),Bi=e(),r(Ni,Bi))}function _i(t){Fi(),B(t,Bi)}function qi(t){Gi||(Fi(),Gi=e(),r(Ni,Gi)),B(t,Gi)}function Yi(t,e){const a={name:t.name,class:t.creature_class,attack:Number(t.attack),defense:Number(t.defense),armor:Number(t.armor),damage:Number(t.damage),hp:Number(t.hp)}
...
Ki(t,e,{groupExists:!0,groupAttackValue:n[0].value,groupDefenseValue:n[1].value,groupArmorValue:n[2].value,groupDamageValue:n[3].value,groupHPValue:n[4].value})}function Wi(t,e,a){a&&function(t){return rt(fi,li,t)}(a).then(o(Qi,t,e))}function Ji(t,e){rt(di).then(Ui).then(o(Wi,t,e))}function Xi(t,e){t.player.hasGroup&&Ji(t,e),Ki(t,e,{groupExists:!1})}function Zi(t,e){Hi||(Hi=a("dialog-viewcreature")),Hi&&(_i(""),qi(""),function(t){return t.response&&t.response.data}(e)&&(Ri(e.response.data.name,Hi),re(!0).then(o(Xi,e))))}function ts(){const e=[,[t.buffs,t.buffsName],[t.buffs2,t.buffs2Name],[t.buffs3,t.buffs3Name]][t.enabledHuntingMode]
...
function Ss(){Nt($s)}export default Ss
//# sourceMappingURL=newMap-dc35d1ab.js.map
