import{u as e,B as t,C as n,bF as s,H as a,T as r,Z as i,y as o,q as c,G as l,c as u,m as d,bJ as b,bH as f,A as p,bO as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-dfa26790.js"
import{f as $}from"./functionPasses-055e6e36.js"
import{s as w}from"./shouldBeArray-b1529a04.js"
import{i as x}from"./insertElementAfterBegin-549a1b31.js"
...
function Z(){return d({className:"minibox"})}function z(){f("bountyList",B),p("",G)
...
var n
y(G,t)}function D(){f("wantedList",T),p("",q)
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),H=a("bountyListRefreshTime"),S=a("bwNeedsRefresh"),S||P()&&(S=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,W=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,D()),e&&(B.isRefreshed=!1,z())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===F&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=Z(),x(b,q)),u.enableActiveBountyList&&(G=Z(),x(b,G)),G&&v(G,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-c256ea4c.js.map
