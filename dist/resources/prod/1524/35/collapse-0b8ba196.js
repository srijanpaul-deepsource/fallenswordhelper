import{N as o,t as n,o as t,a5 as e,z as c,f as r,_ as a,ay as f}from"./calfSystem-fe0ebf32.js"
import{h as s}from"./hideElement-2c661b2e.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],N(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function L(o){h=!h,a(o,h),h?l():u.forEach(b),u.forEach(j)}function y(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(L,o))}(e.prefName),o(e.theTable.rows).forEach(n(T,e)),t(e.theTable,I)}export{y as c}
//# sourceMappingURL=collapse-0b8ba196.js.map
