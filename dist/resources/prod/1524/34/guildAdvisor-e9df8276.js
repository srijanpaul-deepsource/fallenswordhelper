import{n as t,m as s,h as a,a as e,t as n,a2 as r,A as i,i as c,x as l,b as o,p as d,c as u,M as f,J as m,a7 as p,G as h,B as v}from"./calfSystem-793da633.js"
import{g as b}from"./getMembrList-b3463327.js"
import{a as g}from"./addCommas-4b913655.js"
import{a as j}from"./allthen-9dd15411.js"
import{g as B}from"./guild-367418e5.js"
import{c as y}from"./createTable-1ddc44c4.js"
import{r as C}from"./replaceChild-e2d91676.js"
import{i as S}from"./insertHtmlAfterEnd-7508c2c1.js"
import{l as T}from"./loadDataTables-90a93506.js"
...
0!==t.length&&S(t[0],`<span> <a href="${p}guild&subcmd=advisor&subcmd2=weekly">7-Day Summary</a></span>`)}()}function K(t){"weekly"===u.subcmd2?function(t){i('<span class="fshCurveContainer fshFlex"><span class="fshCurveEle fshCurveLbl fshOldSpinner"></span><span class="fshSpinnerMsg">&nbsp;Retrieving daily data ...</span></span>',t)
const s=[b(!1)].concat([1,2,3,4,5,6,7].map(n(F,t)))
j(s,n(O,t))}(t):b(!1).then(n(z,t))}function Q(){if(l())return
const t=o("table",d)[1]
t&&T().then((()=>K(t)))}export default Q
//# sourceMappingURL=guildAdvisor-e9df8276.js.map
