import{r as e,A as t,t as n,ai as s,aa as o,Z as a,ap as i,C as c,m as r,P as l,V as m,i as p,aq as u,D as d,h as f,o as g,p as h,z as b,c as v,ar as C,B as S,a5 as E,j,H as k,y as N,J as x}from"./calfSystem-0708a9bb.js"
import{r as y,g as A}from"./rnd-1c8c3b81.js"
import{p as $,s as q}from"./pubsub-0a5e29ce.js"
import{c as B}from"./createInput-d5428169.js"
import{c as L}from"./createTable-164d9526.js"
import{g as I}from"./getArrayByClassName-a297542c.js"
import{i as F}from"./insertElementAfter-23e2c3dd.js"
import{i as P}from"./insertHtmlAfterEnd-409ee96b.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],B({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function V(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function Z(e){return[e.value,e.text]}function G(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return D(o,s),e.reduce(n(V,t,s),o)}(d("#composing-template-multi option").map(Z),t,s)
f(e,o),g(h,M),q("quickcreate",n(J,o))}function K(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-9b0f48d1.js.map
