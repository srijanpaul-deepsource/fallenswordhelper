import{aN as e,t as n,I as t,bv as a,a7 as s,a5 as l,_ as i,ag as r,y as o,o as f,f as c,v as u}from"./calfSystem-7a1cce43.js"
import{c as h}from"./currentGuildId-c3cf68bc.js"
import{i as d}from"./intValue-ba9b9e5a.js"
import{a as p,g as v}from"./levelHighlight-cab708d7.js"
import{n as m}from"./numberIsNaN-30cde299.js"
import{l as g,p as y}from"./lvlTests-57aa73a7.js"
import{l as M}from"./loadDataTables-40abef4b.js"
import{o as L}from"./onlinePlayersPage-ed7eff2a.js"
import{g as b,s as P}from"./idb-c572d898.js"
...
return s-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),b("fsh_onlinePlayers").then(H),f(_[0],B),c(_[0],"keyup",O)}function F(e){o()||(_=e?$(e):$("#pCC"),M().then(E))}export default F
//# sourceMappingURL=injectOnlinePlayers-03e01b3f.js.map
