import{r as e,B as t,t as n,aA as s,ad as o,Z as a,aH as i,D as c,m as r,P as l,S as m,i as p,aI as u,E as f,h as d,o as g,p as h,A as b,c as v,aJ as C,C as S,a8 as E,j,I as k,z as N,M as x}from"./calfSystem-85fa6364.js"
import{r as A,g as y}from"./rnd-9a282b09.js"
import{p as I,s as $}from"./pubsub-5f4bae38.js"
import{c as B}from"./createInput-6b491c72.js"
import{c as L}from"./createTable-0c2a35a9.js"
import{g as q}from"./getArrayByClassName-4fe5cf41.js"
import{i as F}from"./insertElementAfter-2e9b5c5c.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],B({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function Z(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function G(e){return[e.value,e.text]}function K(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return z(o,s),e.reduce(n(Z,t,s),o)}(f("#composing-template-multi option").map(G),t,s)
d(e,o),g(h,J),$("quickcreate",n(D,o))}function O(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-af630f06.js.map
