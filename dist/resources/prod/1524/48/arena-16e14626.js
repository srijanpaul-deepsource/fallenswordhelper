...
import{ak as a,E as e,e as s,t as r,au as o,d as i,x as c,q as f,y as l,S as d,I as u,av as m,aw as p}from"./calfSystem-85fa6364.js"
import{s as v,g as h}from"./idb-160add45.js"
...
import{l as T,p as j}from"./lvlTests-20be337c.js"
import{i as _}from"./interceptSubmit-6f4d5b99.js"
import{l as k}from"./loadDataTables-632c755a.js"
import{c as w}from"./currentGuildId-01e2fed9.js"
...
1===t.children(i).length&&t.attr("data-order",t.find("td").first().text().replace(/[,\s]/g,""))}(e)}const K=n=>[n,Number(n.previousElementSibling.value)]
...
3!==t?e.order([3,"asc"],[t,a]).draw():e.order([3,a]).draw()}(t,t.index(),a)}function en(n){return c(f({cmd:"arena"},n))}function sn(){return en({subcmd:"view"})}function rn(n,t){const a=$("tr",t).first()
$("a",a).contents().unwrap(),$(t).prepend($("<thead/>").append(a))}function on(){R(),D(),$.fn.dataTable.ext.search.push(O)}function cn(n,[t,o,i]){const c=$('table[width="635"]',n)
c.each(rn),function(n){S=n||{},C=S.id||{},S.id={}}(t),function(n){n.children("tbody").children("tr").each(V)}(c),function(n){if(!a(n))return
...
v("fsh_arenaFull",o)}(o),nn(i),on(),c.DataTable(M),function(n){$(tn,n).off("click"),n.on("click",tn,an)}(n)}function fn(n,t){const a=u("betaOptIn")
a&&m("arena.process"),e('#arenaTypeTabs tr[style="display: none;"]').forEach((n=>n.remove())),cn(n,t),_(),a&&p("arena.process")}function ln(){if(l())return
...
//# sourceMappingURL=arena-16e14626.js.map
