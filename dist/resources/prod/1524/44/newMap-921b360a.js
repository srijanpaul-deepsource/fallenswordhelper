import{c as e,m as t,z as a,A as n,h as r,t as o,i,o as s,aL as u,aM as l,aN as c,aO as f,Z as d,b as m,f as h,E as p,D as b,S as g,av as v,I as y,aP as k,C as w,aI as L,aQ as C,aR as D,aS as A,aT as M,aU as V,aV as S,aB as H,aK as N,B,aW as G,a3 as T,U as x,v as E,ab as j,a4 as P,aX as I,aY as O,P as R,u as F,aZ as _,a_ as q,a$ as K,b0 as Y,aH as z,q as U,a as Q,M as W,b1 as J,b2 as Z,b3 as X,b4 as ee,b5 as te,l as ae,ao as ne,$ as re,ap as oe,a6 as ie,b6 as se,b7 as ue,b8 as le,b9 as ce,ba as fe,bb as de,bc as me,bd as he,be as pe}from"./calfSystem-6ad077b7.js"
import{i as be}from"./insertElementAfter-4dbced0a.js"
import{t as ge}from"./toggleForce-46f497a3.js"
import{c as ve}from"./createSpan-b08aa35e.js"
import{i as ye}from"./insertTextBeforeEnd-72649cc9.js"
import{a as ke,r as we}from"./roundToString-8b06d154.js"
import{a as Le}from"./addCommas-aab57e5e.js"
import{d as Ce,q as De}from"./quickbuffSuccess-75093bea.js"
import{p as Ae}from"./playerName-7e6569ce.js"
import{i as Me}from"./isArray-e57269b2.js"
import{g as Ve,s as $e}from"./idb-9caca870.js"
import{c as Se}from"./createStyle-ed624664.js"
import{g as He}from"./getArrayByClassName-a6fe264a.js"
import{e as Ne}from"./executeAll-4e27c022.js"
import{c as Be}from"./createButton-4c9b3216.js"
import{e as Ge}from"./eventHandler5-d64d204e.js"
import{i as Te}from"./insertElementBefore-7c440c87.js"
import{c as xe}from"./createInput-75a73ea8.js"
import{c as Ee}from"./createLabel-8668dc6c.js"
import{o as je}from"./openQuickBuffByName-f16a58eb.js"
import{a as Pe}from"./all-8d04560c.js"
import{a as Ie}from"./allthen-c5cfa8a4.js"
import{d as Oe,g as Re}from"./getGroupStats-ad8571ed.js"
import{g as Fe}from"./getMercStats-a4e74eed.js"
import{g as _e}from"./getProfile-dbf285d8.js"
import{g as qe}from"./getMembrList-c96ccda8.js"
import{h as Ke}from"./hideElement-3be61495.js"
import{n as Ye}from"./numberIsNaN-11f99b26.js"
import{r as ze}from"./reduceBuffArray-a59bb5c3.js"
import{r as Ue}from"./rnd-b5047085.js"
import{h as Qe}from"./hasClasses-47282b94.js"
import{v as We}from"./valueText-febd3894.js"
import{g as Je}from"./guild-b59f329b.js"
import{g as Ze,a as Xe}from"./getTitanString-e08d7584.js"
import{p as et}from"./padZ-634214b3.js"
import{c as tt}from"./createTable-edb24c5b.js"
import{t as at}from"./testQuant-4528e278.js"
import{g as nt}from"./groupViewStats-d614ecaf.js"
import{m as rt}from"./myStats-1aebe4bb.js"
import{a as ot}from"./huntingBuffs-d2767595.js"
import{b as it}from"./simpleCheckbox-71eaccce.js"
import{b as st}from"./bitwiseAnd-9ac724a1.js"
import{s as ut}from"./shouldBeArray-63e75f63.js"
import"./getBuff-d17ed0c5.js"
...
return ke(a,2).toString()}return"0"}(t,Number(a)),pt)}function At(e,t,a){t?Dt(e,t,a):ht&&ge(ht,!0)}function Mt(e,t){n(Le(e),t)}function Vt(e,t){bt?ge(bt,!1):function(e){bt=e.children[1],n("Kill Streak: ",bt),gt=ve(),r(bt,gt)}(e),Mt(t,gt)}function $t(e,t,a,n){t||a?Vt(e,n):bt&&ge(bt,!0)}function St(e,t){return t.name===e}function Ht(e){const{buffs:t}=GameData.player()
if(t)return t.find(o(St,e))}const Nt=["red","orange","yellow"]
let Bt,Gt
function Tt(e){De(e)&&GameData.fetch(u)}function xt(){Ht("Summon Shield Imp")||Ce([Ae()],[55]).then(Tt)}const Et=["imp-0","imp-1","imp-1"]
...
n(e,Ft),e>0&&setTimeout(Zt,500)}function Xt(e,t){t?Jt(e,t):Rt&&ge(Rt,!0)}function ea(){qt=Ht("Death Dealer"),Kt=Ht("Doubler"),Yt=Ht("Counter Attack"),zt=Ht("Summon Shield Imp"),Ut=function(){const e=GameData.player().teleportCooldown
...
1===e.length&&e.css("background-color",Nt[e.text()]||"#ad8043")}(),ea()
const e=yt([qt,Kt,Yt,zt,Ut,Qt])
e&&(Pt(e,zt,qt),$t(e,qt,Qt,Wt),At(e,qt,Wt),wt(e,Yt),Ct(e,Kt),Xt(e,Ut))}function aa(e,t){var a
...
He("creature",e).forEach(ya)}function wa(e){const t=GameData.actions()[e]
...
return r(a,i),r(e.worldName,a),n}let Va,$a,Sa,Ha,Na,Ba,Ga,Ta,xa
...
ja(t=Va),Ha=Pa("fshFormGroup","Quick Create Attack Group",t),Na=Pa("fshQuickBuff","Open Quick Buff Popup",t),Ba=Pa("fshRealmMap","Open Realm Map",t),Ga=Pa("fshTempleOne","Search map in Ultimate FSG",t),function(e){if(y("showSpeakerOnWorld")){const t=y("playNewMessageSound")
...
xa=Ma({prefVal:a,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:t})}(Va)}const Oa=[[e=>e===Ta,function(){d("playNewMessageSound",!y("playNewMessageSound"))}],[e=>e===xa,function(){e.huntingMode=!e.huntingMode,d("huntingMode",e.huntingMode)}]],Ra=[[e=>e===Ha,function(e){V(e),GameData.doAction(12,401,{},0)}],[e=>e===Na,function(){je(Ae())}],[e=>e===Ba,function(){window.open(`${S+H}map`,"fsMap")}],[e=>e===Ga,function(){const e=GameData.realm()
window.open(`${N}realms${H}view&realm_id=${e.id}`,"mapUfsg")}]]
function Fa(){Va||(Va=t({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),Ia(),s(Va,Ge(Ra)),h(Va,"change",Ge(Oa)),Te(Va,a("worldCoord")))}function _a(e,t){$a&&t.b.minlevel&&(Da(),n(t.b.minlevel,$a))}function qa(e,t){Sa&&n(t.b,Sa)}function Ka(e){return!e||!e.response||!e.response.data}let Ya,za,Ua,Qa,Wa,Ja,Za,Xa,en,tn,an,nn,rn,on,sn,un,ln,cn,fn,dn,mn,hn,pn,bn,gn,vn,yn,kn,wn,Ln,Cn,Dn,An,Mn,Vn
...
r(n,Ya)}const Hn=[e=>"lastUpdate"!==e,e=>!Qa.includes(e),e=>Wa[e].last_login,e=>Number(Wa[e].last_login)<Ja,e=>Number(Wa[e].last_login)>Za,e=>Wa[e].level<400||Wa[e].level>421,e=>Wa[e].level<441||Wa[e].level>450]
function Nn(e,t){return t(e)}function Bn(e){return Hn.every(o(Nn,e))}function Gn(e){return`<a href="${T}${Wa[e].id}">${e}</a>`}function Tn(e){Wa=e,Ja=x-120,Za=x-604800
...
r(Ya,o),Xa=a("relicCount"),en=a("LDPercentage"),tn=a("LDCloaked"),an=a("attackValue"),nn=a("attackValueBuffed"),rn=a("defenseValue"),on=a("defenseValueBuffed"),sn=a("armorValue"),un=a("armorValueBuffed"),ln=a("damageValue"),cn=a("damageValueBuffed"),fn=a("hpValue"),dn=a("hpValueBuffed"),mn=a("defendersCloaked"),hn=a("defendersProcessed")
...
return function(e,t){In.forEach(o(On,e,t))}(a,e),function(e,t){Rn.forEach(o(Fn,e,t))}(a,t),a.superEliteSlayerMultiplier=ke(.002*a.superEliteSlayerLevel,2),Ye(a.armorValue)&&function(e){e.attackValue=Pn(e.attackBonus,e.levelValue),e.defenseValue=Pn(e.defenseBonus,e.levelValue),e.armorValue=Pn(e.armorBonus,e.levelValue),e.damageValue=Pn(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}let qn,Kn,Yn,zn,Un,Qn,Wn,Jn,Zn,Xn,er,tr,ar,nr
function rr(e){return Math.round(e*En)}function or(){Mt(qn,an),Mt(Yn,rn),Mt(zn,sn),Mt(Un,ln),Mt(Wn,fn),n(Jn,mn),Zn+=1,n(Zn,hn)}function ir(e){const t=function(e){return Math.ceil(er.attack*(.0025*P(e["Nightmare Visage"],0)))}(e)
...
Mt(Qn-t,cn)}(e),n("Done.",Vn)}function ur(){n("Processing defending guild stats ... ",Vn),qn+=rr(Xn.attackValue),Yn+=rr(Xn.defenseValue),zn+=rr(Xn.armorValue),Un+=rr(Xn.damageValue),Wn+=rr(Xn.hpValue),or()
const e=Math.ceil(qn*(.0025*Xn.nightmareVisageLevel))
!function(e){Kn=qn-e,Mt(Kn,nn)}(e)
const t=Math.ceil(Yn*(1+.001*Xn.constitutionLevel))
...
qn+=Math.round(t.attackValue*I),Yn+=Math.round(t.defenseValue*I),zn+=Math.round(t.armorValue*I),Un+=Math.round(t.damageValue*I),Wn+=Math.round(t.hpValue*I),0!==t.cloakLevel&&(Jn+=1),or()}function cr(e){Xn=_n(e)}function fr(e){er=e}function dr(e){tr=e}function mr(e){n(e.message,Vn)}function hr(e){const t=E(e),a=b('#pCC a[href*="confirmDisband"]',t)
if(!a)return
...
return GameData.player().hasGroup&&e.push(F({cmd:"guild",subcmd:"groups"}).then(hr)),e=e.concat(Qa.map(pr)),e}function gr(){xn(ar),qn=0,Yn=0,zn=0,Un=0,Wn=0,Jn=0,Zn=0
const e=br()
...
return a?function(e){return new Promise((t=>{Q(3,Mr,[t,e])}))}(a):Lr({a:1,id:e,passback:t}).then(Dr)}let $r,Sr,Hr,Nr,Br,Gr
function Tr(e,t){return We(W(t,e))}function xr(){var e
$r=GameData.player().level,e=a("statbar-character-tooltip-stats"),Hr=Tr(e,te),Sr=Tr(e,J),Br=Tr(e,Z),Nr=Tr(e,X),Gr=Tr(e,ee)}function Er(e){return`<tr><td colspan="2">${e.name}:</td><td colspan="2">${e.value}</td></tr>`}function jr(e,t,a){return function(e){return`<table><tr><td><img src="${v}creatures/${e.image_id}.png" height="200" width="200"></td><td rowspan="2"><table width="400"><tr><td class="header" colspan="4" class="fshCenter">Statistics</td></tr>`}(e)+function(e,t){return`<tr><td>Class:&nbsp;</td><td width="40%">${e.creature_class}</td><td>Level:&nbsp;</td><td width="40%">${e.level} (your level:<span class="${t}">${$r}</span>)</td></tr>`}(e,a)+function(e){return`<tr><td>Attack:&nbsp;</td><td width="40%">${e.attack} (your defense:<span class="fshYellow">${Sr}</span>)</td><td>Defense:&nbsp;</td><td width="40%">${e.defense} (your attack:<span class="fshYellow">${Hr}</span>)</td></tr>`}(e)+function(e){return`<tr><td>Armor:&nbsp;</td><td width="40%">${e.armor} (your damage:<span class="fshYellow">${Nr}</span>)</td><td>Damage:&nbsp;</td><td width="40%">${e.damage} (your armor:<span class="fshYellow">${Br}</span>)</td></tr>`}(e)+function(e,t){return`<tr><td>HP:&nbsp;</td><td width="40%">${e.hp} (your HP:<span class="fshYellow">${Gr}</span>)(1H: <span class="fshRed">${t}</span>)</td><td>Gold:&nbsp;</td><td width="40%">${e.gold}</td></tr>`}(e,t)+'<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Enhancements</td></tr>'+function(e){return 0===e.enhancements.length?'<tr><td colspan="4">[no enhancements]</td></tr>':e.enhancements.map(Er).join("")}(e)+function(e){return`<tr><td colspan="4" height="5"></td></tr><tr><td class="header" colspan="4" class="fshCenter">Description</td></tr><tr><td colspan="4">${e.description}</td></tr><tr><td colspan="4" height="5"></td></tr></table></td></tr><tr><td class="fshCenter"><b>${e.name}</b></td></tr></table>`}(e)}function Pr(t){if(!Ka(t))return function(t){const a=Math.ceil(t.hp*e.hpVariable+t.armor*e.generalVariable)
let n="fshYellow"
...
return a&&(n.className="fshBlue"),function(e,t){t.forEach(o(Kr,e))}(n,t),n}function zr(e,t){Yr(e,t[0],t[1])}function Ur(e,t){t.forEach(o(zr,e))}let Qr,Wr,Jr,Zr,Xr,eo,to,ao,no,ro,oo,io,so,uo,lo,co,fo,mo,ho,po,bo,go,vo,yo,ko,wo,Lo,Co
...
return r(t,e),ye(t,"%"),t}function $o(){ho=null,mo&&!ae("fshHide",mo)&&(ge(mo,!0),n("",ro),n("",oo),n("",io),n("",so),n("",uo),B("",lo),B("",co),Ao())}function So(e){return 0===e.type&&(ho=e.base_creature_id,!0)}function Ho(){if(mo)ge(mo,!1)
else{const e=a("actionContainer")
mo=t({className:"fshActionBox titanInfo"}),ro=ve(),oo=ve(),io=ve(),so=ve(),uo=ve(),lo=ve(),co=ve(),fo=tt({className:"fshCenter"}),Do(),Ur(fo,[[[[2,to,!0],[4,no,!0]]],[[[2,Mo()],[4,io]]],[[[2,Wr,!0],[4,Vo(so)]],!0],[[[2,ao,!0],[4,Vo(uo)]],!0],[[[2,eo,!0],[4,lo]],!0],[[[6,co]]],[[[2,Zr,!0],[2,Jr,!0],[2,Xr,!0]]]]),r(mo,fo),r(e,mo)}}function No(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(ie+1e3*e)
return`${et(t.getHours())}:${et(t.getMinutes())} ${et(t.getDate())}/${oe[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function Bo(e){return we(Ze(e.max_hp-e.current_hp,e.kills),2)}function Go(e){return we(100*e.kills/e.max_hp,2)}function To(e){[[e.current_hp,ro],[e.max_hp,oo],[e.kills,io],[Bo(e),so],[Go(e),uo]].forEach((([e,t])=>{n(e,t)})),B(function(e){return Xe(e.kills,e.max_hp,e.current_hp)}(e),lo),B(No(e.cooldown),co)}function xo(e,t){return[[[2,Ot(t.player.name)],[2,Ot(t.kills.toString())],[2,Ot(`${we(100*t.kills/e.kills,2)}%`)]]]}function Eo(e){return e.realm&&e.creature.base_id===ho&&e.realm===Qr}function jo(e){const t=e.find(Eo)
t&&(To(t),function(e){if(Ao(),!e.contributors)return
const t=e.contributors.map(o(xo,e))
Ur(fo,t)}(t))}function Po(t){return e.showTitanInfo&&Me(t)&&t.some(So)}function Io(e,t){(function(e){return e&&e.s&&Me(e.r)})(t)&&(jo(t.r),Po(GameData.realm().dynamic)?po=window.setTimeout(e,3e4):$o())}function Oo(){re(qr).then(o(Io,Oo))}function Ro(e){po&&(window.clearTimeout(po),po=null),Po(e)?(Ho(),Oo()):$o()}function Fo(e){var t
...
1===t.length&&([Vi]=t)}}(t),Vi&&($i=e.trim(),Oi())}function Fi(){Bi||(Ni||(Ni=t(),r(Hi,Ni),r(Hi,t({innerHTML:'<span class="fshFooter">*Does include CA, DD, HF, DC, Flinch, Super Elite Slayer, NMV, Sanctuary, Constitution, Fortitude, Chi Strike and Terrorize (if active) and allow for randomness (1.1053). Constitution, NMV, Fortitude and Chi Strike apply to group stats.</span>'}))),Bi=t(),r(Ni,Bi))}function _i(e){Fi(),B(e,Bi)}function qi(e){Gi||(Fi(),Gi=t(),r(Ni,Gi)),B(e,Gi)}function Ki(e,t){const a={name:e.name,class:e.creature_class,attack:Number(e.attack),defense:Number(e.defense),armor:Number(e.armor),damage:Number(e.damage),hp:Number(e.hp)}
...
Yi(e,t,{groupExists:!0,groupAttackValue:n[0].value,groupDefenseValue:n[1].value,groupArmorValue:n[2].value,groupDamageValue:n[3].value,groupHPValue:n[4].value})}function Wi(e,t,a){a&&function(e){return re(fi,li,e)}(a).then(o(Qi,e,t))}function Ji(e,t){re(di).then(Ui).then(o(Wi,e,t))}function Zi(e,t){e.player.hasGroup&&Ji(e,t),Yi(e,t,{groupExists:!1})}function Xi(e,t){Hi||(Hi=a("dialog-viewcreature")),Hi&&(_i(""),qi(""),function(e){return e.response&&e.response.data}(t)&&(Ri(t.response.data.name,Hi),rt(!0).then(o(Zi,t))))}function es(){const t=[,[e.buffs,e.buffsName],[e.buffs2,e.buffs2Name],[e.buffs3,e.buffs3Name]][e.enabledHuntingMode]
...
function Ss(){Ne($s)}export default Ss
//# sourceMappingURL=newMap-921b360a.js.map
