import{r as e,B as t,t as n,av as s,ab as o,Z as a,aC as i,D as c,m as r,P as l,S as m,i as p,aD as u,E as d,h as f,o as g,p as b,A as h,c as v,aE as C,C as S,a6 as E,j,I as k,z as N,M as x}from"./calfSystem-6ad077b7.js"
import{r as A,g as y}from"./rnd-b5047085.js"
import{p as $,s as B}from"./pubsub-fb470b55.js"
import{c as I}from"./createInput-75a73ea8.js"
import{c as L}from"./createTable-edb24c5b.js"
import{g as q}from"./getArrayByClassName-a6fe264a.js"
import{i as F}from"./insertElementAfter-4dbced0a.js"
import{i as P}from"./insertHtmlAfterEnd-0792ac6e.js"
...
return 0===s&&h(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],I({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function G(e,t,s,o){return e.reduce(n(Z,o),s.insertRow(-1)),s}function J(e){return[e.value,e.text]}function K(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return z(o,s),e.reduce(n(G,t,s),o)}(d("#composing-template-multi option").map(J),t,s)
f(e,o),g(b,R),B("quickcreate",n(H,o))}function O(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-58e5183e.js.map
