import{u as e,C as t,D as n,bM as s,I as a,U as r,Z as i,z as o,q as c,H as l,c as u,m as d,bQ as b,bO as f,B as p,bV as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-365d90f3.js"
import{f as $}from"./functionPasses-f7da3bd0.js"
import{s as w}from"./shouldBeArray-82175111.js"
import{i as N}from"./insertElementAfterBegin-91a0ceb3.js"
...
function K(){return d({className:"minibox"})}function Q(){f("bountyList",A),p("",q)
...
function _(e,t){A=s("bountyList"),T=s("wantedList"),M=a("bountyListRefreshTime"),S=a("bwNeedsRefresh"),S||P()&&(S=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,W=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(J)):function(e,t){t&&(T.isRefreshed=!1,V()),e&&(A.isRefreshed=!1,Q())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=K(),N(b,G)),u.enableActiveBountyList&&(q=K(),N(b,q)),q&&v(q,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-c41603bc.js.map
