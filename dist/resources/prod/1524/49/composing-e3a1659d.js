import{r as e,B as t,t as n,aA as s,ad as o,Z as a,aH as i,D as c,m as r,P as l,S as m,i as p,aI as u,E as d,h as f,o as g,p as b,A as h,c as v,aJ as C,C as S,a8 as E,j,I as k,z as N,M as x}from"./calfSystem-2172498b.js"
import{r as A,g as y}from"./rnd-1618b1ea.js"
import{p as I,s as $}from"./pubsub-2f2442f6.js"
import{c as B}from"./createInput-b54e35e9.js"
import{c as L}from"./createTable-514c5663.js"
import{g as q}from"./getArrayByClassName-c230ba3d.js"
import{i as F}from"./insertElementAfter-d7162528.js"
import{i as P}from"./insertHtmlAfterEnd-ab1f79ab.js"
...
return 0===s&&h(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],B({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function Z(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function G(e){return[e.value,e.text]}function K(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return z(o,s),e.reduce(n(Z,t,s),o)}(d("#composing-template-multi option").map(G),t,s)
f(e,o),g(b,J),$("quickcreate",n(D,o))}function O(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-e3a1659d.js.map
