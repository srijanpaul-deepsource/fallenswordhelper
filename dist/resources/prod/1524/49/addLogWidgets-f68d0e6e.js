import{e as n,ak as e,E as a,al as t,am as s,F as r,i as o,an as i,H as c,x as l,u as f,t as u,v as m,z as d,C as p,S as h,$ as g,U as b,ao as w,D as y,ap as _,ab as v,h as $,m as C,A as P,I as k,a7 as L,aq as j,Z as T,y as G}from"./calfSystem-2172498b.js"
import{i as S}from"./insertHtmlAfterEnd-ab1f79ab.js"
import{c as A}from"./currentGuildId-7d9d343b.js"
import{g as E}from"./getMembrList-351d1812.js"
import{c as x}from"./closestTr-3eb9ff66.js"
import{a as I}from"./addCommas-1f67a5b9.js"
import{p as R}from"./parseDateAsTimestamp-24bb18a4.js"
import{g as z,s as B}from"./idb-35c610a0.js"
import{c as Y}from"./createStyle-9ebe28f9.js"
import{m as H}from"./myStats-3fea7e4d.js"
import{g as M}from"./addLogColoring-c89a2933.js"
let N
...
function q(n,[e,a]){o(a.cells[1],`<font size="1"><br>[ ${((n,e)=>`<a${(n=>n?' class="pmIgnoreUrl"':"")(n)} href="${i}${c(e)}" data-tooltip="Add to Ignore List">Ignore</a>`)(n,e)} ]</font>`)}function F(n){return l({cmd:"combat",subcmd:"view",combat_id:n})}function W(n){return Number(n.getAttribute("background").match(/\/(\d+)/)[1])}function X(n,e){const a=new RegExp(`${e} = (\\d+)`)
...
return e?{id:e[0],params:[e[1][1],e[1][2]]}:(h("Logs","Missing PvP Special",n),{id:-1,params:["-1","-1"]})}function O(n){return a("#specialsDiv",n).map(c).filter((n=>["leeched","Spell"].some((e=>n.includes(e))))).map(K)}function Q(n){return{id:W(n.rows[1].cells[0]),name:c(n.rows[0].cells[0])}}function V(n){return{id:W(n.rows[1].cells[2]),name:c(n.rows[0].cells[2])}}function nn(n,e){const a=e.children[0].rows[5].cells[0].children[0]
return{attacker:Q(a),defender:V(a),id:Number(n),specials:O(e)}}function en(n){const e=p(n.children[1])
return{gold_gain:X(e,"goldGain"),gold_stolen:X(e,"goldStolen"),pvp_prestige_gain:X(e,"prestigeGain"),pvp_rating_change:X(e,"pvpRatingChange"),winner:X(e,"winner"),xp_gain:X(e,"xpGain")}}function an(n,e){return{...nn(n,e),...en(e)}}function tn(n,e){const a=m(e)
...
e>Sn&&(T(L,e),Sn=e)}const In=[["addIgnoreLink",function(n,e){const t=a(r,n)
...
//# sourceMappingURL=addLogWidgets-f68d0e6e.js.map
