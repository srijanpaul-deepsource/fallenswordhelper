import{u as e,C as t,D as n,bM as s,I as r,U as a,Z as i,z as o,q as c,H as l,c as u,m as b,bQ as d,bO as f,B as p,bV as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-2172498b.js"
import{f as $}from"./functionPasses-dfd0a9eb.js"
import{s as w}from"./shouldBeArray-45b664e6.js"
import{i as N}from"./insertElementAfterBegin-538ae729.js"
import{c as x}from"./createSpan-b3281070.js"
...
A.bounty.push(n)}}(e)}function P(){return A&&a-A.lastUpdate>M||T&&a-T.lastUpdate>M}function U(e){const t=e[6]
...
function K(){return b({className:"minibox"})}function Q(){f("bountyList",A),p("",q)
...
var n
y(q,t)}function V(){f("wantedList",T),p("",G)
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=a,n&&H(n),j=!0}(e),Q())}function J(e){const t=L(e)
F(t),u.enableWantedList&&(Z(t),D<I?R(D+1).then(J):V())}const Y=[()=>!A,()=>!T,()=>S]
function _(e,t){A=s("bountyList"),T=s("wantedList"),M=r("bountyListRefreshTime"),S=r("bwNeedsRefresh"),S||P()&&(S=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,W=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(J)):function(e,t){t&&(T.isRefreshed=!1,V()),e&&(A.isRefreshed=!1,Q())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=K(),N(d,G)),u.enableActiveBountyList&&(q=K(),N(d,q)),q&&v(q,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-ad28a8ad.js.map
