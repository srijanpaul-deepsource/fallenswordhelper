import{c as e,m as t,z as a,A as n,h as r,t as o,i,o as s,aM as u,aN as l,aO as c,aP as f,Z as d,b as m,f as h,E as p,D as b,S as g,aw as v,I as y,aQ as k,C as w,aJ as L,aR as C,aS as D,aT as A,aU as M,aV as V,aW as S,aC as N,aL as H,B,aX as G,a3 as T,U as x,v as E,ab as j,a4 as P,aY as I,aZ as O,P as R,u as F,a_ as _,a$ as q,b0 as Y,b1 as K,aI as z,q as U,a as Q,M as W,b2 as J,b3 as Z,b4 as X,b5 as ee,b6 as te,l as ae,ap as ne,$ as re,aq as oe,a6 as ie,b7 as se,b8 as ue,b9 as le,ba as ce,bb as fe,bc as de,bd as me,be as he,bf as pe}from"./calfSystem-7991d843.js"
import{i as be}from"./insertElementAfter-a49606d1.js"
import{t as ge}from"./toggleForce-70762365.js"
import{c as ve}from"./createSpan-462a14d2.js"
import{i as ye}from"./insertTextBeforeEnd-b095e3b9.js"
import{a as ke,r as we}from"./roundToString-34b7c935.js"
import{a as Le}from"./addCommas-8af578e2.js"
import{d as Ce,q as De}from"./quickbuffSuccess-d920c5f4.js"
import{p as Ae}from"./playerName-541d216c.js"
import{i as Me}from"./isArray-e47504c9.js"
import{g as Ve,s as $e}from"./idb-89606f1a.js"
import{c as Se}from"./createStyle-a04de647.js"
import{g as Ne}from"./getArrayByClassName-7f937df4.js"
import{e as He}from"./executeAll-9a33204f.js"
import{c as Be}from"./createButton-1e66ce8d.js"
import{e as Ge}from"./eventHandler5-3de99d0b.js"
import{i as Te}from"./insertElementBefore-c2bb9234.js"
import{c as xe}from"./createInput-e6426c85.js"
import{c as Ee}from"./createLabel-3f94634a.js"
import{o as je}from"./openQuickBuffByName-76ab32da.js"
import{a as Pe}from"./all-3768003b.js"
import{a as Ie}from"./allthen-34d3fc07.js"
import{d as Oe,g as Re}from"./getGroupStats-9e56b14d.js"
import{g as Fe}from"./getMercStats-c26f3d63.js"
import{g as _e}from"./getProfile-c6106cad.js"
import{g as qe}from"./getMembrList-479139ba.js"
import{h as Ye}from"./hideElement-452544d4.js"
import{n as Ke}from"./numberIsNaN-c0e87dea.js"
import{r as ze}from"./reduceBuffArray-867d4e68.js"
import{r as Ue}from"./rnd-72e72dc0.js"
import{h as Qe}from"./hasClasses-db187de4.js"
import{v as We}from"./valueText-9648dc4e.js"
import{g as Je}from"./guild-a6c2c23e.js"
import{g as Ze,a as Xe}from"./getTitanString-3187e0ac.js"
import{p as et}from"./padZ-aa6c487e.js"
import{c as tt}from"./createTable-2a310c28.js"
import{t as at}from"./testQuant-95fb5e76.js"
import{g as nt}from"./groupViewStats-c85a5e0e.js"
import{m as rt}from"./myStats-3e0bbe38.js"
import{a as ot}from"./huntingBuffs-474375d5.js"
import{b as it}from"./simpleCheckbox-e5b19e25.js"
import{b as st}from"./bitwiseAnd-c837f771.js"
import{s as ut}from"./shouldBeArray-5e3f8541.js"
...
Bt.className=function(e){return Et[e]||"fshGreen"}(a),n(a,Gt)}function Pt(e,t,a){t||a?jt(e,t):Bt&&ge(Bt,!0)}function It(e){return 0===e.type}function Ot(e){return ve({textContent:e})}let Rt,Ft,_t,qt,Yt,Kt,zt,Ut,Qt,Wt
function Jt(e,t){Rt?ge(Rt,!1):function(e,t){Rt=e.children[5],n("Teleport Cooldown: ",Rt),Ft=Ot(t.toString()),r(Rt,Ft)}(e,t)}function Zt(){const e=Math.max(Math.ceil((_t-Date.now())/1e3),0)
n(e,Ft),e>0&&setTimeout(Zt,500)}function Xt(e,t){t?Jt(e,t):Rt&&ge(Rt,!0)}function ea(){qt=Nt("Death Dealer"),Yt=Nt("Doubler"),Kt=Nt("Counter Attack"),zt=Nt("Summon Shield Imp"),Ut=function(){const e=GameData.player().teleportCooldown
...
function $n(e){return e.player_name}function Sn(e){!function(e){Qa=e.defenders.map($n)}(e),Ka?B("",Ka):Ka=t({className:"body"}),function(e){za=t({className:"fshFloatLeft fshRelicLeftDiv"}),r(Ka,za),e.is_owner&&r(za,Oe(Qa)),Ua=Be({className:"custombutton",textContent:"Fetch Stats"}),r(za,Ua)}(e)
...
return function(e,t){In.forEach(o(On,e,t))}(a,e),function(e,t){Rn.forEach(o(Fn,e,t))}(a,t),a.superEliteSlayerMultiplier=ke(.002*a.superEliteSlayerLevel,2),Ke(a.armorValue)&&function(e){e.attackValue=Pn(e.attackBonus,e.levelValue),e.defenseValue=Pn(e.defenseBonus,e.levelValue),e.armorValue=Pn(e.armorBonus,e.levelValue),e.damageValue=Pn(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}let qn,Yn,Kn,zn,Un,Qn,Wn,Jn,Zn,Xn,er,tr,ar,nr
...
function Do(){Wr=Ot("Current"),Jr=Ot("Kills"),Zr=Ot("Member"),Xr=Ot("% of Total"),eo=Ot("Status"),to=Ot("Titan HP"),ao=Ot("Total"),no=Ot("Your Guild")}function Ao(){for(;fo.rows.length>7;)fo.deleteRow(7)}function Mo(){const e=ve()
...
return`${et(t.getHours())}:${et(t.getMinutes())} ${et(t.getDate())}/${oe[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function Bo(e){return we(Ze(e.max_hp-e.current_hp,e.kills),2)}function Go(e){return we(100*e.kills/e.max_hp,2)}function To(e){[[e.current_hp,ro],[e.max_hp,oo],[e.kills,io],[Bo(e),so],[Go(e),uo]].forEach((([e,t])=>{n(e,t)})),B(function(e){return Xe(e.kills,e.max_hp,e.current_hp)}(e),lo),B(Ho(e.cooldown),co)}function xo(e,t){return[[[2,Ot(t.player.name)],[2,Ot(t.kills.toString())],[2,Ot(`${we(100*t.kills/e.kills,2)}%`)]]]}function Eo(e){return e.realm&&e.creature.base_id===ho&&e.realm===Qr}function jo(e){const t=e.find(Eo)
...
//# sourceMappingURL=newMap-dab1020a.js.map
