import{u as e,C as t,D as n,bI as s,I as r,U as a,Z as i,z as o,q as c,H as l,c as u,m as d,bM as f,bK as b,B as p,bP as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-e1e858cd.js"
import{f as $}from"./functionPasses-f44e4b46.js"
import{s as w}from"./shouldBeArray-c9e77dce.js"
import{i as N}from"./insertElementAfterBegin-4f7e454a.js"
...
A.bounty.push(n)}}(e)}function H(){return A&&a-A.lastUpdate>M||T&&a-T.lastUpdate>M}function U(e){const t=e[6]
...
function D(){return d({className:"minibox"})}function Z(){b("bountyList",A),p("",q)
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=a,n&&C(n),j=!0}(e),Z())}function V(e){const t=L(e)
Q(t),u.enableWantedList&&(J(t),X<z?R(X+1).then(V):F())}const Y=[()=>!A,()=>!T,()=>P]
function _(e,t){A=s("bountyList"),T=s("wantedList"),M=r("bountyListRefreshTime"),P=r("bwNeedsRefresh"),P||H()&&(P=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,S=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,Z())}(e,t)}function ee(e){e.target===I&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===K&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=D(),N(f,G)),u.enableActiveBountyList&&(q=D(),N(f,q)),q&&v(q,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-4a9d3aba.js.map
