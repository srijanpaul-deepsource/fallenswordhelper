import{d as t}from"./doSortParams-90a4c5d9.js"
import{I as e,aI as n,B as i,z as r,g as s,v as a,i as o,t as c,C as d,al as u,aK as p,M as f,m,h,u as l,y as g,o as $,p as b}from"./calfSystem-a2fd9017.js"
import{s as v,g as x}from"./idb-09e8fa3a.js"
import{s as _}from"./shouldBeArray-830599fd.js"
import{a as y}from"./stringSort-a1f3c520.js"
import{a as N}from"./all-ceaf9817.js"
import"./csvSplit-e3b3e000.js"
let k,C=[]
function j(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${k}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function w(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${k}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function S(t){return!C.includes(t.name)}function I(t){return`<tr class="rmTr"><td class="rmTd"><a href="${t.link}"><img src="${t.img}" height="30px" width="30px"></a></td><td class="rmTd"><a href="${t.link}">${t.name}</a></td><td class="rmTd">${function(t){return t.items?t.items.map(j).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.components?t.components.map(w).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.target?` <img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.target.id}&inv_id=-1&t=2&p=${k}&vcode=${t.target.verify}" src="${t.target.img}" height="30px" width="30px"><br/>`:""}(t)}</td></tr>`}function T(t,r){r&&(e("hideRecipes")&&(C=_("hideRecipeNames")),function(t,e){k=n()
...
//# sourceMappingURL=recipeMgr-1980ad3b.js.map
