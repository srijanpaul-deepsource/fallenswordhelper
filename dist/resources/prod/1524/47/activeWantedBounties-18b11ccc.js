import{u as e,C as t,D as n,bJ as s,I as r,U as a,Z as i,z as o,q as c,H as l,c as u,m as d,bN as f,bL as b,B as p,bQ as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-a2fd9017.js"
import{f as $}from"./functionPasses-bd6902f6.js"
import{s as w}from"./shouldBeArray-830599fd.js"
...
A.bounty.push(n)}}(e)}function P(){return A&&a-A.lastUpdate>S||T&&a-T.lastUpdate>S}function U(e){const t=e[6]
...
function _(e,t){A=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||P()&&(W=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,C=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,Q()),e&&(A.isRefreshed=!1,K())}(e,t)}function ee(e){e.target===X&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=J(),N(f,G)),u.enableActiveBountyList&&(q=J(),N(f,q)),q&&v(q,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-18b11ccc.js.map
