import{u as e,C as t,D as n,bE as s,I as r,U as a,_ as i,z as o,q as c,H as l,c as u,m as d,bI as b,bG as f,B as p,bN as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-030d7057.js"
import{f as $}from"./functionPasses-d13672a2.js"
import{s as w}from"./shouldBeArray-f937e740.js"
import{i as N}from"./insertElementAfterBegin-236f9295.js"
import{c as x}from"./createSpan-cbce88a2.js"
...
A.bounty.push(n)}}(e)}function M(){return A&&a-A.lastUpdate>S||T&&a-T.lastUpdate>S}function P(e){const t=e[6]
...
function K(){return d({className:"minibox"})}function _(){f("bountyList",A),p("",O)
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=a,n&&H(n),j=!0}(e),_())}function V(e){const t=L(e)
Q(t),u.enableWantedList&&(J(t),z<D?R(z+1).then(V):F())}const Y=[()=>!A,()=>!T,()=>W]
function Z(e,t){A=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||M()&&(W=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,C=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,_())}(e,t)}function ee(e){e.target===I&&(f("bountyList",null),Z(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),Z(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=K(),N(b,q)),u.enableActiveBountyList&&(O=K(),N(b,O)),O&&v(O,ee),q&&v(q,ee),Z(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-4f0d9b41.js.map
