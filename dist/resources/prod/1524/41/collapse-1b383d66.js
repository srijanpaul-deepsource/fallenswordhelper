import{N as o,t as n,o as t,a5 as e,z as c,f as r,_ as a,aG as f}from"./calfSystem-030d7057.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],T(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function L(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(j)}function F(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(L,o))}(e.prefName),o(e.theTable.rows).forEach(n(b,e)),t(e.theTable,N)}export{F as c}
//# sourceMappingURL=collapse-1b383d66.js.map
