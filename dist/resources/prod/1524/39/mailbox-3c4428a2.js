...
import{x as n,$ as e,y as s,g as i,p as a,Q as r,t as c,k as o,m as f,h as m,o as u,e as l,l as d,B as p,z as h}from"./calfSystem-fe534823.js"
import{c as k}from"./createInput-58fc2e41.js"
import{c as b}from"./createLabel-6833e4c3.js"
import{c as g}from"./createUl-bf42ad98.js"
import{a as j}from"./allthen-b65a93f3.js"
import{i as v}from"./indexAjaxJson-6f85f3e9.js"
import{i as x}from"./insertElementBefore-68b894c4.js"
import{i as T}from"./isArray-f324e0ac.js"
import{j as y,o as B}from"./jsonFail-8cb8ad1c.js"
...
n&&p("",n)}function H(t,n){y(n,t)||T(n.r)&&function(t,n){n.r.forEach(C),B(`${n.r.length.toString()} item(s) taken.`,t)}(t,n)}function N(t,n){var s;(s=n,e(M,L,s)).then(c(H,t))}function S(n,e,s){d("fshBls",s.target)&&function(n,e,s){const i=s.dataset.id,{invIds:a}=n[i]
...
!function(t,n){l(n).forEach(c(A,t))}(s,t),m(n,s),u(s,c(S,t,e))}function F(t){const n=f({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),e=function(t){const n=f(),e=g()
...
//# sourceMappingURL=mailbox-3c4428a2.js.map
