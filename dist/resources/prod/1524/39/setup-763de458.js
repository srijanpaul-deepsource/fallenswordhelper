...
import{y as n,d as o,t as e,g as i,av as a,u as p,O as s,au as c}from"./calfSystem-fe534823.js"
import{m as u}from"./assets-b1b89ba1.js"
import"./all-2b32eb82.js"
const l=[]
let r,d
function f(t,n){return p({cmd:"arena",subcmd:"dopickmove",move_id:t,slot_id:n})}function m(t){return t.value}function v(t,n){if(t!==l[n])return r.eq(n).attr({src:a,width:"25",height:"25"}),f("x",n)}function h(t,n){if("x"!==t&&t!==l[n])return f(t,n)}function g(){s(`${c}setup`)}function b(n){const o=n.map(h)
t(o,g)}function k(){const n=i("select",d).map(m),o=n.map(v)
t(o,e(b,n))}function x(t,n,o){const e=function(t){const n=$(t).attr("src").match(u)
return n?n[1]:"x"}(o)
l.push(e)
...
//# sourceMappingURL=setup-763de458.js.map
