import{u as e,C as t,D as n,bE as s,I as r,U as i,_ as a,z as o,q as c,H as l,c as u,m as d,bI as b,bG as f,B as p,bN as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-15b00143.js"
import{f as $}from"./functionPasses-e2f17f43.js"
import{s as w}from"./shouldBeArray-1ce261c7.js"
import{i as N}from"./insertElementAfterBegin-6888d6e1.js"
import{c as x}from"./createSpan-2658e7cc.js"
...
A.bounty.push(n)}}(e)}function M(){return A&&i-A.lastUpdate>S||T&&i-T.lastUpdate>S}function P(e){const t=e[6]
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=i,n&&H(n),j=!0}(e),_())}function V(e){const t=L(e)
Q(t),u.enableWantedList&&(J(t),z<D?R(z+1).then(V):F())}const Y=[()=>!A,()=>!T,()=>W]
function Z(e,t){A=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||M()&&(W=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=i,j=!1,C=w("wantedNames"),a("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,_())}(e,t)}function ee(e){e.target===I&&(f("bountyList",null),Z(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),Z(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=K(),N(b,q)),u.enableActiveBountyList&&(O=K(),N(b,O)),O&&v(O,ee),q&&v(q,ee),Z(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-749f1346.js.map
