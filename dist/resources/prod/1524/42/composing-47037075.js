import{r as e,B as t,t as n,au as s,ac as o,_ as a,aA as i,D as c,m as r,Q as l,W as m,i as p,aB as u,E as f,h as d,o as g,p as b,A as h,c as v,aC as C,C as S,a7 as E,j,I as k,z as N,K as x}from"./calfSystem-15b00143.js"
import{r as A,g as y}from"./rnd-8a314c4b.js"
import{p as B,s as $}from"./pubsub-bb736d5d.js"
import{c as I}from"./createInput-ff6bf89d.js"
import{c as L}from"./createTable-c2551f6f.js"
import{g as q}from"./getArrayByClassName-c7b90480.js"
import{i as F}from"./insertElementAfter-befc939b.js"
import{i as T}from"./insertHtmlAfterEnd-778c206f.js"
...
return 0===s&&h(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],I({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function W(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function G(e){return[e.value,e.text]}function J(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return H(o,s),e.reduce(n(W,t,s),o)}(f("#composing-template-multi option").map(G),t,s)
d(e,o),g(b,M),$("quickcreate",n(K,o))}function O(e){m("composing","FastCompose"),p(e,"<br>")
...
0===t?X(!0):(X(!1),a(C,t))}(),f("input[id^=create-]:not(#create-multi)",b).forEach(Y),g(b,Z),function(){if(k("moveComposingButtons")){const e=N("composing-error-dialog").previousElementSibling
...
//# sourceMappingURL=composing-47037075.js.map
