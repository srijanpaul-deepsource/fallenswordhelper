import{a as t}from"./addGuildLogWidgets-f4b7b070.js"
import{a as e}from"./addLogColoring-6c8585c3.js"
import{a as s}from"./all-9f53e8b3.js"
import{u as i,t as n,bq as o,br as a,y as c,B as d,p as r,o as h,g as l,A as f,z as u,I as p,v as m,D as g,C as b,K as k,i as y,H as w}from"./calfSystem-15b00143.js"
import{c as j}from"./createTable-c2551f6f.js"
import{e as L}from"./eventHandler5-618e181e.js"
import{f as R}from"./functionPasses-e2f17f43.js"
import{h as N}from"./hideElement-30ade5f0.js"
import{p as v}from"./parseDateAsTimestamp-41bbfb83.js"
import{s as G}from"./selfIdIs-b6892aa6.js"
import{t as x}from"./toggleForce-f06995aa.js"
import{g as H,s as T}from"./idb-1c9eb1ac.js"
import"./dataRows-89a16eef.js"
import"./playerName-41a4004e.js"
import"./searchPlayerHref-8f703ebb.js"
...
if(W(n,o)){V=!1
break}Q.push([100*q+t,n,i,o,C(o)])}}(t)}function J(t){!function(t){_=m(t)
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=K.checks[t.getAttribute("item")]}function ot(){l("input",B).forEach(nt),Z()}function at(t,e){return t[0]-e[0]}function ct(){V&&Q.sort(at),f("Loading complete.",M),K.log=Q.filter(n(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){U=j({id:"fshInjectHere",className:"width_full"}),y(U,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const s=u("fshInjectHere")
r.replaceChild(U,s),e("myGuildLog",1,3),t()}()}function dt(t){J(t),function(){const t=[]
...
K.checks[e]=!K.checks[e],Z(),Q.forEach(n(rt,e,!K.checks[e]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){K.checks=D.slice(0),ot(),Q.forEach(ft)}function pt(t){N(t[5]),N(t[6])}function mt(){K.checks=O.slice(0),ot(),Q.forEach(pt)}function gt(){K.log=!1,Z(),f("Loading Page 1 ...",M),Q=[],V=!0,d("",u("fshInjectHere")),I(1).then(dt)}function bt(t){!function(t){K=t||K,K.checks=K.checks||D.slice(0)}(t),d(E,r),B=u("fshNewGuildLog"),M=u("fshOutput"),h(B,L([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),gt]])),ot(),F=Number(p("newGuildLogHistoryPages")),$=F,I(1).then(dt)}function kt(){c()||H("fsh_guildLog").then(bt)}export default kt
//# sourceMappingURL=newGuildLog-5a1ca335.js.map
