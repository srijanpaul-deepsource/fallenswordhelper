import{u as e,C as t,D as n,bE as s,I as r,V as i,_ as a,z as o,q as c,H as l,c as u,m as d,bI as b,bG as f,B as p,bN as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-9942149b.js"
import{f as $}from"./functionPasses-17426539.js"
import{s as w}from"./shouldBeArray-e5f9dc4e.js"
import{i as N}from"./insertElementAfterBegin-9f52b347.js"
import{c as x}from"./createSpan-84310061.js"
...
function K(){return d({className:"minibox"})}function V(){f("bountyList",A),p("",O)
...
var n
y(O,t)}function _(){f("wantedList",T),p("",q)
...
J(t),u.enableWantedList&&(F(t),z<D?R(z+1).then(Q):_())}const Y=[()=>!A,()=>!T,()=>W]
function Z(e,t){A=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||M()&&(W=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=i,j=!1,C=w("wantedNames"),a("bwNeedsRefresh",!1),R(1).then(Q)):function(e,t){t&&(T.isRefreshed=!1,_()),e&&(A.isRefreshed=!1,V())}(e,t)}function ee(e){e.target===I&&(f("bountyList",null),Z(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),Z(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=K(),N(b,q)),u.enableActiveBountyList&&(O=K(),N(b,O)),O&&v(O,ee),q&&v(q,ee),Z(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-b1656e0c.js.map
