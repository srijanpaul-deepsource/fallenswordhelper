import{y as t,B as e,h as n,o as i,p as s,t as r,aU as a,z as o,au as c,bp as f}from"./calfSystem-9942149b.js"
import{c as d}from"./createTable-4b731acb.js"
import{d as l}from"./daUseItem-46bcfe13.js"
import{e as m}from"./eventHandler5-e7aa5fb9.js"
import{g as u}from"./getInventory-0cdb2477.js"
import{j as p}from"./jConfirm-b0fc8390.js"
import{j as h,o as b}from"./jsonFail-0750268a.js"
import{s as x}from"./selfIdIs-7e904820.js"
...
t+=a($).reduce(C,""),e(t,y),g=o("qeresult")}function Y(t){return"Zombie Coffin"===t.item_name||12===t.type||16===t.type}function H(t){_=t.player_id,j=t.items.filter(Y),M()}function O(){v=!v,M()}function R(){I=!I,M()}function T(t){return t.id.startsWith("fshExtr")}function U(r){if(t())return
const a=r||s
e('<div class="qeHead"><b>Quick Extract</b></div>Select which type of plants you wish to extract all of. Only select extractable resources.<br><label><input type="checkbox" id="fshInSt" checked> Select items in ST</label>&nbsp;&nbsp;<label><input type="checkbox" id="fshInMain" checked> Only extract items in Main Folder</label>',a),y=d({width:"100%"}),n(a,y),v=!0,I=!0,i(a,m([[x("fshInSt"),O],[x("fshInMain"),R],[T,F]])),u().then(H)}export default U
//# sourceMappingURL=quickExtract-e2b70fc6.js.map
