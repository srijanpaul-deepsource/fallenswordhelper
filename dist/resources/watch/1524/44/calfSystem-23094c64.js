...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-ac8ecf1f.js')); };
const injectGuild = () => { runDefault(import('./guild-f88f6243.js')); };
const injectProfile = () => { runDefault(import('./profile-893b16a1.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-b2c2b1e5.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-df8baba0.js')); };
const inventing = () => { runDefault(import('./inventing-633cd137.js')); };
const news$1 = () => { runDefault(import('./news-1c85fd59.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-b6c7811d.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-f105cc2d.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-24cc279d.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-6e0f3ea0.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-e69d09a1.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-8539ffd7.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-85da1608.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-79395797.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-82b8523e.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-b09d1a67.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-f8319fab.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-f8319fab.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-a4884575.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-a4884575.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-a3b5d12e.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-c2003faf.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-f4f8327c.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-c0ca6b0b.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-d4040555.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-14c56c21.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-38105fc2.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-f1982ca8.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-9c83794e.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-81c51347.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-fda6aff6.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-2c765bf0.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-4e27e45a.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-fa2b2ec6.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-8cc9f807.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-4508a327.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-4046b7d9.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-76c07bd8.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-692ea684.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-05ad766b.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-af0efd67.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-be71f62e.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-38f510f4.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-6a005820.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-10a920e0.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-8a308443.js'));
};
const storeMoves = () => { runDefault(import('./store-875b1a5b.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-869fe256.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-f470eda0.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-fd4b697f.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-9351679d.js')); };
const injectComposing = () => { runDefault(import('./composing-b21fe1c8.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-131cb9f1.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-41c6667d.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-3d506031.js'));
};
...
const guildHall = () => { runDefault(import('./hall-1ecd6c4d.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-6219ac8b.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-e9f91f13.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-ac7a29ff.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-bc774ae2.js')); };
const guildLog = () => { runDefault(import('./guildLog-0a942b24.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-7b0bf980.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-787321ab.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-e86cbdeb.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-29dcab29.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-7be3da99.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-a7d6fd30.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-393fccce.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-800648eb.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-8f27b9ca.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-504bb348.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-6bc15664.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-0feb8834.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-0e210f8a.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-82c56c38.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-bb241ace.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-5cf58661.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-518abc7b.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-afa992da.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-5d26985a.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-afc3ceb2.js')); };
const injectTopRated = () => { runDefault(import('./toprated-7f21a2f2.js')); };
...
const injectTrade = () => { runDefault(import('./trade-745cb992.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-3960e5ba.js')); };
const injectBank = () => { runDefault(import('./injectBank-6ba3b677.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-26a5bf1d.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-1e59fa34.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-58db1586.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-8e419a97.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-cfb1a9ef.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-e70539b3.js'));
};
const ladder = () => { runDefault(import('./ladder-f46df2db.js')); };
const marketplace = () => { runDefault(import('./marketplace-9db7d58b.js')); };
const points = () => { runDefault(import('./points-71203f1f.js')); };
const superelite = () => { runDefault(import('./superelite-96615d6c.js')); };
const privateMsg = () => { runDefault(import('./privateMsg-b29d7fa9.js')); };
const playerLog = () => { runDefault(import('./playerLog-6a6d999a.js')); };
...
export { $dataAccess as $, setText as A, setInnerHtml as B, getText as C, searchPlayerUrl as D, querySelector as E, querySelectorArray as F, playerLinkSelector as G, getTextTrim as H, getValue as I, defCharacterVirtualLevel as J, defStatLevel as K, quickbuffUrl as L, getElementsByClassName as M, navigateTo as N, indexPhp as O, isArray as P, once as Q, clickThis as R, getUrlParameter as S, sendEvent as T, insertHtml as U, nowSecs as V, scouttowerUrl as W, setValue as X, jQueryDialog as Y, injectNotepadShowLogs as Z, injectMonsterLog as _, add$1 as a, keys as a$, getCalfPrefs as a0, escapeHtml as a1, theLinks as a2, playerIdUrl as a3, notepadBlankUrl as a4, fallback as a5, now as a6, defLastLadderReset as a7, server as a8, cmdUrl as a9, oldActionSpinner as aA, defTd as aB, runDefault as aC, composingUrl as aD, defSubcmd as aE, defNeedToCompose as aF, contains as aG, defLastComposeCheck as aH, playerId as aI, showPlayerUrl as aJ, retryAjax as aK, isFunction as aL, containsText as aM, guideUrl as aN, defFetchPlayerBuffs as aO, defPlayerBuffs as aP, defPlayerUpdate as aQ, defTeleport as aR, defPvE as aS, isUndefined as aT, defAfterUpdateActionlist as aU, defFetchWorldRealmDynamic as aV, defFetchWorldRealmActions as aW, hideQTip as aX, worldUrl as aY, defRealmUpdate as aZ, defPlayerLevel as a_, pointsUrl as aa, insertHtmlAfterBegin as ab, querySelectorAll as ac, months as ad, sendException as ae, parseError as af, arrayFrom as ag, classPair as ah, tradeUrl as ai, secureUrl as aj, isObject as ak, getCustomUrlParameter as al, attackplayerUrl as am, doAddIgnore as an, fromEntries as ao, combatSelector as ap, noteSelector as aq, defTr as ar, defaults as as, time as at, timeEnd as au, loadScript as av, loadCss as aw, infoBox as ax, cdn as ay, arenaUrl as az, createDiv as b, newGuildLogUrl as b$, defenderMultiplier as b0, defRelicView as b1, doSendGold as b2, defPlayerGold as b3, initSendGoldOnWorld as b4, sendGoldonWorld as b5, defStatAttack as b6, defStatDefense as b7, defStatArmor as b8, defStatDamage as b9, playerIDRE as bA, defCmd as bB, guildRE as bC, defEnableGuildActivityTracker as bD, draggable as bE, recallUserUrl as bF, defStatVl as bG, asyncPThree as bH, updateArchiveUrl as bI, archiveUrl as bJ, auctionSearchUrl as bK, getValueJSON as bL, setValueJSON as bM, profileUrl as bN, pCR as bO, pCL as bP, classHandler as bQ, bountyUrl as bR, parseTemplePage as bS, displayDisconnectedFromGodsMessage as bT, blacksmithUrl as bU, dropItemsUrl as bV, defStatbarLevel as bW, injectFsBoxContent as bX, joinallUrl as bY, joinUnderUrl as bZ, newGuildLogLoc as b_, defStatHp as ba, defRefreshActionList as bb, defStairway as bc, defShopPrompt as bd, defViewCreature as be, jsonParse as bf, defFetchPlayerBackpackCount as bg, defControlsKeydown as bh, handleEvent as bi, places as bj, mercRE as bk, ahSearchUrl as bl, fshBuffLog as bm, screenview as bn, news$1 as bo, injectQuestBookFull as bp, inventing as bq, rarity as br, itemType as bs, profile$2 as bt, composingFragmentType as bu, isString as bv, guildLogUrl as bw, GMSTORAGE_PATH as bx, guildViewUrl as by, lastActivityRE as bz, calf as c, defJoinallgroupsundersize as c0, injectGuild as c1, injectAuctionSearch as c2, injectOnlinePlayers as c3, injectFindOther as c4, injectFindBuffs as c5, injectRecipeManager as c6, injectBuffLog as c7, injectQuickLinkManager as c8, joinGroups as c9, auctionhouseUrl as ca, insertQuickExtract as cb, insertQuickWear as cc, dispatch as cd, defTable as d, entries as e, insertHtmlBeforeEnd as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, on as k, itemRE as l, getArrayByTagName as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, infoBoxFrom as w, callApp as x, jQueryNotPresent as y, getElementById as z };
//# sourceMappingURL=calfSystem-23094c64.js.map
