...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-7cdf1938.js')); };
const injectGuild = () => { runDefault(import('./guild-60c4de2e.js')); };
const injectProfile = () => { runDefault(import('./profile-cfa5e286.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-68277fbd.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-0064e875.js')); };
const inventing = () => { runDefault(import('./inventing-3efc40cd.js')); };
const news$1 = () => { runDefault(import('./news-6940b56e.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-3881dd2d.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-6dcb0e45.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-5e771ca4.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-7645718c.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-ed7b26a7.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-fea2e3a2.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-58ee5b0c.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-357cd8da.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-08315d3a.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-95d48c44.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-e4d9455d.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-e4d9455d.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-485eb5ff.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-485eb5ff.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-a0a4ac2c.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-3ee3684e.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-201ad5c0.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-fc41f4c5.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-6b2c3216.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-37a85a76.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-e14476a6.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-df83abae.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-0b431a97.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-c20f61a6.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-20aa45d0.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-32170517.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-2666f6df.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-2782ad49.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-bee08245.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-ae9d014a.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-93555842.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-3b7a4bd4.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-1ec9f21e.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-4718f786.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-599733d9.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-deb2750a.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-d5d9c2c2.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-58ef31d0.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-a4cf95fc.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-29293ad5.js'));
};
const storeMoves = () => { runDefault(import('./store-56222df7.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-71a025f9.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-43975baa.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-1fed8cb2.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-9e4eaca7.js')); };
const injectComposing = () => { runDefault(import('./composing-3de78b68.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-1e3d7c51.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-1420f658.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-444dd41f.js'));
};
...
const guildHall = () => { runDefault(import('./hall-8b9a7e84.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-4ebcf9bf.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-5a760153.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-59114d51.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-cb75b655.js')); };
const guildLog = () => { runDefault(import('./guildLog-8b1113d2.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-4cb9f5d7.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-15f036ee.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-93b49b82.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-ae1912f4.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-dbc9dc60.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-043a193a.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-b9de0ffd.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-ce1349cb.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-e07e89fe.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-17611d74.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-38724fdd.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-0fa9cbf8.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-235d4ab3.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-038c1b5e.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-49615181.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-6b56fe58.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-29013e3e.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-398818e3.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-00399312.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-83fab8c6.js')); };
const injectTopRated = () => { runDefault(import('./toprated-5a61a360.js')); };
...
const injectTrade = () => { runDefault(import('./trade-cf64bfde.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-fe249bbe.js')); };
const injectBank = () => { runDefault(import('./injectBank-2c98f8f0.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-7462cdb1.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-04317cd9.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-7233b045.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-4a28ef41.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-3bbc5db6.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-be0c8f55.js'));
};
const ladder = () => { runDefault(import('./ladder-74ad427d.js')); };
const marketplace = () => { runDefault(import('./marketplace-ed4eb7eb.js')); };
const points = () => { runDefault(import('./points-29318076.js')); };
const superelite = () => { runDefault(import('./superelite-1150c15a.js')); };
const privateMsg = () => { runDefault(import('./privateMsg-8c2dc8dc.js')); };
const playerLog = () => { runDefault(import('./playerLog-812a1231.js')); };
...
export { $dataAccess as $, setText as A, setInnerHtml as B, getText as C, searchPlayerUrl as D, querySelector as E, querySelectorArray as F, playerLinkSelector as G, getTextTrim as H, getValue as I, defCharacterVirtualLevel as J, defStatLevel as K, quickbuffUrl as L, getElementsByClassName as M, navigateTo as N, indexPhp as O, isArray as P, once as Q, clickThis as R, getUrlParameter as S, sendEvent as T, insertHtml as U, nowSecs as V, scouttowerUrl as W, setValue as X, jQueryDialog as Y, injectNotepadShowLogs as Z, injectMonsterLog as _, add$1 as a, worldUrl as a$, getCalfPrefs as a0, escapeHtml as a1, theLinks as a2, playerIdUrl as a3, notepadBlankUrl as a4, fallback as a5, isBoolean as a6, isUndefined as a7, now as a8, defLastLadderReset as a9, infoBox as aA, cdn as aB, arenaUrl as aC, oldActionSpinner as aD, defTd as aE, runDefault as aF, composingUrl as aG, defSubcmd as aH, defNeedToCompose as aI, contains as aJ, defLastComposeCheck as aK, playerId as aL, showPlayerUrl as aM, retryAjax as aN, isFunction as aO, containsText as aP, guideUrl as aQ, defFetchPlayerBuffs as aR, defPlayerBuffs as aS, defPlayerUpdate as aT, defTeleport as aU, defPvE as aV, defAfterUpdateActionlist as aW, guildViewUrl as aX, defFetchWorldRealmDynamic as aY, defFetchWorldRealmActions as aZ, hideQTip as a_, server as aa, cmdUrl as ab, pointsUrl as ac, insertHtmlAfterBegin as ad, querySelectorAll as ae, months as af, sendException as ag, parseError as ah, arrayFrom as ai, toLowerCase as aj, classPair as ak, tradeUrl as al, secureUrl as am, isObject as an, getCustomUrlParameter as ao, attackplayerUrl as ap, doAddIgnore as aq, fromEntries as ar, combatSelector as as, noteSelector as at, defTr as au, defaults as av, time as aw, timeEnd as ax, loadScript as ay, loadCss as az, createDiv as b, joinallUrl as b$, defRealmUpdate as b0, defPlayerLevel as b1, keys as b2, defenderMultiplier as b3, defRelicView as b4, doSendGold as b5, defPlayerGold as b6, initSendGoldOnWorld as b7, sendGoldonWorld as b8, defStatAttack as b9, GMSTORAGE_PATH as bA, lastActivityRE as bB, playerIDRE as bC, defCmd as bD, alpha as bE, guildRE as bF, defEnableGuildActivityTracker as bG, draggable as bH, recallUserUrl as bI, defStatVl as bJ, asyncPThree as bK, updateArchiveUrl as bL, archiveUrl as bM, auctionSearchUrl as bN, getValueJSON as bO, setValueJSON as bP, profileUrl as bQ, pCR as bR, pCL as bS, classHandler as bT, bountyUrl as bU, parseTemplePage as bV, displayDisconnectedFromGodsMessage as bW, blacksmithUrl as bX, dropItemsUrl as bY, defStatbarLevel as bZ, injectFsBoxContent as b_, defStatDefense as ba, defStatArmor as bb, defStatDamage as bc, defStatHp as bd, defRefreshActionList as be, defStairway as bf, defShopPrompt as bg, defViewCreature as bh, jsonParse as bi, defFetchPlayerBackpackCount as bj, defControlsKeydown as bk, handleEvent as bl, places as bm, mercRE as bn, ahSearchUrl as bo, fshBuffLog as bp, screenview as bq, news$1 as br, injectQuestBookFull as bs, inventing as bt, rarity as bu, itemType as bv, profile$2 as bw, composingFragmentType as bx, isString as by, guildLogUrl as bz, calf as c, joinUnderUrl as c0, newGuildLogLoc as c1, newGuildLogUrl as c2, defJoinallgroupsundersize as c3, injectGuild as c4, injectAuctionSearch as c5, injectOnlinePlayers as c6, injectFindOther as c7, injectFindBuffs as c8, injectRecipeManager as c9, injectBuffLog as ca, injectQuickLinkManager as cb, joinGroups as cc, auctionhouseUrl as cd, insertQuickExtract as ce, insertQuickWear as cf, dispatch as cg, defTable as d, entries as e, insertHtmlBeforeEnd as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, on as k, itemRE as l, getArrayByTagName as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, infoBoxFrom as w, callApp as x, jQueryNotPresent as y, getElementById as z };
//# sourceMappingURL=calfSystem-7a121553.js.map
