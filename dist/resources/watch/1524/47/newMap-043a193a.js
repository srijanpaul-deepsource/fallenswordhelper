import { c as calf, b as createDiv, z as getElementById, A as setText, i as insertElement, s as partial, aR as defFetchPlayerBuffs, f as insertHtmlBeforeEnd, o as onclick, P as isArray, aS as defPlayerBuffs, aT as defPlayerUpdate, aU as defTeleport, X as setValue, E as querySelector, F as querySelectorArray, aB as cdn, T as sendEvent, g as getElementsByTagName, k as on, aV as defPvE, I as getValue, C as getText, a7 as isUndefined, aO as isFunction, aW as defAfterUpdateActionlist, x as callApp, aX as guildViewUrl, aM as showPlayerUrl, B as setInnerHtml, aY as defFetchWorldRealmDynamic, aZ as defFetchWorldRealmActions, a_ as hideQTip, a$ as worldUrl, aH as defSubcmd, aQ as guideUrl, b0 as defRealmUpdate, b1 as defPlayerLevel, a3 as playerIdUrl, V as nowSecs, b2 as keys, t as createDocument, ae as querySelectorAll, a5 as fallback, b3 as defenderMultiplier, u as indexAjaxData, Q as once, b4 as defRelicView, b5 as doSendGold, b6 as defPlayerGold, b7 as initSendGoldOnWorld, b8 as sendGoldonWorld, aN as retryAjax, q as extend, a as add, M as getElementsByClassName, b9 as defStatAttack, ba as defStatDefense, bb as defStatArmor, bc as defStatDamage, bd as defStatHp, ai as arrayFrom, h as hasClass, af as months, H as getTextTrim, a8 as now, $ as $dataAccess, be as defRefreshActionList, bf as defStairway, bg as defShopPrompt, bh as defViewCreature, bi as jsonParse, bj as defFetchPlayerBackpackCount, bk as defControlsKeydown } from './calfSystem-7a121553.js';
import { i as insertElementAfter } from './insertElementAfter-8028e664.js';
import { t as toggleForce } from './toggleForce-41b0f4ee.js';
import { c as createSpan } from './createSpan-bcdf48f3.js';
import { i as insertTextBeforeEnd } from './insertTextBeforeEnd-e3c0faff.js';
import { a as round, r as roundToString } from './roundToString-042f58fd.js';
import { a as addCommas } from './addCommas-27b35f1c.js';
import { q as quickbuffSuccess, d as daQuickbuff } from './quickbuffSuccess-8c2506f1.js';
import { p as playerName$1 } from './playerName-c1e4c230.js';
import { s as set, g as get } from './idb-a4bd5e0c.js';
import { c as createStyle } from './createStyle-f5a906f6.js';
...
import { d as doBuffLinks, g as getGroupStats$1 } from './getGroupStats-30aa5b00.js';
import { g as getMercStats } from './getMercStats-9bd6920a.js';
import { g as getProfile } from './getProfile-ca87cf7e.js';
import { g as getMembrList } from './getMembrList-eb128386.js';
import { h as hideElement } from './hideElement-7486432a.js';
import { n as numberIsNaN } from './numberIsNaN-2f104aa2.js';
import { r as reduceBuffArray } from './reduceBuffArray-4540efb2.js';
import { r as rnd } from './rnd-b26142cd.js';
import { h as hasClasses } from './hasClasses-09c5db12.js';
...
import { g as getKillsPct, a as getTitanString } from './getTitanString-caa19ea3.js';
import { p as padZ } from './padZ-65ad9136.js';
import { c as createTable } from './createTable-86ca1e44.js';
import { t as testQuant } from './testQuant-4a4612db.js';
import { g as groupViewStats } from './groupViewStats-075ab53c.js';
import { m as myStats } from './myStats-d5bc9765.js';
import { a as huntingBuffsHtml } from './huntingBuffs-179cca20.js';
import { b as simpleCheckboxHtml } from './simpleCheckbox-4ea82834.js';
import { b as bitwiseAnd } from './bitwiseAnd-66d656b9.js';
import { s as shouldBeArray } from './shouldBeArray-0660f652.js';
import './getBuff-047def3d.js';
import './buffObj-68975e43.js';
import './fshOpen-a2455e89.js';
import './createLi-b5e42de2.js';
import './createUl-8f2e09e7.js';
...
var css$3 = "/* World Action List */\n#actionList .crate {background-color: PaleVioletRed;}\n";
var modules_4cf20f2f = {};
...
function drawBuffInfo() {
  if (containerDiv$1) {
    toggleForce(containerDiv$1, false);
  } else {
    containerDiv$1 = createDiv({
      className: 'fshActionBox',
      innerHTML: '<div></div><div></div><div></div>'
        + '<div></div><div></div><div></div>',
    });
    const actCont = getElementById('actionContainer');
    insertElementAfter(containerDiv$1, actCont.children[2]);
  }
  return containerDiv$1;
}

function hideBuffInfo() {
  if (containerDiv$1) {
    toggleForce(containerDiv$1, true);
  }
}
...
function hasTitan$1(el) { return el.type === 0; }

function titanKs() {
  const { dynamic } = GameData.realm();
  return isArray(dynamic) && dynamic.some(hasTitan$1);
}
...
function storeEnhancements$1(enh) {
...
function hazEnhancements(data) {
  if (data.player.enhancements) {
    data.player.enhancements.forEach(storeEnhancements$1); // loop through enhancements
  }
}
...
function condition$1(key, fn) { return fn(key); }

function availableMembers(key) {
  return available.every(partial(condition$1, key));
}
...
function doGroupAttackBuffedElement() {
  const storedFlinchEffectValue = Math.ceil(groupStats$1.attack
...
function doGroupDamageBuffedElement(buffs, fortitudeBonusHP) {
  const chiStrikeBonusDamage = Math.ceil((groupStats$1.hp + fortitudeBonusHP)
...
function getCreatureStats(id, passback) {
  const cached = creatureCache.find(partial(thisMob$1, id));
  if (cached) {
...
// Incomplete
function scouttower() {
  return indexAjaxData({ cmd: 'guild', subcmd: 'scouttower' }).then(parseReport$2);
}

function daScoutTower() {
  return $dataAccess(scouttower$1, scouttower);
}
...
var css$1 = ".cR .fshActionBox {\n  background: -webkit-linear-gradient(top, rgba(255,255,255,0.4) 0%,rgba(255,255,255,0.2) 100%);\n  border-radius: 4px;\n  border: solid 0 #ffffff;\n  box-shadow: 0 1px 3px #000000;\n  margin: 6px 4px 4px;\n  padding: 4px;\n  overflow: hidden;\n}\n#actionContainer .fshActionBox:nth-child(4) {\n  margin-top: 3px;\n}\n\n.titanInfo table {width: 184px;}\n.titanInfo .header {font-size: 11px;}\n.titanInfo .cooldown {font-weight: bold;}\n";
var modules_e13f810f = {};
...
var css = "#dialog-viewcreature .fshFooter {\n  color: grey;\n  font-size: x-small;\n}\n";
var modules_ae2154bf = {};
...
function parseReport(html) {
  ...
  return { r: [{ id, members: [{ name: playerName$1() }] }] };
}
...
//# sourceMappingURL=newMap-043a193a.js.map
