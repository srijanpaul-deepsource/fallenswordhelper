...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-9c98c75f.js')); };
const injectGuild = () => { runDefault(import('./guild-b7b7a55e.js')); };
const injectProfile = () => { runDefault(import('./profile-2b08f24c.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-d8ba37cc.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-49203aac.js')); };
const inventing = () => { runDefault(import('./inventing-893a7d71.js')); };
const news$1 = () => { runDefault(import('./news-1776e3a4.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-0364913b.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-f85e82dc.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-9f0acb03.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-11ef2219.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-7eeab418.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-a3d82485.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-57789565.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-863a9442.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-0379f33a.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-43468a62.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-70547e2f.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-70547e2f.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-745f5daa.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-745f5daa.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-c30b2392.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-16ede038.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-33ff71d1.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-afe1f28b.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-6203a6cd.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-439406ad.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-3ba6c7c8.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-3f8cae7a.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-25f4eec0.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-c03fb8b8.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-6b72319d.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-1dc3b265.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-ec98bcb5.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-746f33f7.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-3216a99f.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-5361789b.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-4a941240.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-1dedd62e.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-5faa783d.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-755f193a.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-80d837dc.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-fbe90178.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-97649020.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-6d6fcf00.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-f446be98.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-bf3d0336.js'));
};
const storeMoves = () => { runDefault(import('./store-cb4bdfc5.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-ca591bd4.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-a3be01e4.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-df3d8955.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-aeb3ad52.js')); };
const injectComposing = () => { runDefault(import('./composing-8283cb24.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-ad6defdf.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-1b57cd27.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-b63e3ccd.js'));
};
...
const guildHall = () => { runDefault(import('./hall-70f8f127.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-cbdb7681.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-226c7d1b.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-a3b9f57b.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-c0a3c8b7.js')); };
const guildLog = () => { runDefault(import('./guildLog-da0cb621.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-be3dfdbc.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-29967991.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-e5ec784a.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-ab342d7d.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-5aee4c98.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-c7394257.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-2f0cd335.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-92a5633e.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-481dd353.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-b9a0f841.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-f5afc81d.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-09d02525.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-1af42524.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-bebb6c2c.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-cd3807ad.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-af07de3c.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-b5406382.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-814c223a.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-cfbeb7d0.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-908d7121.js')); };
const injectTopRated = () => { runDefault(import('./toprated-bd1fe493.js')); };
...
const injectTrade = () => { runDefault(import('./trade-f97dc3ad.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-17cef443.js')); };
const injectBank = () => { runDefault(import('./injectBank-0d25068f.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-abcb8391.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-f978d5b8.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-8cdae577.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-f95afd0b.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-044b57e3.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-84a78f74.js'));
};
const ladder = () => { runDefault(import('./ladder-6ea68179.js')); };
const marketplace = () => { runDefault(import('./marketplace-ca19dbf5.js')); };
const points = () => { runDefault(import('./points-19c5f03a.js')); };
const superelite = () => { runDefault(import('./superelite-0e4fefcb.js')); };
const privateMsg = () => { runDefault(import('./privateMsg-ccf5ef69.js')); };
const playerLog = () => { runDefault(import('./playerLog-7b6973c5.js')); };
