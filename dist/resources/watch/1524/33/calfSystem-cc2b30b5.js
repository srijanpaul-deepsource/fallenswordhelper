...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-bdf4d4ec.js')); };
const injectGuild = () => { runDefault(import('./guild-59460248.js')); };
const injectProfile = () => { runDefault(import('./profile-9e1867c9.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-50f33d30.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-d43cdc5d.js')); };
const inventing = () => { runDefault(import('./inventing-d8df0841.js')); };
const news = () => { runDefault(import('./news-8e389393.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-9b681698.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-a3ef53c3.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-cc2a1533.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-d1fee990.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-c36c94a9.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-415786c2.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-9552b0c3.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-9cc0126f.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-beae09e0.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-dd387298.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-736ff971.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-736ff971.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-d3ca8d62.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-d3ca8d62.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-6defd80b.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-38fb42d9.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-4f7d2696.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-373682e3.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-2b14b523.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-2cf421a8.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-38dbaa8e.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-dbddf7ba.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-f1e2fd4c.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-396a16a1.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-04a94734.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-5b18c85f.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-08ddac82.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-c3e700bf.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-c9f0b38a.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-87f3adfd.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-f4834acd.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-a301d174.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-044ee5a5.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-70d7889b.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-8984f29e.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-e7ba91a3.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-574c566a.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-fed130fe.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-b9f10591.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-322ccc81.js'));
};
const storeMoves = () => { runDefault(import('./store-f2af7538.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-cc50fc25.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-fe1c0b5c.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-cc565bc8.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-1b5f0854.js')); };
const injectComposing = () => { runDefault(import('./composing-4ade2c00.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-da5ad750.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-9fb32faa.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-7eab7b95.js'));
};
...
const guildHall = () => { runDefault(import('./hall-45a3114b.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-3dcdcdeb.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-fcf25095.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-f32f18ad.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-1e939a6d.js')); };
const guildLog = () => { runDefault(import('./guildLog-1f6e48f6.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-aa7338e1.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-8b34e1bb.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-d8ab1fee.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-91ff92c3.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-a8386020.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-26475970.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-6c2581ba.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-425bd706.js')); };
const outbox = () => { runDefault(import('./outbox-2f081ac0.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-19805187.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-bee2dad0.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-fd6eeeb5.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-199cfa66.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-b8d00337.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-e8733ac9.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-82753862.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-b71161f9.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-2c6d591d.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-d28a91fd.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-272f0c2b.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-a1c4b36a.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-087bc33a.js')); };
const injectTopRated = () => { runDefault(import('./toprated-c0697d28.js')); };
...
const injectTrade = () => { runDefault(import('./trade-a70c2bdb.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-a7bad29b.js')); };
const injectBank = () => { runDefault(import('./injectBank-1c66dbb1.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-3553ee97.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-d19b117f.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-5330b44e.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-e94b793d.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-8612c096.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-089ea47b.js'));
};
const ladder = () => { runDefault(import('./ladder-c199a206.js')); };
const marketplace = () => { runDefault(import('./marketplace-cd2b9726.js')); };
const points = () => { runDefault(import('./points-dc2303c9.js')); };
const superelite = () => { runDefault(import('./superelite-a5c576d6.js')); };
...
//# sourceMappingURL=calfSystem-cc2b30b5.js.map
