...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-eefc6ecc.js')); };
const injectGuild = () => { runDefault(import('./guild-176ffbfd.js')); };
const injectProfile = () => { runDefault(import('./profile-4f8b318d.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-227b170c.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-a56d31ce.js')); };
const inventing = () => { runDefault(import('./inventing-a7ff6045.js')); };
const news$1 = () => { runDefault(import('./news-4d1b06fb.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-32b6ec48.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-151e30b1.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-280fee63.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-d49e2936.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-e08ad3b4.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-5627e4e1.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-f9e16c03.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-6d98e684.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-61893218.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-609ed631.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-da2a3aa0.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-da2a3aa0.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-ecc5db46.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-ecc5db46.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-38f59bbc.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-f5bd9e92.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-00d9c483.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-effdbf0b.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-0f21f3cd.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-05ecb93d.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-39710eea.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-0663bcca.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-da50f0ce.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-35a8072a.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-5aea51a6.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-3825816b.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-a8a82fc1.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-be11b8b5.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-a25b13c9.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-8eed6d77.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-fad8eeb7.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-beafb365.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-6b88c948.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-ab3b700f.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-37fa6368.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-64d4d3e1.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-216174d1.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-99081668.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-80622f17.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-5f521397.js'));
};
const storeMoves = () => { runDefault(import('./store-a64e5036.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-52dec879.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-6f07ffd7.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-71c5bd4f.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-7f2e3d1f.js')); };
const injectComposing = () => { runDefault(import('./composing-32c9b9d8.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-fee4394c.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-e57c8277.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-bf461446.js'));
};
...
const guildHall = () => { runDefault(import('./hall-6f4f4a59.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-d00d2ddd.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-78c93964.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-557aaf92.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-6ed6a4d3.js')); };
const guildLog = () => { runDefault(import('./guildLog-dd667560.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-9c1d3b42.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-57d77f2e.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-26efb255.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-5709fbdc.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-51b1f930.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-7a8e73ca.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-27a2a3c7.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-e2eb1086.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-cb29337e.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-5c4700c0.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-0755faf6.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-b0e74b0e.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-4e793857.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-2ea01f83.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-af60e089.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-222c01a5.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-416a9517.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-35d44ba9.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-8feb9fde.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-8e9e14db.js')); };
const injectTopRated = () => { runDefault(import('./toprated-1312f51e.js')); };
...
const injectTrade = () => { runDefault(import('./trade-69cb8d90.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-cac58f80.js')); };
const injectBank = () => { runDefault(import('./injectBank-3e47e4db.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-221aa49e.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-c4ad4379.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-1bd128c8.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-bf0c6410.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-8ece3310.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-1b640724.js'));
};
const ladder = () => { runDefault(import('./ladder-51f92934.js')); };
const marketplace = () => { runDefault(import('./marketplace-68f0492e.js')); };
const points = () => { runDefault(import('./points-92486235.js')); };
const superelite = () => { runDefault(import('./superelite-7c53b643.js')); };
const privateMsg = () => { runDefault(import('./privateMsg-8c64dd55.js')); };
const playerLog = () => { runDefault(import('./playerLog-24d777b4.js')); };
...
export { $dataAccess as $, setText as A, setInnerHtml as B, getText as C, searchPlayerUrl as D, querySelector as E, querySelectorArray as F, playerLinkSelector as G, getTextTrim as H, getValue as I, defCharacterVirtualLevel as J, getElementsByClassName as K, defStatLevel as L, quickbuffUrl as M, arrayFrom as N, navigateTo as O, indexPhp as P, isArray as Q, once as R, clickThis as S, getUrlParameter as T, insertHtml as U, nowSecs as V, scouttowerUrl as W, setValue as X, sendEvent as Y, jQueryDialog as Z, injectNotepadShowLogs as _, add$1 as a, defRelicView as a$, injectMonsterLog as a0, getCalfPrefs as a1, escapeHtml as a2, theLinks as a3, playerIdUrl as a4, notepadBlankUrl as a5, fallback as a6, now as a7, defLastLadderReset as a8, server as a9, runDefault as aA, composingUrl as aB, defSubcmd as aC, defNeedToCompose as aD, contains as aE, defLastComposeCheck as aF, playerId as aG, showPlayerUrl as aH, retryAjax as aI, isFunction as aJ, containsText as aK, guideUrl as aL, defFetchPlayerBuffs as aM, defPlayerBuffs as aN, defPlayerUpdate as aO, defTeleport as aP, defPvE as aQ, isUndefined as aR, defAfterUpdateActionlist as aS, defFetchWorldRealmDynamic as aT, defFetchWorldRealmActions as aU, hideQTip as aV, worldUrl as aW, defRealmUpdate as aX, defPlayerLevel as aY, keys as aZ, defenderMultiplier as a_, cmdUrl as aa, pointsUrl as ab, insertHtmlAfterBegin as ac, querySelectorAll as ad, months as ae, sendException as af, parseError as ag, isObject as ah, getCustomUrlParameter as ai, attackplayerUrl as aj, doAddIgnore as ak, fromEntries as al, combatSelector as am, chatSelector as an, noteSelector as ao, defTr as ap, defTd as aq, defaults as ar, time as as, timeEnd as at, loadScript as au, loadCss as av, infoBox as aw, cdn as ax, arenaUrl as ay, oldActionSpinner as az, createDiv as b, newGuildLogUrl as b$, doSendGold as b0, defPlayerGold as b1, initSendGoldOnWorld as b2, sendGoldonWorld as b3, defStatAttack as b4, defStatDefense as b5, defStatArmor as b6, defStatDamage as b7, defStatHp as b8, defRefreshActionList as b9, guildRE as bA, defEnableGuildActivityTracker as bB, draggable as bC, recallUserUrl as bD, defStatVl as bE, asyncPThree as bF, updateArchiveUrl as bG, archiveUrl as bH, auctionSearchUrl as bI, getValueJSON as bJ, setValueJSON as bK, profileUrl as bL, pCR as bM, pCL as bN, secureUrl as bO, tradeUrl as bP, classHandler as bQ, bountyUrl as bR, parseTemplePage as bS, displayDisconnectedFromGodsMessage as bT, blacksmithUrl as bU, dropItemsUrl as bV, defStatbarLevel as bW, injectFsBoxContent as bX, joinallUrl as bY, joinUnderUrl as bZ, newGuildLogLoc as b_, defStairway as ba, defShopPrompt as bb, defViewCreature as bc, jsonParse as bd, defFetchPlayerBackpackCount as be, defControlsKeydown as bf, handleEvent as bg, places as bh, mercRE as bi, ahSearchUrl as bj, fshBuffLog as bk, screenview as bl, news$1 as bm, injectQuestBookFull as bn, inventing as bo, rarity as bp, itemType as bq, profile$2 as br, composingFragmentType as bs, isString as bt, guildLogUrl as bu, GMSTORAGE_PATH as bv, guildViewUrl as bw, lastActivityRE as bx, playerIDRE as by, defCmd as bz, calf as c, defJoinallgroupsundersize as c0, classPair as c1, injectGuild as c2, injectAuctionSearch as c3, injectOnlinePlayers as c4, injectFindOther as c5, injectFindBuffs as c6, injectRecipeManager as c7, injectBuffLog as c8, injectQuickLinkManager as c9, joinGroups as ca, auctionhouseUrl as cb, insertQuickExtract as cc, insertQuickWear as cd, dispatch as ce, defTable as d, entries as e, insertHtmlBeforeEnd as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, on as k, itemRE as l, getArrayByTagName as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, infoBoxFrom as w, callApp as x, jQueryNotPresent as y, getElementById as z };
//# sourceMappingURL=calfSystem-78c09adf.js.map
