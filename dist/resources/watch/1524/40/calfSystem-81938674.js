...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-e60cb2dc.js')); };
const injectGuild = () => { runDefault(import('./guild-47095913.js')); };
const injectProfile = () => { runDefault(import('./profile-b277069c.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-81c6a4ca.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-57b9f51f.js')); };
const inventing = () => { runDefault(import('./inventing-1884cdb2.js')); };
const news$1 = () => { runDefault(import('./news-5e1c3674.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-13fcb1ba.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-ef0de606.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-b24d4cdd.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-ca737dff.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-ba00223f.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-48a18ad4.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-8073ef4f.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-53083d3e.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-e532c7d5.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-dcf5f1c0.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-f45d8592.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-f45d8592.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-a2d1cc00.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-a2d1cc00.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-966cde65.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-da54d22f.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-dda871fe.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-d65984d8.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-e6e09cfb.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-f2d04495.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-75cf1825.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-c17529fd.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-420193b4.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-67861c51.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-9ec3dfe1.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-3e14abc2.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-9e906fd8.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-467ae4c4.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-10852d34.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-b74fa01c.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-787ff9da.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-e970fd00.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-6afb2de9.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-eca55f59.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-34f36cb6.js').then((m) => m.seLog());
  }
}
...
function viewcombatset() {
  return profile$2({ subcmd: 'viewcombatset' });
}
...
const injectArena = () => { runDefault(import('./arena-1147807f.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-636d54d1.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-0af4d638.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-95925849.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-ce22326e.js'));
};
const storeMoves = () => { runDefault(import('./store-1e4e5ad2.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-c6bf0ef0.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-8fdbfa5a.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-abb7db66.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-648030a8.js')); };
const injectComposing = () => { runDefault(import('./composing-33a2ff4a.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-c1688a0a.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-66055969.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-298e44b7.js'));
};
...
const guildHall = () => { runDefault(import('./hall-bf509bb9.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-f784502d.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-e731d70a.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-a838887f.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-38f4ff53.js')); };
const guildLog = () => { runDefault(import('./guildLog-9be22f01.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-594413b4.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-fd94f22b.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-cf786022.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-a26fe1df.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-2e32075d.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-5e36d937.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-c7a50f03.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-1f76d89f.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-2b5d0917.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-be5773fe.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-1cb0d965.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-60fa7281.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-cb1d60fc.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-b6686bed.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-9014b3e1.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-9268bce7.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-c6747e07.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-251e3b9a.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-837ec624.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-f2d5bba2.js')); };
const injectTopRated = () => { runDefault(import('./toprated-d852cb1e.js')); };
...
const injectTrade = () => { runDefault(import('./trade-643549ee.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-167a5765.js')); };
const injectBank = () => { runDefault(import('./injectBank-03a65fab.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-603e7965.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-ad6defef.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-f0f4a525.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-d60b849f.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-a63ba7f8.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-8b06819d.js'));
};
const ladder = () => { runDefault(import('./ladder-ef9d156c.js')); };
const marketplace = () => { runDefault(import('./marketplace-0ac75e7d.js')); };
const points = () => { runDefault(import('./points-1443578a.js')); };
const superelite = () => { runDefault(import('./superelite-b00f7e4a.js')); };
const privateMsg = () => { runDefault(import('./privateMsg-8329974f.js')); };
const playerLog = () => { runDefault(import('./playerLog-a21a4648.js')); };
...
export { $dataAccess as $, setText as A, setInnerHtml as B, getText as C, searchPlayerUrl as D, querySelector as E, querySelectorArray as F, playerLinkSelector as G, getTextTrim as H, getValue as I, defCharacterVirtualLevel as J, getElementsByClassName as K, defStatLevel as L, quickbuffUrl as M, arrayFrom as N, navigateTo as O, indexPhp as P, isArray as Q, once as R, clickThis as S, getUrlParameter as T, insertHtml as U, nowSecs as V, scouttowerUrl as W, setValue as X, sendEvent as Y, jQueryDialog as Z, injectNotepadShowLogs as _, add$1 as a, doSendGold as a$, injectMonsterLog as a0, getCalfPrefs as a1, escapeHtml as a2, theLinks as a3, playerIdUrl as a4, notepadBlankUrl as a5, fallback as a6, now as a7, defLastLadderReset as a8, server as a9, composingUrl as aA, defSubcmd as aB, defNeedToCompose as aC, contains as aD, defLastComposeCheck as aE, playerId as aF, showPlayerUrl as aG, retryAjax as aH, isFunction as aI, containsText as aJ, guideUrl as aK, defFetchPlayerBuffs as aL, defPlayerBuffs as aM, defPlayerUpdate as aN, defTeleport as aO, defPvE as aP, isUndefined as aQ, defAfterUpdateActionlist as aR, defFetchWorldRealmDynamic as aS, defFetchWorldRealmActions as aT, hideQTip as aU, worldUrl as aV, defRealmUpdate as aW, defPlayerLevel as aX, keys as aY, defenderMultiplier as aZ, defRelicView as a_, cmdUrl as aa, pointsUrl as ab, insertHtmlAfterBegin as ac, querySelectorAll as ad, months as ae, sendException as af, parseError as ag, isObject as ah, getCustomUrlParameter as ai, attackplayerUrl as aj, doAddIgnore as ak, fromEntries as al, combatSelector as am, chatSelector as an, noteSelector as ao, defTr as ap, defTd as aq, defaults as ar, time as as, timeEnd as at, loadCss as au, infoBox as av, cdn as aw, arenaUrl as ax, oldActionSpinner as ay, runDefault as az, createDiv as b, defJoinallgroupsundersize as b$, defPlayerGold as b0, initSendGoldOnWorld as b1, sendGoldonWorld as b2, defStatAttack as b3, defStatDefense as b4, defStatArmor as b5, defStatDamage as b6, defStatHp as b7, defRefreshActionList as b8, defStairway as b9, defEnableGuildActivityTracker as bA, draggable as bB, recallUserUrl as bC, defStatVl as bD, asyncPThree as bE, updateArchiveUrl as bF, archiveUrl as bG, auctionSearchUrl as bH, getValueJSON as bI, setValueJSON as bJ, profileUrl as bK, pCR as bL, pCL as bM, secureUrl as bN, tradeUrl as bO, classHandler as bP, bountyUrl as bQ, parseTemplePage as bR, displayDisconnectedFromGodsMessage as bS, blacksmithUrl as bT, dropItemsUrl as bU, defStatbarLevel as bV, injectFsBoxContent as bW, joinallUrl as bX, joinUnderUrl as bY, newGuildLogLoc as bZ, newGuildLogUrl as b_, defShopPrompt as ba, defViewCreature as bb, jsonParse as bc, defFetchPlayerBackpackCount as bd, defControlsKeydown as be, handleEvent as bf, places as bg, mercRE as bh, ahSearchUrl as bi, fshBuffLog as bj, screenview as bk, news$1 as bl, injectQuestBookFull as bm, inventing as bn, rarity as bo, itemType as bp, profile$2 as bq, composingFragmentType as br, isString as bs, guildLogUrl as bt, GMSTORAGE_PATH as bu, guildViewUrl as bv, lastActivityRE as bw, playerIDRE as bx, defCmd as by, guildRE as bz, calf as c, classPair as c0, injectGuild as c1, injectAuctionSearch as c2, injectOnlinePlayers as c3, injectFindOther as c4, injectFindBuffs as c5, injectRecipeManager as c6, injectBuffLog as c7, injectQuickLinkManager as c8, joinGroups as c9, auctionhouseUrl as ca, insertQuickExtract as cb, insertQuickWear as cc, dispatch as cd, defTable as d, entries as e, insertHtmlBeforeEnd as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, on as k, itemRE as l, getArrayByTagName as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, infoBoxFrom as w, callApp as x, jQueryNotPresent as y, getElementById as z };
//# sourceMappingURL=calfSystem-81938674.js.map
