...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-8eee5a6f.js')); };
const injectGuild = () => { runDefault(import('./guild-23e1a0b8.js')); };
const injectProfile = () => { runDefault(import('./profile-3fb4698a.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-54fbd1ab.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-f4e67939.js')); };
const inventing = () => { runDefault(import('./inventing-59a979b0.js')); };
const news$1 = () => { runDefault(import('./news-ae5ac797.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-9a9cd391.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-cd5ed9b7.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-63d4ab27.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-5154dd42.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-a59ecca7.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-5c1caec5.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-5151dff1.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-b096cc29.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-e7a727b6.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-666fb967.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-2705f4a7.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-2705f4a7.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-0695ec12.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-0695ec12.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-66549d9b.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-da2d9858.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-422d2b2d.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-14bc6731.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-7eb6f47e.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-666172f6.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-3f658ed2.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-34b65899.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-584ed5d9.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-26bca1b9.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-13f95a4c.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-68830a67.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-87671c59.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-fd785051.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-f9ca3414.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-e1f7c413.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-01aaccd6.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-5b3decd6.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-1ca7255a.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-ffc19cb1.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-3847b4f9.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-22e102f2.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-b9cfe815.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-1d2c32da.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-484c8332.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-78a4c35a.js'));
};
const storeMoves = () => { runDefault(import('./store-a07a72e3.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-1c1ce187.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-b3dae9b7.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-de8084b6.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-d0562462.js')); };
const injectComposing = () => { runDefault(import('./composing-6e3f07fe.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-3ce52b28.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-60e1b437.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-bb9d123b.js'));
};
...
const guildHall = () => { runDefault(import('./hall-092701bb.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-1df2a3d1.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-3734d8a3.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-4b3ec9c9.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-c1d2c558.js')); };
const guildLog = () => { runDefault(import('./guildLog-9b843f3c.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-5aa7ae47.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-b3f80c40.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-65e2bd6e.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-15b0086f.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-cd461d1d.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-49e72620.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-215b2cc8.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-e21c6d6c.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-f32c8e3e.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-e0e7fc88.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-b37f1190.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-7e2c2600.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-c6ccefa7.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-1227c410.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-cf4974a2.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-cb5e8056.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-033d949d.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-25e2f451.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-3c58a48d.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-73b498a4.js')); };
const injectTopRated = () => { runDefault(import('./toprated-b2af24fb.js')); };
...
const injectTrade = () => { runDefault(import('./trade-6cada506.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-467ead89.js')); };
const injectBank = () => { runDefault(import('./injectBank-1386a1a4.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-47257882.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-f8d31397.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-25d5570b.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-0402a564.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-e45fc6a9.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-73556e17.js'));
};
const ladder = () => { runDefault(import('./ladder-72a13395.js')); };
const marketplace = () => { runDefault(import('./marketplace-c3ece62b.js')); };
const points = () => { runDefault(import('./points-82ce2754.js')); };
const superelite = () => { runDefault(import('./superelite-53f9472d.js')); };
const privateMsg = () => { runDefault(import('./privateMsg-fb812da6.js')); };
const playerLog = () => { runDefault(import('./playerLog-ef9f638e.js')); };
...
//# sourceMappingURL=calfSystem-86663d02.js.map
