import{N as o,t as n,o as t,a5 as e,z as c,f as r,_ as a,aF as f}from"./calfSystem-fe534823.js"
import{h as s}from"./hideElement-d197c06b.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],T(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function F(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(j)}function L(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(F,o))}(e.prefName),o(e.theTable.rows).forEach(n(b,e)),t(e.theTable,N)}export{L as c}
//# sourceMappingURL=collapse-ca36e8a3.js.map
