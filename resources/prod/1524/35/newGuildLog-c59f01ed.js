import{a as t}from"./addGuildLogWidgets-389ed640.js"
import{a as e}from"./addLogColoring-7e6fca96.js"
import{a as s}from"./all-3be74659.js"
import{u as i,t as n,bp as o,bq as a,y as d,B as c,p as r,o as h,g as l,A as f,z as u,I as p,v as m,D as g,C as b,K as k,i as y,H as w}from"./calfSystem-fe0ebf32.js"
import{c as j}from"./createTable-94e6d4a8.js"
import{e as L}from"./eventHandler5-b489b45c.js"
import{f as R}from"./functionPasses-dfde2ed6.js"
import{h as N}from"./hideElement-2c661b2e.js"
import{p as v}from"./parseDateAsTimestamp-25c526ef.js"
import{s as G}from"./selfIdIs-47818e07.js"
import{t as x}from"./toggleForce-e38cb2b0.js"
import{g as H,s as T}from"./idb-b0de0ac7.js"
import"./dataRows-fe9c44ea.js"
import"./playerName-dca56241.js"
import"./searchPlayerHref-bc71ee04.js"
...
t.push(e),K.checks[t[4]]||(e.className="fshHide"),st(e,'<span class="newGuildLog"></span>'),st(e,`<nobr>${t[2]}</nobr>`),st(e,t[3])}(t),function(t){const e=U.insertRow(-1)
t.push(e),K.checks[t[4]]||(e.className="fshHide")
const s=e.insertCell(-1)
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=K.checks[t.getAttribute("item")]}function ot(){l("input",B).forEach(nt),Z()}function at(t,e){return t[0]-e[0]}function dt(){V&&Q.sort(at),f("Loading complete.",M),K.log=Q.filter(n(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){U=j({id:"fshInjectHere",className:"width_full"}),y(U,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const s=u("fshInjectHere")
r.replaceChild(U,s),e("myGuildLog",1),t()}()}function ct(t){J(t),function(){const t=[]
...
//# sourceMappingURL=newGuildLog-c59f01ed.js.map
