import{c as t}from"./closestTable-e206f233.js"
import{c as n}from"./createSpan-0da61261.js"
import{z as e,h as o,f as s,t as r,B as c,C as a,_ as i,bs as u,ay as f,m,p as l,e as p}from"./calfSystem-fe0ebf32.js"
...
if(n)return y(n)}(e)}return t}function q(t){return function(n,e,s){t(n,e,s),i("lastScavPage",`${u}scavenging&cave_id=${s}&gold=${e}`),c(M(),(v||(v=m(),o(l,v)),c("",v),v))}}function w(){!function(){const t=sendRequest
f(t)&&(sendRequest=q(t))}(),function(){const t=e("multiplier_count")
t&&j(t)}()}export default w
//# sourceMappingURL=scavenging-3ffdb4cd.js.map
