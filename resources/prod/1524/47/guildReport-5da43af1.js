import{o as t,bP as n,b as e,p as o,t as a,ah as r,B as i,ay as s,S as c,bz as u,aI as l,m as p,aY as f,by as d,P as m,h as b,n as g,f as h,a as y,e as M,A as j,i as L,q as x,a4 as $,ad as C,C as I,c as v,a3 as R,R as H,E as N,aG as S,aM as T,y as k}from"./calfSystem-a2fd9017.js"
import{c as E}from"./currentGuildId-871ea013.js"
import{e as w}from"./useItem-4eadd293.js"
import{a as A}from"./queue-975eab6a.js"
import{g as G}from"./getMembrList-be74c9ce.js"
import{b as B}from"./batch-0f132e33.js"
import{e as P}from"./eventHandler5-cfda59d1.js"
import{i as D}from"./isChecked-5c7617f4.js"
import{s as F}from"./selfIdIs-4b2f735e.js"
import{t as W}from"./testRange-c05346fa.js"
import{c as _}from"./createInput-ca1e27eb.js"
import{c as q}from"./createSelect-74d50a3a.js"
import{c as J}from"./createTable-fb7a908d.js"
import{c as Y}from"./createTr-f34d74f0.js"
import{g as z,s as Q}from"./idb-09e8fa3a.js"
import{o as U}from"./onlineDot-20a56643.js"
...
i(`<table><tbody>${f(e).reduce(a(Lt,t,e),"")}</tbody></table>`,ht)}function $t(){const t=Y()
...
yt.replaceChild(n,yt.children[0]),h(yt,"mousedown",a(St,t.myMap)),y(3,B,[[5,3,M(t.myMap),0,a(Rt,n),a(Nt,n)]])}const kt="fsh_potMap",Et={pottab1:!1,pottab2:!1,pottab3:!1,myMap:{},minpoint:12,maxpoint:20}
function wt(t,n){t.myMap[n]||(t.myMap[n]=n)}function At(t,n,e){"SELECT"===e.target.tagName&&(t.myMap[e.target.name]=e.target.value,Q(kt,t),xt(t,n))}function Gt(t,n,e){return n[e]=t?"Ignore":e,n}function Bt(t,n,e){!function(t,n,e){t.myMap=f(n).reduce(a(Gt,e),{})}(t,n,e),Q(kt,t),Tt(t),xt(t,n)}function Pt(t){return/^pottab\d$/.test(t.id)}function Dt(t,n){t[n.id]=n.checked,Q(kt,t)}function Ft(t,n,e){const o=e.target.id,a=W(e.target.value,0,999)
a&&(t[o]=a,Q(kt,t),xt(t,n))}function Wt(n,e,o){h(o,"change",a(At,n,e)),t(o,P(function(t,n){return[[F("fshIgnoreAll"),a(Bt,t,n,!0)],[F("fshReset"),a(Bt,t,n,null)],[Pt,a(Dt,t)]]}(n,e))),h(o,"input",a(Ft,n,e))}function _t(t,n){const e=function(t){return p({id:"potReport",innerHTML:`<input id="pottab1" type="checkbox"${D(t.pottab1)}><label for="pottab1">Composed Potion Inventory</label><input id="pottab2" type="checkbox"${D(t.pottab2)}><label for="pottab2">Mapping</label><input id="pottab3" type="checkbox"${D(t.pottab3)}><label for="pottab3">Thresholds</label>`})}(t),r=p({id:"panels"})
...
x(e,$(n,{})),e.myMap=function(t,n){return f(n).forEach(a(wt,t)),gt(t.myMap)}(e,t),Q(kt,e),_t(e,t)}function Jt(t){o&&z(kt).then(a(qt,t))}let Yt,zt,Qt,Ut,Kt
function Ot(t,n){const e=zt[n]
b(e,t)}function Vt(t){Yt.push(mt(t)),function(t){if(t.endsWith(" (Potion)")){const n=t.slice(0,-9)
Qt[n]=(Qt[n]||0)+1}}(t.previousElementSibling.innerHTML)}function Xt(){B([5,3,Yt,0,Ot,a(Jt,Qt)])}function Zt(){zt=C("#pCC table table tr:not(.fshHide) td:nth-of-type(3n)"),Qt={},Yt=[],B([5,3,zt,0,Vt,Xt])}function tn(t){const n=I(t)
...
B([5,3,t,0,tn])}function en(t){t.children[0].hasAttribute("bgcolor")&&(Kt=T(Ut,t.children[0].children[0])),Kt||(t.className="fshHide")}function on(){if(Ut=H("user"),!Ut)return
if(!N('#pCC table table td[bgcolor="#DAA534"] b').some(S(Ut)))return
const t=C("#pCC table table tr")
B([5,2,t,0,en])}function an(){!k()&&E()&&(!async function(){await G(!1),y(3,nn)}(),y(2,on),y(3,Zt),t(e("table",o)[1],n(ot)))}export default an
//# sourceMappingURL=guildReport-5da43af1.js.map
