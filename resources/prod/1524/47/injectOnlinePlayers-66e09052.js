import{aY as e,t as n,I as t,bB as a,a8 as s,a4 as l,Z as i,au as r,y as o,o as f,f as u,v as c}from"./calfSystem-a2fd9017.js"
import{c as h}from"./currentGuildId-871ea013.js"
import{i as d}from"./intValue-e4ce6bb5.js"
import{a as p,g as v}from"./levelHighlight-c360a2b9.js"
import{n as m}from"./numberIsNaN-2f104aa2.js"
import{l as g,p as y}from"./lvlTests-a0a61e5e.js"
import{l as M}from"./loadDataTables-b1cb127b.js"
import{o as b}from"./onlinePlayersPage-517f6747.js"
import{g as L,s as P}from"./idb-09e8fa3a.js"
...
for(let n=2;n<=G;n+=1)b(n).then(e)}function B(e){$("#fshOutput",_).append(e)}function V(e){B(` ${z+1}`)
const t=c(e),a=$("#pCC input.custominput",t).first()
!function(e,t){const a=t.attr("value")
$('#pCC img[src$="/world/icon_action_view.png',e).parent().parent().parent().each(n(S,a))}(t,a),z+=1,1===z&&A(V,a),z===G&&(P("fsh_onlinePlayers",D),H(D))}function W(e){"fshRefresh"===e.target.id&&($("#fshRefresh",_).hide(),z=0,D={},b(1).then(V),i("lastOnlineCheck",s),B("Parsing online players...")),"fshReset"===e.target.id&&function(e){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",e).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",e).val(r.onlinePlayerMaxLvl),O()}(_)}function Y(){_.html(`<span><b>Online Players</b></span>${function(){const e=t("lastOnlineCheck")
return s-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),L("fsh_onlinePlayers").then(H),f(_[0],W),u(_[0],"keyup",k)}function Z(e){o()||(_=e?$(e):$("#pCC"),M().then(Y))}export default Z
//# sourceMappingURL=injectOnlinePlayers-66e09052.js.map
