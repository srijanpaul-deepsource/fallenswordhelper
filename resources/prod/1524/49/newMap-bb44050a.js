import{c as t,m as e,z as a,A as n,h as r,t as o,i,o as s,aQ as u,aR as l,aS as c,aT as f,Z as d,b as m,f as h,E as p,D as b,S as g,aA as v,I as y,aU as k,C as w,aN as L,a6 as C,aV as D,aW as A,aX as M,aY as V,aZ as S,aG as N,aP as H,B,a_ as G,a3 as T,U as x,v as E,ad as j,a4 as P,a$ as I,b0 as R,P as O,u as F,b1 as _,b2 as q,b3 as Y,b4 as K,aM as z,q as U,a as Q,M as W,b5 as J,b6 as Z,b7 as X,b8 as tt,b9 as et,l as at,ar as nt,$ as rt,as as ot,a8 as it,ba as st,bb as ut,bc as lt,bd as ct,be as ft,bf as dt,bg as mt,bh as ht,bi as pt}from"./calfSystem-2172498b.js"
import{i as bt}from"./insertElementAfter-d7162528.js"
import{t as gt}from"./toggleForce-d61da182.js"
import{c as vt}from"./createSpan-b3281070.js"
import{i as yt}from"./insertTextBeforeEnd-0a52fd64.js"
import{a as kt,r as wt}from"./roundToString-98c640ba.js"
import{a as Lt}from"./addCommas-1f67a5b9.js"
import{d as Ct,q as Dt}from"./quickbuffSuccess-2e12deea.js"
import{p as At}from"./playerName-a5989c6d.js"
import{i as Mt}from"./isArray-be6d57af.js"
import{g as Vt,s as $t}from"./idb-35c610a0.js"
import{c as St}from"./createStyle-9ebe28f9.js"
import{g as Nt}from"./getArrayByClassName-c230ba3d.js"
import{e as Ht}from"./executeAll-779c0127.js"
import{c as Bt}from"./createButton-23c78013.js"
import{e as Gt}from"./eventHandler5-f81b785a.js"
import{i as Tt}from"./insertElementBefore-c7161beb.js"
import{c as xt}from"./createInput-b54e35e9.js"
import{c as Et}from"./createLabel-88a2c766.js"
import{o as jt}from"./openQuickBuffByName-8e50e0f6.js"
import{a as Pt}from"./all-bb953856.js"
import{a as It}from"./allthen-f7cedfa7.js"
import{d as Rt,g as Ot}from"./getGroupStats-0e22cb75.js"
import{g as Ft}from"./getMercStats-deaa8646.js"
import{g as _t}from"./getProfile-8db6fc9e.js"
import{g as qt}from"./getMembrList-351d1812.js"
import{h as Yt}from"./hideElement-3021ab25.js"
import{n as Kt}from"./numberIsNaN-9a364388.js"
import{r as zt}from"./reduceBuffArray-05963b78.js"
import{r as Ut}from"./rnd-1618b1ea.js"
import{h as Qt}from"./hasClasses-d89020ec.js"
import{v as Wt}from"./valueText-c5773d3b.js"
import{g as Jt}from"./guild-8b9b510e.js"
import{g as Zt,a as Xt}from"./getTitanString-719b1e7a.js"
import{p as te}from"./padZ-3a27e144.js"
import{c as ee}from"./createTable-514c5663.js"
import{t as ae}from"./testQuant-55fb1392.js"
import{g as ne}from"./groupViewStats-6b3e492f.js"
import{m as re}from"./myStats-3fea7e4d.js"
import{a as oe}from"./huntingBuffs-4c2b64f0.js"
import{b as ie}from"./simpleCheckbox-b36336fb.js"
import{b as se}from"./bitwiseAnd-e091ed55.js"
import{s as ue}from"./shouldBeArray-45b664e6.js"
...
Be.className=function(t){return Ee[t]||"fshGreen"}(a),n(a,Ge)}function Pe(t,e,a){e||a?je(t,e):Be&&gt(Be,!0)}function Ie(t){return 0===t.type}function Re(t){return vt({textContent:t})}let Oe,Fe,_e,qe,Ye,Ke,ze,Ue,Qe,We
function Je(t,e){Oe?gt(Oe,!1):function(t,e){Oe=t.children[5],n("Teleport Cooldown: ",Oe),Fe=Re(e.toString()),r(Oe,Fe)}(t,e)}function Ze(){const t=Math.max(Math.ceil((_e-Date.now())/1e3),0)
n(t,Fe),t>0&&setTimeout(Ze,500)}function Xe(t,e){e?Je(t,e):Oe&&gt(Oe,!0)}function ta(){qe=Ne("Death Dealer"),Ye=Ne("Doubler"),Ke=Ne("Counter Attack"),ze=Ne("Summon Shield Imp"),Ue=function(){const t=GameData.player().teleportCooldown
...
const t=ye([qe,Ye,Ke,ze,Ue,Qe])
t&&(Pe(t,ze,qe),$e(t,qe,Qe,We),Ae(t,qe,We),we(t,Ke),Ce(t,Ye),Xe(t,Ue))}function aa(t,e){var a
a=e.player.teleportCooldown,Fe&&(_e=Date.now()+1e3*a,Ze())}const na=["NORMAL","CHAMPION","ELITE","SUPER ELITE","TITAN","LEGENDARY"]
let ra=!1
...
return $a=Re(Ea(GameData.realm().minlevel)),r(t,$a),t}()),r(a,function(){const t=e({textContent:"Your Lvl: "})
return Sa=Re(Ea(GameData.player().level)),r(t,Sa),t}()),r(t,a)}function Pa(t,e,a){const n=Bt({className:`fshCurveEle fshCurveBtn fshPoint tip-static ${t}`,dataset:{tipped:e}})
...
xa=Ma({prefVal:a,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:e})}(Va)}const Ra=[[t=>t===Ta,function(){d("playNewMessageSound",!y("playNewMessageSound"))}],[t=>t===xa,function(){t.huntingMode=!t.huntingMode,d("huntingMode",t.huntingMode)}]],Oa=[[t=>t===Na,function(t){V(t),GameData.doAction(12,401,{},0)}],[t=>t===Ha,function(){jt(At())}],[t=>t===Ba,function(){window.open(`${S+N}map`,"fsMap")}],[t=>t===Ga,function(){const t=GameData.realm()
window.open(`${H}realms${N}view&realm_id=${t.id}`,"mapUfsg")}]]
function Fa(){Va||(Va=e({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),Ia(),s(Va,Gt(Oa)),h(Va,"change",Gt(Ra)),Tt(Va,a("worldCoord")))}function _a(t,e){$a&&e.b.minlevel&&(Da(),n(e.b.minlevel,$a))}function qa(t,e){Sa&&n(e.b,Sa)}function Ya(t){return!t||!t.response||!t.response.data}let Ka,za,Ua,Qa,Wa,Ja,Za,Xa,tn,en,an,nn,rn,on,sn,un,ln,cn,fn,dn,mn,hn,pn,bn,gn,vn,yn,kn,wn,Ln,Cn,Dn,An,Mn,Vn
function $n(t){return t.player_name}function Sn(t){!function(t){Qa=t.defenders.map($n)}(t),Ka?B("",Ka):Ka=e({className:"body"}),function(t){za=e({className:"fshFloatLeft fshRelicLeftDiv"}),r(Ka,za),t.is_owner&&r(za,Rt(Qa)),Ua=Bt({className:"custombutton",textContent:"Fetch Stats"}),r(za,Ua)}(t)
const n=a("dialog-relic")
r(n,Ka)}const Nn=[t=>"lastUpdate"!==t,t=>!Qa.includes(t),t=>Wa[t].last_login,t=>Number(Wa[t].last_login)<Ja,t=>Number(Wa[t].last_login)>Za,t=>Wa[t].level<400||Wa[t].level>421,t=>Wa[t].level<441||Wa[t].level>450]
function Hn(t,e){return e(t)}function Bn(t){return Nn.every(o(Hn,t))}function Gn(t){return`<a href="${T}${Wa[t].id}">${t}</a>`}function Tn(t){Wa=t,Ja=x-120,Za=x-604800
const e=G(Wa).filter(Bn).map(Gn)
i(Ka,`<div class="fshFloatLeft fshRelicLowDiv"><table class="relicT"><thead><tr><th>${e.length.toString()} Offline guild members not at relic:</th></tr></thead><tbody><tr><td>${e.join(" ")}</td></tr></tbody></table></div>`)}function xn(t){Yt(Ua)
...
r(Ka,o),Xa=a("relicCount"),tn=a("LDPercentage"),en=a("LDCloaked"),an=a("attackValue"),nn=a("attackValueBuffed"),rn=a("defenseValue"),on=a("defenseValueBuffed"),sn=a("armorValue"),un=a("armorValueBuffed"),ln=a("damageValue"),cn=a("damageValueBuffed"),fn=a("hpValue"),dn=a("hpValueBuffed"),mn=a("defendersCloaked"),hn=a("defendersProcessed")
...
return function(t,e){In.forEach(o(Rn,t,e))}(a,t),function(t,e){On.forEach(o(Fn,t,e))}(a,e),a.superEliteSlayerMultiplier=kt(.002*a.superEliteSlayerLevel,2),Kt(a.armorValue)&&function(t){t.attackValue=Pn(t.attackBonus,t.levelValue),t.defenseValue=Pn(t.defenseBonus,t.levelValue),t.armorValue=Pn(t.armorBonus,t.levelValue),t.damageValue=Pn(t.damageBonus,t.levelValue),t.hpValue=t.hpBonus}(a),a}let qn,Yn,Kn,zn,Un,Qn,Wn,Jn,Zn,Xn,tr,er,ar,nr
function rr(t){return Math.round(t*En)}function or(){Me(qn,an),Me(Kn,rn),Me(zn,sn),Me(Un,ln),Me(Wn,fn),n(Jn,mn),Zn+=1,n(Zn,hn)}function ir(t){const e=function(t){return Math.ceil(tr.attack*(.0025*P(t["Nightmare Visage"],0)))}(t)
tr.attack-=e,function(){const t=Math.ceil(tr.attack*Xn.flinchLevel*.001)
Me(tr.attack-t,vn)}()
...
!function(t){Me(tr.hp+t,Mn)}(n),function(t,e){const a=Math.ceil((tr.hp+e)*P(t["Chi Strike"],0)*.001),n=Math.ceil(tr.damage*Xn.terrorizeLevel*.001)
...
ir(t),function(t){const e=Math.ceil(Yn*P(t.Flinch,0)*.001)
Me(Yn-e,nn)}(t),function(t){const e=Math.ceil(Qn*P(t.Terrorize,0)*.001)
Me(Qn-e,cn)}(t),n("Done.",Vn)}function ur(){n("Processing defending guild stats ... ",Vn),qn+=rr(Xn.attackValue),Kn+=rr(Xn.defenseValue),zn+=rr(Xn.armorValue),Un+=rr(Xn.damageValue),Wn+=rr(Xn.hpValue),or()
const t=Math.ceil(qn*(.0025*Xn.nightmareVisageLevel))
!function(t){Yn=qn-t,Me(Yn,nn)}(t)
const e=Math.ceil(Kn*(1+.001*Xn.constitutionLevel))
!function(t,e){const a=e+t
Me(a,on),Me(Math.ceil(.55*a),pn),Me(Math.ceil(.65*a),bn)}(t,e),Me(zn+Math.floor(zn*Xn.sanctuaryLevel*.001),un)
const a=Wn+function(t){return Math.ceil(t*Xn.fortitudeLevel*.001)}(e)
Me(a,dn),function(t){Qn=Un+Math.ceil(t*Xn.chiStrikeLevel*.001),Me(Qn)}(a),0!==Xn.cloakLevel&&n("Yes",en),GameData.player().hasGroup&&tr?sr():n("Done.",Vn)}function lr(t){const e=_n(t)
qn+=Math.round(e.attackValue*I),Kn+=Math.round(e.defenseValue*I),zn+=Math.round(e.armorValue*I),Un+=Math.round(e.damageValue*I),Wn+=Math.round(e.hpValue*I),0!==e.cloakLevel&&(Jn+=1),or()}function cr(t){Xn=_n(t)}function fr(t){tr=t}function dr(t){er=t}function mr(t){n(t.message,Vn)}function hr(t){const e=E(t),a=b('#pCC a[href*="confirmDisband"]',e)
if(!a)return
const n=function(t){const e=t.previousElementSibling.href,a=[Ot(e).then(fr)]
...
const{target:a}=e,n=a.parentNode.parentNode.parentNode;(function(t,e){return Qt(Ir,t)&&!at("fshTip",t)&&at("creature",e)})(a,n)&&Fr(a,n)}function qr(){return Jt({subcmd:"scouttower"})}function Yr(t,e){const a=t.insertCell(-1)
return[a.colSpan]=e,e[2]&&(a.className="header"),r(a,e[1]),a}function Kr(t,e,a){const n=t.insertRow(-1)
return a&&(n.className="fshBlue"),function(t,e){e.forEach(o(Yr,t))}(n,e),n}function zr(t,e){Kr(t,e[0],e[1])}function Ur(t,e){e.forEach(o(zr,t))}let Qr,Wr,Jr,Zr,Xr,to,eo,ao,no,ro,oo,io,so,uo,lo,co,fo,mo,ho,po,bo,go,vo,yo,ko,wo,Lo,Co
function Do(){Wr=Re("Current"),Jr=Re("Kills"),Zr=Re("Member"),Xr=Re("% of Total"),to=Re("Status"),eo=Re("Titan HP"),ao=Re("Total"),no=Re("Your Guild")}function Ao(){for(;fo.rows.length>7;)fo.deleteRow(7)}function Mo(){const t=vt()
...
mo=e({className:"fshActionBox titanInfo"}),ro=vt(),oo=vt(),io=vt(),so=vt(),uo=vt(),lo=vt(),co=vt(),fo=ee({className:"fshCenter"}),Do(),Ur(fo,[[[[2,eo,!0],[4,no,!0]]],[[[2,Mo()],[4,io]]],[[[2,Wr,!0],[4,Vo(so)]],!0],[[[2,ao,!0],[4,Vo(uo)]],!0],[[[2,to,!0],[4,lo]],!0],[[[6,co]]],[[[2,Zr,!0],[2,Jr,!0],[2,Xr,!0]]]]),r(mo,fo),r(t,mo)}}function Ho(t){return t<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(t){const e=new Date(it+1e3*t)
return`${te(e.getHours())}:${te(e.getMinutes())} ${te(e.getDate())}/${ot[e.getMonth()]}/${e.getFullYear()}`}(t)}</span>`}function Bo(t){return wt(Zt(t.max_hp-t.current_hp,t.kills),2)}function Go(t){return wt(100*t.kills/t.max_hp,2)}function To(t){[[t.current_hp,ro],[t.max_hp,oo],[t.kills,io],[Bo(t),so],[Go(t),uo]].forEach((([t,e])=>{n(t,e)})),B(function(t){return Xt(t.kills,t.max_hp,t.current_hp)}(t),lo),B(Ho(t.cooldown),co)}function xo(t,e){return[[[2,Re(e.player.name)],[2,Re(e.kills.toString())],[2,Re(`${wt(100*e.kills/t.kills,2)}%`)]]]}function Eo(t){return t.realm&&t.creature.base_id===ho&&t.realm===Qr}function jo(t){const e=t.find(Eo)
e&&(To(e),function(t){if(Ao(),!t.contributors)return
const e=t.contributors.map(o(xo,t))
Ur(fo,e)}(e))}function Po(e){return t.showTitanInfo&&Mt(e)&&e.some(So)}function Io(t,e){(function(t){return t&&t.s&&Mt(t.r)})(e)&&(jo(e.r),Po(GameData.realm().dynamic)?po=window.setTimeout(t,3e4):$o())}function Ro(){rt(qr).then(o(Io,Ro))}function Oo(t){po&&(window.clearTimeout(po),po=null),Po(t)?(No(),Ro()):$o()}function Fo(t){var e
t.dynamic&&(e=t.name,Qr=e,Oo(t.dynamic))}function _o(t,e){(function(t){return t.realm&&t.realm.name})(e)&&Fo(e.realm)}function qo(t){const e=t.response.response,a=t.response.msg
let n
...
i(Lo,`${n}<br>`)}function Yo(){GameData.doAction(14,3,{id:bo.id,item_id:bo.itemId},0),vo.close()}function Ko(){const t=ae(ko.value)
if(!t)return
const e=[]
for(let a=1;a<t;a+=1)e.push(Lr({a:14,d:0,id:bo.id,item_id:bo.itemId}).then(qo))
It(e,Yo)}function zo(){yo?n("",Lo):(yo=e({className:"fshClear",textContent:"Select how many to quick-buy:"}),ko=xt({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),r(yo,ko),wo=Bt({textContent:"Quick-buy"}),s(wo,Ko),r(yo,wo),Lo=e(),r(yo,Lo),r(go,yo))}function Uo(t,e){bo=e,go=go||a("shopDialogConfirm"),go&&(vo=vo||$(go).data("hcsWorldDialogShopConfirm"),vo&&zo())}function Qo(t){Co[t.name]?Co[t.name].seen&&(Co[t.name].seen+=1):(Co[t.name]={seen:1},function(t,e){e.creature_class=t.creature_class,e.image_id=t.image_id,e.level=Number(t.level),e.type=t.type}(t,Co[t.name]))}function Wo(t,e,a){return e?t(e,a):a}function Jo(t,e){const a=t||{}
return a.min=Wo(Math.min,a.min,e),a.max=Wo(Math.max,a.max,e),a}const Zo=["attack","armor","damage","defense","hp"]
function Xo(t,e,a){const n=Jo(e[a],Number(t[a]));(function(t,e){return!t||t.min!==e.min||t.max!==e.max})(e[a],n)&&(e[a]=n)}function ti(t,e){t[e.name]=Jo(t[e.name],Number(e.value))}function ei(t){Co||(Co={}),Qo(t),function(t,e){Zo.forEach(o(Xo,t,e))}(t,Co[t.name]),function(t,e){(function(t){return t.enhancements&&t.enhancements.length>0})(t)&&(e.enhancements=e.enhancements||{},t.enhancements.forEach(o(ti,e.enhancements)))}(t,Co[t.name]),$t("fsh_monsterLog",Co)}function ai(t){Co=t||{}}const ni=[]
function ri(e){var a
Ya(e)||(g("NewMap","MonsterLog"),a=e.response.data,t.showMonsterLog&&ei(a))}function oi(t,e){return t.id===e.id}function ii(t,e){6!==t.type||function(t){if(ni.find(o(oi,t.data)))return!0
...
const a=o(fs,e)
$.subscribe(l,a),t.showBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(e),Ei=y("hidePlayerActions"),$.subscribe(D,ns),ns()},function(){_(),q&&wr()},function(){$.subscribe(ct,Xi)},function(){Ds.forEach(As)},function(){y("enableCreatureColoring")&&r(document.body,St("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(D,ka),ka(),function(){const t=GameData.doAction
GameData.doAction=Ca(t)}()},function(){Vt("fsh_monsterLog").then(ai),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",si),si()},function(){$.subscribe(mt,Ms)},function(){y("keepLogs")&&Vt("fsh_combatLog").then(ga)},function(){window.initialGameData&&_o(0,window.initialGameData),$.subscribe(`${st} ${ut}`,_o)},function(){$.subscribe(lt,Uo)},function(){$.subscribe(R,vr)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){V("#mapTooltip")},function(){Fa(),$.subscribe(A,_a),$.subscribe(M,qa)},function(){ea(),$.subscribe(`${l} ${c}`,ea),$.subscribe(f,aa)},function(){s(a("buffList"),Vs)},function(){h(a("actionList"),"mouseover",_r)},function(){const t=m("body")[0]
h(t,"keydown",ua),h(t,"keyup",la)}]
function Ss(){Ht($s)}export default Ss
//# sourceMappingURL=newMap-bb44050a.js.map
