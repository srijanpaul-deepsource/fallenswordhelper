import{B as e,V as t,w as o,D as s,t as n,H as a,f as r,C as c,i,Z as l,x as f,by as d}from"./calfSystem-0708a9bb.js"
import{g as m,d as u,a as p,i as h}from"./injectStoreItems-54c9eb94.js"
import{S as b,i as j,s as g,e as v,t as x,a as y,b as _,c as C,d as k,f as E,g as D,h as I,l as S,n as N,j as w,r as $,k as A,m as M,o as T}from"./index-bebd168e.js"
import{c as B}from"./chunk-c6dcf4eb.js"
import{c as J}from"./closestTable-9ab270bd.js"
import{c as V}from"./closestTr-33960a32.js"
import{e as F}from"./errorDialog-998604da.js"
import{b as H}from"./simpleCheckbox-57c00d72.js"
import"./daAjaxSendItemsToRecipient-758f891f.js"
...
r=E(),c=v("span"),c.textContent=" ",i=E(),l=v("button"),l.textContent="Move",D(a,"class","customselect"),void 0===e[1]&&M((()=>e[5].call(a))),D(l,"class","custombutton"),D(l,"type","button"),D(o,"class","fshCenter")},m(m,p){y(m,t,p),_(t,o),_(o,s),_(o,n),_(o,a)
...
return o.$$set=e=>{"folders"in e&&n(0,c=e.folders)},[c,r,i,t=>e(t.parentNode.parentNode),function(){t("dropitems","Move to Folder"),a("move",r)},function(){r=T(this),n(1,r),n(2,i),n(0,c)}]}class z extends b{constructor(e){super(),j(this,e,q,Z,g,{folders:0})}}function G(e,t){return function(e,t){return o({cmd:"profile",subcmd:"sendtofolder",folder_id:e,folderItem:t})}(e,t)}function K(){return s('[name="removeIndex[]"]:checked')}function L(e){const t=V(e)
...
//# sourceMappingURL=injectProfileDropItems-e57a9ac3.js.map
