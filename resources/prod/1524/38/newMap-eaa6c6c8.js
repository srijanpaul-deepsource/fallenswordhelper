import{c as e,m as t,z as a,A as n,h as r,t as o,i,o as s,aC as u,aD as l,aE as c,aF as f,_ as d,b as m,f as h,E as p,D as b,W as g,ak as v,I as y,aG as k,C as w,ay as L,aH as C,aI as D,aJ as A,aK as M,aL as V,aM as S,aq as N,aB as H,B,aN as G,a4 as x,U as T,v as E,ac as j,a5 as P,aO as I,aP as O,Q as R,u as F,aQ as _,aR as q,aS as K,aT as Y,ax as z,q as U,a as Q,K as W,aU as J,aV as X,aW as Z,aX as ee,aY as te,l as ae,N as ne,$ as re,au as oe,a7 as ie,aZ as se,a_ as ue,a$ as le,b0 as ce,b1 as fe,b2 as de,b3 as me,b4 as he,b5 as pe}from"./calfSystem-7a1cce43.js"
import{i as be}from"./insertElementAfter-cc5370ba.js"
import{t as ge}from"./toggleForce-6fbd75e0.js"
import{c as ve}from"./createSpan-e8d911bd.js"
import{i as ye}from"./insertTextBeforeEnd-b2037954.js"
import{a as ke,r as we}from"./roundToString-a20f2465.js"
import{a as Le}from"./addCommas-cec84c43.js"
import{d as Ce,q as De}from"./quickbuffSuccess-ac0de792.js"
import{p as Ae}from"./playerName-1f8ebec9.js"
import{i as Me}from"./isArray-6eab9c89.js"
import{g as Ve,s as $e}from"./idb-c572d898.js"
import{c as Se}from"./createStyle-643076c0.js"
import{g as Ne}from"./getArrayByClassName-0cc51c94.js"
import{e as He}from"./executeAll-13b3b7cf.js"
import{c as Be}from"./createButton-4963e07d.js"
import{e as Ge}from"./eventHandler5-4001c34b.js"
import{i as xe}from"./insertElementBefore-71272774.js"
import{c as Te}from"./createInput-76cdb39b.js"
import{c as Ee}from"./createLabel-314ee2b4.js"
import{o as je}from"./openQuickBuffByName-18faab75.js"
import{a as Pe}from"./all-edb79f43.js"
import{a as Ie}from"./allthen-8480e63e.js"
import{d as Oe,g as Re}from"./getGroupStats-8b06f201.js"
import{g as Fe}from"./getMercStats-c85b3b96.js"
import{g as _e}from"./getProfile-f62f3400.js"
import{g as qe}from"./getMembrList-bfb04e21.js"
import{h as Ke}from"./hideElement-9b8f5190.js"
import{n as Ye}from"./numberIsNaN-30cde299.js"
import{r as ze}from"./reduceBuffArray-70400887.js"
import{r as Ue}from"./rnd-e8cb70da.js"
import{h as Qe}from"./hasClasses-425b3e86.js"
import{v as We}from"./valueText-3ccfe58d.js"
import{g as Je}from"./guild-6cfdbf69.js"
import{g as Xe,a as Ze}from"./getTitanString-420472ae.js"
import{p as et}from"./padZ-8b68b081.js"
import{c as tt}from"./createTable-cbb1ed54.js"
import{t as at}from"./testQuant-1b52803b.js"
import{g as nt}from"./groupViewStats-661b2e52.js"
import{m as rt}from"./myStats-662030be.js"
import{a as ot}from"./huntingBuffs-0c7108db.js"
import{b as it}from"./simpleCheckbox-65181dd3.js"
import{b as st}from"./bitwiseAnd-7bfebdac.js"
import{s as ut}from"./shouldBeArray-e4f0e2a6.js"
...
let Bt,Gt
function xt(e){De(e)&&GameData.fetch(u)}function Tt(){Nt("Summon Shield Imp")||Ce([Ae()],[55]).then(xt)}const Et=["imp-0","imp-1","imp-1"]
...
return r(a,i),r(e.worldName,a),n}let Va,$a,Sa,Na,Ha,Ba,Ga,xa,Ta
...
xa=Ma({prefVal:t,checkId:"fshSoundCheck",onClass:"soundOn",onTip:"Turn Off Sound when you have a new log message",offClass:"soundOff",offTip:"Turn On Sound when you have a new log message",worldName:e})}}(Va),function(t){const a=e.huntingMode
Ta=Ma({prefVal:a,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:t})}(Va)}const Oa=[[e=>e===xa,function(){d("playNewMessageSound",!y("playNewMessageSound"))}],[e=>e===Ta,function(){e.huntingMode=!e.huntingMode,d("huntingMode",e.huntingMode)}]],Ra=[[e=>e===Na,function(e){V(e),GameData.doAction(12,401,{},0)}],[e=>e===Ha,function(){je(Ae())}],[e=>e===Ba,function(){window.open(`${S+N}map`,"fsMap")}],[e=>e===Ga,function(){const e=GameData.realm()
window.open(`${H}realms${N}view&realm_id=${e.id}`,"mapUfsg")}]]
function Fa(){Va||(Va=t({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),Ia(),s(Va,Ge(Ra)),h(Va,"change",Ge(Oa)),xe(Va,a("worldCoord")))}function _a(e,t){$a&&t.b.minlevel&&(Da(),n(t.b.minlevel,$a))}function qa(e,t){Sa&&n(t.b,Sa)}function Ka(e){return!e||!e.response||!e.response.data}let Ya,za,Ua,Qa,Wa,Ja,Xa,Za,en,tn,an,nn,rn,on,sn,un,ln,cn,fn,dn,mn,hn,pn,bn,gn,vn,yn,kn,wn,Ln,Cn,Dn,An,Mn,Vn
...
return GameData.player().hasGroup&&e.push(F({cmd:"guild",subcmd:"groups"}).then(hr)),e=e.concat(Qa.map(pr)),e}function gr(){Tn(ar),qn=0,Yn=0,zn=0,Un=0,Wn=0,Jn=0,Xn=0
const e=br()
...
return`${et(t.getHours())}:${et(t.getMinutes())} ${et(t.getDate())}/${oe[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function Bo(e){return we(Xe(e.max_hp-e.current_hp,e.kills),2)}function Go(e){return we(100*e.kills/e.max_hp,2)}function xo(e){[[e.current_hp,ro],[e.max_hp,oo],[e.kills,io],[Bo(e),so],[Go(e),uo]].forEach((([e,t])=>{n(e,t)})),B(function(e){return Ze(e.kills,e.max_hp,e.current_hp)}(e),lo),B(Ho(e.cooldown),co)}function To(e,t){return[[[2,Ot(t.player.name)],[2,Ot(t.kills.toString())],[2,Ot(`${we(100*t.kills/e.kills,2)}%`)]]]}function Eo(e){return e.realm&&e.creature.base_id===ho&&e.realm===Qr}function jo(e){const t=e.find(Eo)
t&&(xo(t),function(e){if(Ao(),!e.contributors)return
const t=e.contributors.map(o(To,e))
...
Me(t)&&([xi,Ti]=t)}function ts(t){"enabledHuntingMode"===t.target.name&&(e.enabledHuntingMode=t.target.value,d("enabledHuntingMode",e.enabledHuntingMode),es(),GameData.fetch(u))}function as(e){const t=W("verbs",e)
...
return xe(e,i),o}function ss(e,t){return e[t.name]=!0,e}function us(e,t,a){return e[a.trim()]||t.push(a),t}function ls(e){B("",e)}function cs(e,t){const a=t.b.reduce(ss,{}),n=xi.reduce(o(us,a),[])
n.length>0?function(e,t){B(`You are missing some ${Ti} hunting buffs<br>(${t.join(", ")})`,e)}(e,n):ls(e)}function fs(t,a,n){xi&&function(t,a,n){e.showBuffs?cs(t,n):ls(t)}(t,0,n)}const ds=[{generalVariable:1.1053,hpVariable:1.1},{generalVariable:1.1,hpVariable:1.053},{generalVariable:1.053,hpVariable:1},{generalVariable:1.1053,hpVariable:1}]
function ms(){var t
...
//# sourceMappingURL=newMap-eaa6c6c8.js.map
