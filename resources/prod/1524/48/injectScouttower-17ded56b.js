import{c as t}from"./createAnchor-e05d2ad3.js"
import{d as n}from"./dataRows-b45e1fd7.js"
import{c as e}from"./createTBody-54748321.js"
import{c as o}from"./createTable-0c2a35a9.js"
import{h as s,i as r,e as a,a8 as c,ar as l,o as i,l as f,aO as u,C as d,y as m,b as h,p,d as b,t as T,aP as g,B as j}from"./calfSystem-85fa6364.js"
import{g as w,a as C}from"./getTitanString-e6d381cf.js"
import{g as N}from"./getTitle-0449c122.js"
import{o as $}from"./openQuickBuffByName-fd250012.js"
import{p as B}from"./parseDateAsTimestamp-b71ec36f.js"
import{r as S}from"./roundToString-a22b7b5d.js"
import{g as x,s as E}from"./idb-160add45.js"
...
return s(n,c),r(c,function(t){return a(t).map(_).filter(y).sort(k).map(v).join("")}(t)),n}function R(t){return d(t.cells[0].children[0].children[0])}function A(t){const{target:e}=t
...
var o,s,a
r(t.cells[3],(o=Number(d(t.cells[3])),s=Number(e[0]),a=Number(e[1]),`<br><span class="fshBlue"> (${S(w(a-s,o),2)}% Current <br>${S(100*o/a,2)}% Total<br>${C(o,a,s)})`))}function U(n,e){!function(t){const n=d(t.cells[2]);-1===n.indexOf("-")&&Q(t,n)}(e),function(t,n){const e=M(n).replace(" (Titan)","")
...
//# sourceMappingURL=injectScouttower-17ded56b.js.map
