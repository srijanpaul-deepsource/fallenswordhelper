import{i as n}from"./interceptSubmit-ed906294.js"
import{S as t,i as e,s as r,h as s,e as a,a as c,u as o,n as i,d as u,b as d,c as l,f,g as p,l as m,r as h}from"./index-c31cc1d2.js"
import{S as g,a5 as b,x as k,q as w,v as L,a6 as v,u as y,$ as _,I as x,D as C,A as O,B as j,a7 as P,a8 as S}from"./calfSystem-365d90f3.js"
...
return s(i=n[1],m),{c(){t=d("tr"),e=d("td"),e.innerHTML='<span data-tooltip="Ticking this box opts you in to the PVP Ladder, unticking it will remove you from the PVP Ladder." class="svelte-1quw1g">PvP Ladder Opt-in:</span>',r=l(),a=d("td"),m.block.c(),f(e,"class","svelte-1quw1g"),f(a,"class","svelte-1quw1g")},m(n,s){c(n,t,s),p(t,e),p(t,r),p(t,a),m.block.m(a,m.anchor=null),m.mount=()=>a,m.anchor=null},p(t,e){n=t,m.ctx=n,2&e&&i!==(i=n[1])&&s(i,m)||o(m,n,e)},d(n){n&&u(t),m.block.d(),m.token=null,m=null}}}function $(n){return{c:i,m:i,p:i,d:i}}function D(n){let t,e,r
return{c(){t=d("input"),f(t,"type","checkbox")},m(s,a){c(s,t,a),t.checked=n[0],e||(r=[m(t,"change",n[6]),m(t,"click",n[3])],e=!0)},p(n,e){1&e&&(t.checked=n[0])},d(n){n&&u(t),e=!1,h(r)}}}function E(n){let t
return{c(){t=d("div"),t.innerHTML='<span class="fshSpinner fshSpinner12 svelte-1quw1g"></span>',f(t,"class","svelte-1quw1g")},m(n,e){c(n,t,e)},p:i,d(n){n&&u(t)}}}function H(n){return{c:i,m:i,p:i,d:i}}function A(n){let t,e={ctx:n,current:null,token:null,hasCatch:!1,pending:H,then:M,catch:T,value:7}
...
//# sourceMappingURL=ladder-5a17ece4.js.map
