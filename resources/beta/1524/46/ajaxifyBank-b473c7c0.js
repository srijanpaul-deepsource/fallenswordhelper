import{j as t,s as n,t as e,u as o,v as a,d as i}from"./calfSystem-cbf77dd7.js"
const s="#pCC b"
function p(t,n){return $("#pH #statbar-gold-tooltip-general dd",t).eq(n).text()}function d(t,n,e){return $(s,t).slice(n).eq(e).text()}function u(t,n,o){var a
!function(t){const n=$("#pCC #info-msg")
0===n.length?$("#pCC").prepend(t.closest(i)):n.closest(i).replaceWith(t.closest(i))}(o),function(t){$("#pH #statbar-gold").text($("#pH #statbar-gold",t).text()),$("#pH #statbar-gold-tooltip-general dd").text(e(p,t))}(n),function(t,n){$(s).slice(n).text(e(d,t,n))}(n,t.balPos),a=t.depoPos,"0"===$(s).eq(a).text()&&$('#pCC input[value="Deposit"]').prop("disabled",!0),function(t,n){"1"!==t.data.amount?$("#pCC #deposit_amount").val($("#pCC #deposit_amount",n).val()):$("#pCC #deposit_amount").val("1")}(t,n),$("#pCC #withdraw_amount").val(t.initWithdraw)}function c(t,n){const e=a(n),o=$("#pCC #info-msg",e)
0!==o.length&&u(t,e,o)}function l(t){o(t.data).then(e(c,t))}function r(t,n){n.preventDefault()
...
//# sourceMappingURL=ajaxifyBank-b473c7c0.js.map
