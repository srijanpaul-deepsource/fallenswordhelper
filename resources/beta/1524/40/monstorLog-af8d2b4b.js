...
import{q as s,av as e,aV as n,e as a,aP as r,c as o,j as i,p as c,B as f,z as l,o as h,t as d,l as p}from"./calfSystem-ab393688.js"
import{d as u}from"./doSortParams-95b7a424.js"
import{p as m,s as g,a as y}from"./stringSort-cf993953.js"
import{g as C,s as b}from"./idb-4a088c10.js"
...
return s+=a(t).map(k).join("<br>"),`${s}</span>`}return'<span class="fshGrey">**Missing**</span>'}function v(n,a){return s(n[a],{name:a,image:(r=n[a].image_id,`<img class="tip-static" src="${e}creatures/${r}.png" data-tipped="<img src='${e}creatures/${r}.png' width=200 height=200>" width=40 height=40>`),level:t(n[a].level),attack:$(n[a].attack),defense:$(n[a].defense),armor:$(n[a].armor),damage:$(n[a].damage),hp:$(n[a].hp),enhancements:j(n[a].enhancements)})
var r}function L(t){return"string"==typeof t?parseInt(t.replace(/,|#/g,""),10):t}function w(t,s){if(function(t){return!r(t.type)&&t.type>8}(t))return 1
