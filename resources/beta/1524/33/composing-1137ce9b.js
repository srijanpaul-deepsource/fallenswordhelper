import{r as e,A as t,t as n,ak as s,aa as o,Z as a,ar as i,C as c,m as r,P as l,V as m,i as p,as as u,D as f,h as d,o as g,p as h,z as b,c as v,at as C,B as S,a5 as k,j as E,H as j,y as N,J as x}from"./calfSystem-c91a5c89.js"
import{r as y,g as A}from"./rnd-1c8c3b81.js"
import{p as $,s as B}from"./pubsub-cee1f4f0.js"
import{c as L}from"./createInput-a2c87173.js"
import{c as q}from"./createTable-443d89cd.js"
import{g as I}from"./getArrayByClassName-23f3f49c.js"
import{i as F}from"./insertElementAfter-829ab10f.js"
import{i as P}from"./insertHtmlAfterEnd-3d170c1c.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],L({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function V(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function Z(e){return[e.value,e.text]}function G(e,t,s){const o=function(e,t,s){const o=q({id:"fshFastCompose"})
return D(o,s),e.reduce(n(V,t,s),o)}(f("#composing-template-multi option").map(Z),t,s)
d(e,o),g(h,M),B("quickcreate",n(J,o))}function K(e){m("composing","FastCompose"),p(e,"<br>")
...
0===t?W(!0):(W(!1),a(C,t))}(),f("input[id^=create-]:not(#create-multi)",h).forEach(X),g(h,Y),function(){if(j("moveComposingButtons")){const e=N("composing-error-dialog").previousElementSibling
...
//# sourceMappingURL=composing-1137ce9b.js.map
