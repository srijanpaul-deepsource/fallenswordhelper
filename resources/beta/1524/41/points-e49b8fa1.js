import{E as n,C as e,z as t,B as a,t as s,a8 as i,a9 as l,_ as r,f as o,h as f,A as c,S as m}from"./calfSystem-587dd8d3.js"
import{p as u}from"./parseGoldUpgrades-f78ff20a.js"
import{c as d}from"./createSpan-f508c88b.js"
...
let l
t*i<=S?(l=t*s,a.className="fshBlue"):(l=Math.floor(S/i)*s,a.className="fshRed"),c(`(+${l} stamina)`,a)}function y(n,e,t){const{target:a}=t,s=Number(a.value),i=function(n,e){if(g[n]||(g[n]={}),!g[n].span){const t=d()
...
//# sourceMappingURL=points-e49b8fa1.js.map
