import{c as e,m as t,z as a,A as n,h as r,t as o,i,o as s,aQ as u,aR as l,aS as c,aT as f,Z as d,b as m,f as h,E as p,D as b,S as g,aA as v,I as y,aU as k,C as w,aN as L,a6 as C,aV as D,aW as A,aX as M,aY as V,aZ as S,aG as N,aP as H,B,a_ as G,a3 as T,U as x,v as E,ad as j,a4 as P,a$ as I,b0 as R,P as O,u as F,b1 as _,b2 as q,b3 as Y,b4 as K,aM as z,q as U,a as Q,M as W,b5 as J,b6 as Z,b7 as X,b8 as ee,b9 as te,l as ae,ar as ne,$ as re,as as oe,a8 as ie,ba as se,bb as ue,bc as le,bd as ce,be as fe,bf as de,bg as me,bh as he,bi as pe}from"./calfSystem-db2edbef.js"
import{i as be}from"./insertElementAfter-41e869ed.js"
import{t as ge}from"./toggleForce-41b0f4ee.js"
import{c as ve}from"./createSpan-8ddb7122.js"
import{i as ye}from"./insertTextBeforeEnd-76479b28.js"
import{a as ke,r as we}from"./roundToString-042f58fd.js"
import{a as Le}from"./addCommas-27b35f1c.js"
import{d as Ce,q as De}from"./quickbuffSuccess-9f0abfda.js"
import{p as Ae}from"./playerName-70d3d303.js"
import{i as Me}from"./isArray-fb536e29.js"
import{g as Ve,s as $e}from"./idb-937dea46.js"
import{c as Se}from"./createStyle-405c1e12.js"
import{g as Ne}from"./getArrayByClassName-e5960a90.js"
import{e as He}from"./executeAll-9ecb4cd8.js"
import{c as Be}from"./createButton-7e963da8.js"
import{e as Ge}from"./eventHandler5-9df31290.js"
import{i as Te}from"./insertElementBefore-165ce171.js"
import{c as xe}from"./createInput-93c1d447.js"
import{c as Ee}from"./createLabel-213b60f2.js"
import{o as je}from"./openQuickBuffByName-76c48ffd.js"
import{a as Pe}from"./all-ceaf9817.js"
import{a as Ie}from"./allthen-2719c129.js"
import{d as Re,g as Oe}from"./getGroupStats-f762db17.js"
import{g as Fe}from"./getMercStats-7ccd5343.js"
import{g as _e}from"./getProfile-6da1b876.js"
import{g as qe}from"./getMembrList-d7f57e87.js"
import{h as Ye}from"./hideElement-7486432a.js"
import{n as Ke}from"./numberIsNaN-2f104aa2.js"
import{r as ze}from"./reduceBuffArray-4540efb2.js"
import{r as Ue}from"./rnd-b26142cd.js"
import{h as Qe}from"./hasClasses-28ee19c6.js"
import{v as We}from"./valueText-cde56b68.js"
import{g as Je}from"./guild-046ae9f9.js"
import{g as Ze,a as Xe}from"./getTitanString-caa19ea3.js"
import{p as et}from"./padZ-65ad9136.js"
import{c as tt}from"./createTable-4c650454.js"
import{t as at}from"./testQuant-4a4612db.js"
import{g as nt}from"./groupViewStats-d0332725.js"
import{m as rt}from"./myStats-c4e7b0cc.js"
import{a as ot}from"./huntingBuffs-d4e67bdf.js"
import{b as it}from"./simpleCheckbox-0c10ca3c.js"
import{b as st}from"./bitwiseAnd-66d656b9.js"
import{s as ut}from"./shouldBeArray-42b75ace.js"
import"./getBuff-7461d500.js"
...
Bt.className=function(e){return Et[e]||"fshGreen"}(a),n(a,Gt)}function Pt(e,t,a){t||a?jt(e,t):Bt&&ge(Bt,!0)}function It(e){return 0===e.type}function Rt(e){return ve({textContent:e})}let Ot,Ft,_t,qt,Yt,Kt,zt,Ut,Qt,Wt
function Jt(e,t){Ot?ge(Ot,!1):function(e,t){Ot=e.children[5],n("Teleport Cooldown: ",Ot),Ft=Rt(t.toString()),r(Ot,Ft)}(e,t)}function Zt(){const e=Math.max(Math.ceil((_t-Date.now())/1e3),0)
n(e,Ft),e>0&&setTimeout(Zt,500)}function Xt(e,t){t?Jt(e,t):Ot&&ge(Ot,!0)}function ea(){qt=Nt("Death Dealer"),Yt=Nt("Doubler"),Kt=Nt("Counter Attack"),zt=Nt("Summon Shield Imp"),Ut=function(){const e=GameData.player().teleportCooldown
...
const e=yt([qt,Yt,Kt,zt,Ut,Qt])
e&&(Pt(e,zt,qt),$t(e,qt,Qt,Wt),At(e,qt,Wt),wt(e,Kt),Ct(e,Yt),Xt(e,Ut))}function aa(e,t){var a
a=t.player.teleportCooldown,Ft&&(_t=Date.now()+1e3*a,Zt())}const na=["NORMAL","CHAMPION","ELITE","SUPER ELITE","TITAN","LEGENDARY"]
let ra=!1
...
return $a=Rt(Ea(GameData.realm().minlevel)),r(e,$a),e}()),r(a,function(){const e=t({textContent:"Your Lvl: "})
return Sa=Rt(Ea(GameData.player().level)),r(e,Sa),e}()),r(e,a)}function Pa(e,t,a){const n=Be({className:`fshCurveEle fshCurveBtn fshPoint tip-static ${e}`,dataset:{tipped:t}})
...
xa=Ma({prefVal:a,checkId:"fshHuntCheck",onClass:"huntOn",onTip:"Hunting mode is ON",offClass:"huntOff",offTip:"Hunting mode is OFF",worldName:t})}(Va)}const Ra=[[e=>e===Ta,function(){d("playNewMessageSound",!y("playNewMessageSound"))}],[e=>e===xa,function(){e.huntingMode=!e.huntingMode,d("huntingMode",e.huntingMode)}]],Oa=[[e=>e===Na,function(e){V(e),GameData.doAction(12,401,{},0)}],[e=>e===Ha,function(){je(Ae())}],[e=>e===Ba,function(){window.open(`${S+N}map`,"fsMap")}],[e=>e===Ga,function(){const e=GameData.realm()
window.open(`${H}realms${N}view&realm_id=${e.id}`,"mapUfsg")}]]
function Fa(){Va||(Va=t({className:"fshCurveContainer",id:"fshWorldButtonContainer"}),Ia(),s(Va,Ge(Oa)),h(Va,"change",Ge(Ra)),Te(Va,a("worldCoord")))}function _a(e,t){$a&&t.b.minlevel&&(Da(),n(t.b.minlevel,$a))}function qa(e,t){Sa&&n(t.b,Sa)}function Ya(e){return!e||!e.response||!e.response.data}let Ka,za,Ua,Qa,Wa,Ja,Za,Xa,en,tn,an,nn,rn,on,sn,un,ln,cn,fn,dn,mn,hn,pn,bn,gn,vn,yn,kn,wn,Ln,Cn,Dn,An,Mn,Vn
function $n(e){return e.player_name}function Sn(e){!function(e){Qa=e.defenders.map($n)}(e),Ka?B("",Ka):Ka=t({className:"body"}),function(e){za=t({className:"fshFloatLeft fshRelicLeftDiv"}),r(Ka,za),e.is_owner&&r(za,Re(Qa)),Ua=Be({className:"custombutton",textContent:"Fetch Stats"}),r(za,Ua)}(e)
const n=a("dialog-relic")
r(n,Ka)}const Nn=[e=>"lastUpdate"!==e,e=>!Qa.includes(e),e=>Wa[e].last_login,e=>Number(Wa[e].last_login)<Ja,e=>Number(Wa[e].last_login)>Za,e=>Wa[e].level<400||Wa[e].level>421,e=>Wa[e].level<441||Wa[e].level>450]
function Hn(e,t){return t(e)}function Bn(e){return Nn.every(o(Hn,e))}function Gn(e){return`<a href="${T}${Wa[e].id}">${e}</a>`}function Tn(e){Wa=e,Ja=x-120,Za=x-604800
const t=G(Wa).filter(Bn).map(Gn)
i(Ka,`<div class="fshFloatLeft fshRelicLowDiv"><table class="relicT"><thead><tr><th>${t.length.toString()} Offline guild members not at relic:</th></tr></thead><tbody><tr><td>${t.join(" ")}</td></tr></tbody></table></div>`)}function xn(e){Ye(Ua)
...
r(Ka,o),Xa=a("relicCount"),en=a("LDPercentage"),tn=a("LDCloaked"),an=a("attackValue"),nn=a("attackValueBuffed"),rn=a("defenseValue"),on=a("defenseValueBuffed"),sn=a("armorValue"),un=a("armorValueBuffed"),ln=a("damageValue"),cn=a("damageValueBuffed"),fn=a("hpValue"),dn=a("hpValueBuffed"),mn=a("defendersCloaked"),hn=a("defendersProcessed")
...
r(Ka,s),pn=a("DC225"),bn=a("DC175"),gn=a("GroupAttack"),vn=a("GroupAttackBuffed"),yn=a("GroupDefense"),kn=a("GroupDefenseBuffed"),wn=a("GroupArmor"),Ln=a("GroupArmorBuffed"),Cn=a("GroupDamage"),Dn=a("GroupDamageBuffed"),An=a("GroupHP"),Mn=a("GroupHPBuffed")}let En
function jn(e){const t=E(e),a=j('#pCC img[src*="/relics/"]',t).length
var r
n(a,Xa),En=1===(r=a)?1.5:ke(1-r/10,2),n(`${String(100*En)}%`,en)}function Pn(e,t){return e>10*t||e<t?e:10*t}const In=[["levelValue","level"],["attackValue","attack"],["attackBonus","bonus_attack"],["defenseValue","defense"],["defenseBonus","bonus_defense"],["armorValue","armor"],["armorBonus","bonus_armor"],["damageValue","damage"],["damageBonus","bonus_damage"],["hpValue","hp"],["hpBonus","bonus_hp"],["killStreakValue","killstreak"]]
function Rn(e,t,a){e[a[0]]=Number(t[a[1]])}const On=[["counterAttackLevel","Counter Attack"],["doublerLevel","Doubler"],["deathDealerLevel","Death Dealer"],["darkCurseLevel","Dark Curse"],["holyFlameLevel","Holy Flame"],["constitutionLevel","Constitution"],["sanctuaryLevel","Sanctuary"],["flinchLevel","Flinch"],["nightmareVisageLevel","Nightmare Visage"],["superEliteSlayerLevel","Super Elite Slayer"],["fortitudeLevel","Fortitude"],["chiStrikeLevel","Chi Strike"],["terrorizeLevel","Terrorize"],["barricadeLevel","Barricade"],["reignOfTerrorLevel","Reign Of Terror"],["anchoredLevel","Anchored"],["severeConditionLevel","Severe Condition"],["entrenchLevel","Entrench"],["cloakLevel","Cloak"]]
function Fn(e,t,a){e[a[0]]=t[a[1]]||0}function _n(e){if(!e)return
const t=ze(e._skills),a={}
return function(e,t){In.forEach(o(Rn,e,t))}(a,e),function(e,t){On.forEach(o(Fn,e,t))}(a,t),a.superEliteSlayerMultiplier=ke(.002*a.superEliteSlayerLevel,2),Ke(a.armorValue)&&function(e){e.attackValue=Pn(e.attackBonus,e.levelValue),e.defenseValue=Pn(e.defenseBonus,e.levelValue),e.armorValue=Pn(e.armorBonus,e.levelValue),e.damageValue=Pn(e.damageBonus,e.levelValue),e.hpValue=e.hpBonus}(a),a}let qn,Yn,Kn,zn,Un,Qn,Wn,Jn,Zn,Xn,er,tr,ar,nr
function rr(e){return Math.round(e*En)}function or(){Mt(qn,an),Mt(Kn,rn),Mt(zn,sn),Mt(Un,ln),Mt(Wn,fn),n(Jn,mn),Zn+=1,n(Zn,hn)}function ir(e){const t=function(e){return Math.ceil(er.attack*(.0025*P(e["Nightmare Visage"],0)))}(e)
er.attack-=t,function(){const e=Math.ceil(er.attack*Xn.flinchLevel*.001)
Mt(er.attack-e,vn)}()
...
!function(e){Mt(er.hp+e,Mn)}(n),function(e,t){const a=Math.ceil((er.hp+t)*P(e["Chi Strike"],0)*.001),n=Math.ceil(er.damage*Xn.terrorizeLevel*.001)
...
ir(e),function(e){const t=Math.ceil(Yn*P(e.Flinch,0)*.001)
Mt(Yn-t,nn)}(e),function(e){const t=Math.ceil(Qn*P(e.Terrorize,0)*.001)
Mt(Qn-t,cn)}(e),n("Done.",Vn)}function ur(){n("Processing defending guild stats ... ",Vn),qn+=rr(Xn.attackValue),Kn+=rr(Xn.defenseValue),zn+=rr(Xn.armorValue),Un+=rr(Xn.damageValue),Wn+=rr(Xn.hpValue),or()
const e=Math.ceil(qn*(.0025*Xn.nightmareVisageLevel))
!function(e){Yn=qn-e,Mt(Yn,nn)}(e)
const t=Math.ceil(Kn*(1+.001*Xn.constitutionLevel))
!function(e,t){const a=t+e
Mt(a,on),Mt(Math.ceil(.55*a),pn),Mt(Math.ceil(.65*a),bn)}(e,t),Mt(zn+Math.floor(zn*Xn.sanctuaryLevel*.001),un)
const a=Wn+function(e){return Math.ceil(e*Xn.fortitudeLevel*.001)}(t)
Mt(a,dn),function(e){Qn=Un+Math.ceil(e*Xn.chiStrikeLevel*.001),Mt(Qn)}(a),0!==Xn.cloakLevel&&n("Yes",tn),GameData.player().hasGroup&&er?sr():n("Done.",Vn)}function lr(e){const t=_n(e)
qn+=Math.round(t.attackValue*I),Kn+=Math.round(t.defenseValue*I),zn+=Math.round(t.armorValue*I),Un+=Math.round(t.damageValue*I),Wn+=Math.round(t.hpValue*I),0!==t.cloakLevel&&(Jn+=1),or()}function cr(e){Xn=_n(e)}function fr(e){er=e}function dr(e){tr=e}function mr(e){n(e.message,Vn)}function hr(e){const t=E(e),a=b('#pCC a[href*="confirmDisband"]',t)
if(!a)return
const n=function(e){const t=e.previousElementSibling.href,a=[Oe(t).then(fr)]
...
mo=t({className:"fshActionBox titanInfo"}),ro=ve(),oo=ve(),io=ve(),so=ve(),uo=ve(),lo=ve(),co=ve(),fo=tt({className:"fshCenter"}),Do(),Ur(fo,[[[[2,to,!0],[4,no,!0]]],[[[2,Mo()],[4,io]]],[[[2,Wr,!0],[4,Vo(so)]],!0],[[[2,ao,!0],[4,Vo(uo)]],!0],[[[2,eo,!0],[4,lo]],!0],[[[6,co]]],[[[2,Zr,!0],[2,Jr,!0],[2,Xr,!0]]]]),r(mo,fo),r(e,mo)}}function Ho(e){return e<=0?'<span class="fshGreen cooldown">No active cooldown</span>':`<span class="fshMaroon cooldown">Cooldown until: ${function(e){const t=new Date(ie+1e3*e)
return`${et(t.getHours())}:${et(t.getMinutes())} ${et(t.getDate())}/${oe[t.getMonth()]}/${t.getFullYear()}`}(e)}</span>`}function Bo(e){return we(Ze(e.max_hp-e.current_hp,e.kills),2)}function Go(e){return we(100*e.kills/e.max_hp,2)}function To(e){[[e.current_hp,ro],[e.max_hp,oo],[e.kills,io],[Bo(e),so],[Go(e),uo]].forEach((([e,t])=>{n(e,t)})),B(function(e){return Xe(e.kills,e.max_hp,e.current_hp)}(e),lo),B(Ho(e.cooldown),co)}function xo(e,t){return[[[2,Rt(t.player.name)],[2,Rt(t.kills.toString())],[2,Rt(`${we(100*t.kills/e.kills,2)}%`)]]]}function Eo(e){return e.realm&&e.creature.base_id===ho&&e.realm===Qr}function jo(e){const t=e.find(Eo)
t&&(To(t),function(e){if(Ao(),!e.contributors)return
const t=e.contributors.map(o(xo,e))
Ur(fo,t)}(t))}function Po(t){return e.showTitanInfo&&Me(t)&&t.some(So)}function Io(e,t){(function(e){return e&&e.s&&Me(e.r)})(t)&&(jo(t.r),Po(GameData.realm().dynamic)?po=window.setTimeout(e,3e4):$o())}function Ro(){re(qr).then(o(Io,Ro))}function Oo(e){po&&(window.clearTimeout(po),po=null),Po(e)?(No(),Ro()):$o()}function Fo(e){var t
e.dynamic&&(t=e.name,Qr=t,Oo(e.dynamic))}function _o(e,t){(function(e){return e.realm&&e.realm.name})(t)&&Fo(t.realm)}function qo(e){const t=e.response.response,a=e.response.msg
let n
...
i(Lo,`${n}<br>`)}function Yo(){GameData.doAction(14,3,{id:bo.id,item_id:bo.itemId},0),vo.close()}function Ko(){const e=at(ko.value)
if(!e)return
const t=[]
for(let a=1;a<e;a+=1)t.push(Lr({a:14,d:0,id:bo.id,item_id:bo.itemId}).then(qo))
Ie(t,Yo)}function zo(){yo?n("",Lo):(yo=t({className:"fshClear",textContent:"Select how many to quick-buy:"}),ko=xe({id:"buyAmount",className:"fshNumberInput",min:1,max:99,value:1,type:"number"}),r(yo,ko),wo=Be({textContent:"Quick-buy"}),s(wo,Ko),r(yo,wo),Lo=t(),r(yo,Lo),r(go,yo))}function Uo(e,t){bo=t,go=go||a("shopDialogConfirm"),go&&(vo=vo||$(go).data("hcsWorldDialogShopConfirm"),vo&&zo())}function Qo(e){Co[e.name]?Co[e.name].seen&&(Co[e.name].seen+=1):(Co[e.name]={seen:1},function(e,t){t.creature_class=e.creature_class,t.image_id=e.image_id,t.level=Number(e.level),t.type=e.type}(e,Co[e.name]))}function Wo(e,t,a){return t?e(t,a):a}function Jo(e,t){const a=e||{}
return a.min=Wo(Math.min,a.min,t),a.max=Wo(Math.max,a.max,t),a}const Zo=["attack","armor","damage","defense","hp"]
function Xo(e,t,a){const n=Jo(t[a],Number(e[a]));(function(e,t){return!e||e.min!==t.min||e.max!==t.max})(t[a],n)&&(t[a]=n)}function ei(e,t){e[t.name]=Jo(e[t.name],Number(t.value))}function ti(e){Co||(Co={}),Qo(e),function(e,t){Zo.forEach(o(Xo,e,t))}(e,Co[e.name]),function(e,t){(function(e){return e.enhancements&&e.enhancements.length>0})(e)&&(t.enhancements=t.enhancements||{},e.enhancements.forEach(o(ei,t.enhancements)))}(e,Co[e.name]),$e("fsh_monsterLog",Co)}function ai(e){Co=e||{}}const ni=[]
function ri(t){var a
Ya(t)||(g("NewMap","MonsterLog"),a=t.response.data,e.showMonsterLog&&ti(a))}function oi(e,t){return e.id===t.id}function ii(e,t){6!==e.type||function(e){if(ni.find(o(oi,e.data)))return!0
...
const a=o(fs,t)
$.subscribe(l,a),e.showBuffs&&window.initialGameData&&a(null,{b:window.initialGameData.player.buffs})}(t),Ei=y("hidePlayerActions"),$.subscribe(D,ns),ns()},function(){_(),q&&wr()},function(){$.subscribe(ce,Xi)},function(){Ds.forEach(As)},function(){y("enableCreatureColoring")&&r(document.body,Se("#actionList .creature-1 {color: green;}\n#actionList .creature-2 {color: yellow;}\n#actionList .creature-3 {color: red;}"))},function(){$.subscribe(D,ka),ka(),function(){const e=GameData.doAction
GameData.doAction=Ca(e)}()},function(){Ve("fsh_monsterLog").then(ai),$.subscribe("-1-success.action-response 4-success.action-response 5-success.action-response 25-success.action-response",si),si()},function(){$.subscribe(me,Ms)},function(){y("keepLogs")&&Ve("fsh_combatLog").then(ga)},function(){window.initialGameData&&_o(0,window.initialGameData),$.subscribe(`${se} ${ue}`,_o)},function(){$.subscribe(le,Uo)},function(){$.subscribe(R,vr)},function(){$("#messageCenter").worldMessageCenter({offset:"0 60"})},function(){V("#mapTooltip")},function(){Fa(),$.subscribe(A,_a),$.subscribe(M,qa)},function(){ta(),$.subscribe(`${l} ${c}`,ta),$.subscribe(f,aa)},function(){s(a("buffList"),Vs)},function(){h(a("actionList"),"mouseover",_r)},function(){const e=m("body")[0]
h(e,"keydown",ua),h(e,"keyup",la)}]
function Ss(){He($s)}export default Ss
//# sourceMappingURL=newMap-86a32bca.js.map
