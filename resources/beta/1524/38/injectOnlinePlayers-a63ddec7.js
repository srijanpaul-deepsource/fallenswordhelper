import{aP as e,t as n,I as t,by as a,a7 as s,a5 as l,_ as i,ag as r,y as o,o as f,f as c,v as u}from"./calfSystem-71efcdd9.js"
import{c as h}from"./currentGuildId-feae79ca.js"
import{i as d}from"./intValue-ba9b9e5a.js"
import{a as p,g as v}from"./levelHighlight-b98e27c1.js"
import{n as m}from"./numberIsNaN-30cde299.js"
import{l as g,p as y}from"./lvlTests-046caab1.js"
import{l as M}from"./loadDataTables-6ada905c.js"
import{o as L}from"./onlinePlayersPage-ba873c67.js"
import{g as b,s as P}from"./idb-3de49256.js"
...
return s-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),b("fsh_onlinePlayers").then(H),f(_[0],B),c(_[0],"keyup",k)}function F(e){o()||(_=e?$(e):$("#pCC"),M().then(E))}export default F
//# sourceMappingURL=injectOnlinePlayers-a63ddec7.js.map
