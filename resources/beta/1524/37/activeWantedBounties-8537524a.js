import{u as e,C as t,D as n,bH as s,I as r,U as a,_ as i,z as o,q as c,H as l,c as u,m as b,bL as d,bJ as f,B as p,bQ as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-cb2a6f39.js"
import{f as $}from"./functionPasses-70dc3f56.js"
import{s as w}from"./shouldBeArray-9beca0ea.js"
import{i as N}from"./insertElementAfterBegin-b0467547.js"
import{c as x}from"./createSpan-e4b93b95.js"
...
A.bounty.push(n)}}(e)}function P(){return A&&a-A.lastUpdate>H||T&&a-T.lastUpdate>H}function U(e){const t=e[6]
...
function J(){return b({className:"minibox"})}function K(){f("bountyList",A),p("",q)
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=a,n&&M(n),j=!0}(e),K())}function V(e){const t=L(e)
F(t),u.enableWantedList&&(_(t),D<I?R(D+1).then(V):Q())}const Y=[()=>!A,()=>!T,()=>S]
function Z(e,t){A=s("bountyList"),T=s("wantedList"),H=r("bountyListRefreshTime"),S=r("bwNeedsRefresh"),S||P()&&(S=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,W=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,Q()),e&&(A.isRefreshed=!1,K())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),Z(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(f("wantedList",null),Z(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=J(),N(d,G)),u.enableActiveBountyList&&(q=J(),N(d,q)),q&&v(q,ee),G&&v(G,ee),Z(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-8537524a.js.map
