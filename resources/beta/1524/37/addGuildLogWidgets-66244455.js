import{I as s,g as e,p as a,au as n,ax as r,N as o,C as i,B as c}from"./calfSystem-cb2a6f39.js"
import{d as t}from"./dataRows-2cfb2c52.js"
import{p as l}from"./playerName-809cf32e.js"
import{s as f}from"./searchPlayerHref-50921e40.js"
...
a[1]=f(n),c(a.join("'"),s.cells[2]),function(s,e,a){e||a===l()||($(s).find("td").removeClass("row").css("font-size","xx-small"),s.style.color="gray")}(s,e,n)}function h(s){m(s),function(s){const e=i(s.cells[2]),a=e.includes("has invited the player");("'"===e.charAt(0)||a)&&u(s,a)}(s)}function y(){const s=e("td",a).find(n("Message"))
if(!s)return
...
//# sourceMappingURL=addGuildLogWidgets-66244455.js.map
