import{x as n,q as o,$ as a,aa as t,z as i,ar as s,c,j as f,I as p,at as m,av as u,a7 as e,_ as l}from"./calfSystem-4a40365f.js"
...
o>0?(l(m,!1),l(u,e+1e3*o)):x()}(n.potions)}function j(n){n.s&&_(n.r)}function v(){const n=p(u)
n&&e<n||a(r).then(j)}function y(){"composing"!==c.cmd&&f()&&(p(m)?g():v())}export default y
//# sourceMappingURL=injectComposeAlert-0d83a1cd.js.map
