...
import{x as n,$ as e,y as s,g as i,p as a,Q as r,t as o,k as c,m as f,h as m,o as u,e as l,l as d,B as p,z as h}from"./calfSystem-4a40365f.js"
import{c as k}from"./createInput-7fa974b4.js"
import{c as g}from"./createLabel-7a009fa9.js"
import{c as b}from"./createUl-3aa80487.js"
import{a as j}from"./allthen-a8900f54.js"
import{i as v}from"./indexAjaxJson-6d511c0e.js"
import{i as x}from"./insertElementBefore-42a90ba9.js"
import{i as T}from"./isArray-c961431c.js"
import{j as y,o as B}from"./jsonFail-610466c3.js"
...
n&&p("",n)}function H(t,n){y(n,t)||T(n.r)&&function(t,n){n.r.forEach(C),B(`${n.r.length.toString()} item(s) taken.`,t)}(t,n)}function N(t,n){var s;(s=n,e(M,L,s)).then(o(H,t))}function S(n,e,s){d("fshBls",s.target)&&function(n,e,s){const i=s.dataset.id,{invIds:a}=n[i]
...
!function(t,n){l(n).forEach(o(A,t))}(s,t),m(n,s),u(s,o(S,t,e))}function F(t){const n=f({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),e=function(t){const n=f(),e=b()
...
//# sourceMappingURL=mailbox-296a42bd.js.map
