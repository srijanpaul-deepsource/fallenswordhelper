import{N as o,t as n,o as t,a5 as e,z as c,f as r,_ as a,aA as f}from"./calfSystem-4a40365f.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],T(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function L(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(j)}function A(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(L,o))}(e.prefName),o(e.theTable.rows).forEach(n(b,e)),t(e.theTable,N)}export{A as c}
//# sourceMappingURL=collapse-3a04de76.js.map
