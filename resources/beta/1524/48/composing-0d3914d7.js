import{r as e,B as t,t as n,aB as s,ae as o,_ as a,aI as i,D as c,m as r,P as l,S as m,i as p,aJ as u,E as d,h as f,o as g,p as h,A as b,c as v,aK as C,C as S,a9 as E,j,I as k,z as N,M as x}from"./calfSystem-8af1dca2.js"
import{r as A,g as y}from"./rnd-9a282b09.js"
import{p as B,s as I}from"./pubsub-df1bfb19.js"
import{c as $}from"./createInput-75b7145b.js"
import{c as L}from"./createTable-0267c13e.js"
import{g as q}from"./getArrayByClassName-11de01ae.js"
import{i as F}from"./insertElementAfter-62f0d2ad.js"
import{i as P}from"./insertHtmlAfterEnd-e22ce08b.js"
import{i as T}from"./insertElementBefore-5adb1609.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],$({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function R(e,t,s,o){return e.reduce(n(K,o),s.insertRow(-1)),s}function G(e){return[e.value,e.text]}function O(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return D(o,s),e.reduce(n(R,t,s),o)}(d("#composing-template-multi option").map(G),t,s)
f(e,o),g(h,J),I("quickcreate",n(H,o))}function U(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-0d3914d7.js.map
