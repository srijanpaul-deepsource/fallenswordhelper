import{a$ as n,t,I as e,bF as a,a9 as s,a5 as l,_ as i,av as r,y as o,o as f,f as c,v as u}from"./calfSystem-8af1dca2.js"
import{c as d}from"./currentGuildId-ae75dbfc.js"
import{i as h}from"./intValue-9eb5015a.js"
import{a as p,g as v}from"./levelHighlight-823ca554.js"
import{n as m}from"./numberIsNaN-68797c81.js"
import{l as g,p as y}from"./lvlTests-87d82dc1.js"
import{l as M}from"./loadDataTables-8a5539c9.js"
import{o as L}from"./onlinePlayersPage-9a8622c6.js"
import{g as P,s as x}from"./idb-30d71a28.js"
...
for(let t=2;t<=G;t+=1)L(t).then(n)}function F(n){$("#fshOutput",_).append(n)}function V(n){F(` ${z+1}`)
const e=u(n),a=$("#pCC input.custominput",e).first()
!function(n,e){const a=e.attr("value")
$('#pCC img[src$="/world/icon_action_view.png',n).parent().parent().parent().each(t(S,a))}(e,a),z+=1,1===z&&A(V,a),z===G&&(x("fsh_onlinePlayers",D),H(D))}function W(n){"fshRefresh"===n.target.id&&($("#fshRefresh",_).hide(),z=0,D={},L(1).then(V),i("lastOnlineCheck",s),F("Parsing online players...")),"fshReset"===n.target.id&&function(n){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",n).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",n).val(r.onlinePlayerMaxLvl),O()}(_)}function B(){_.html(`<span><b>Online Players</b></span>${function(){const n=e("lastOnlineCheck")
return s-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),P("fsh_onlinePlayers").then(H),f(_[0],W),c(_[0],"keyup",k)}function E(n){o()||(_=n?$(n):$("#pCC"),M().then(B))}export default E
//# sourceMappingURL=injectOnlinePlayers-a0c22921.js.map
