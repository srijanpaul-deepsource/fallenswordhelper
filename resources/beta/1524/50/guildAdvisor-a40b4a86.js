import{n as t,u as s,v as e,D as a,as as n,H as r,$ as i,m as l,h as c,a as o,t as d,a4 as u,I as f,aw as m,ax as p,B as v,i as h,y as b,b as g,p as j,c as y,M as C,ab as A,C as B}from"./calfSystem-617f9a5d.js"
import{g as w}from"./getMembrList-331ed151.js"
import{a as D}from"./addCommas-b66fde4c.js"
import{a as S}from"./allthen-2ff5fddb.js"
import{g as k}from"./guild-9563808a.js"
import{i as T}from"./intValue-76dfee09.js"
import{c as x}from"./createTable-6eb5d32d.js"
...
q(t,function(t){return E({innerHTML:`<tr><td class="fshRight" colspan="3">Total: </td>${t.slice(1).reduce(Y,t[0].stats).map(D).reduce(Z,"")}</tr>`})}(a),a.map(d(tt,s)))}function et(t){const s=f("betaOptIn")
...
const t=g("table",j)[1]
t&&M().then((()=>function(t){"weekly"===y.subcmd2?et(t):w(!1).then(d(rt,t))}(t)))}export default it
//# sourceMappingURL=guildAdvisor-a40b4a86.js.map
