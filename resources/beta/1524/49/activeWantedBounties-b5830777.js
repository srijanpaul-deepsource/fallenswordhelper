import{u as e,C as t,D as n,bN as s,I as a,U as r,_ as i,z as o,q as c,H as l,c as u,m as d,bR as b,bP as f,B as p,bW as h,h as m,i as y,v as L,y as g,o as v}from"./calfSystem-42f137cb.js"
import{f as $}from"./functionPasses-dfd0a9eb.js"
import{s as w}from"./shouldBeArray-0378ee92.js"
import{i as N}from"./insertElementAfterBegin-c46ad05b.js"
import{c as x}from"./createSpan-54af063c.js"
...
function K(){return d({className:"minibox"})}function _(){f("bountyList",A),p("",q)
...
function Z(e,t){A=s("bountyList"),T=s("wantedList"),W=a("bountyListRefreshTime"),P=a("bwNeedsRefresh"),P||M()&&(P=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,S=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,_())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),Z(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(f("wantedList",null),Z(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(G=K(),N(b,G)),u.enableActiveBountyList&&(q=K(),N(b,q)),q&&v(q,ee),G&&v(G,ee),Z(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-b5830777.js.map
