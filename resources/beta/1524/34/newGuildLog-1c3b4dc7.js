import{a as t}from"./addGuildLogWidgets-b589c9a7.js"
import{a as e}from"./addLogColoring-14811dca.js"
import{a as s}from"./all-3246a95f.js"
import{u as i,t as n,bp as a,bq as o,x as d,A as c,p as r,o as h,g as l,z as f,y as u,H as p,v as m,C as g,B as b,J as k,i as y,G as w}from"./calfSystem-dfa26790.js"
import{c as j}from"./createTable-daece6d2.js"
import{e as L}from"./eventHandler5-2f9b746a.js"
import{f as R}from"./functionPasses-055e6e36.js"
import{h as N}from"./hideElement-7b9c883f.js"
import{p as G}from"./parseDateAsTimestamp-5cae868a.js"
import{s as v}from"./selfIdIs-54e4a3f8.js"
import{t as x}from"./toggleForce-f376374b.js"
import{g as H,s as T}from"./idb-93f11a94.js"
import"./dataRows-fbdbdd02.js"
import"./playerName-b7be03d7.js"
import"./searchPlayerHref-b91c068c.js"
...
function S(t,e){return a(e)?t.includes(e):e.test(t)}function A(t,e){return e.some(n(S,t))}function C(t){const e=I.findIndex(n(A,t))
...
for(let t=1;t<s;t+=2){const s=e.rows[t],i=w(s.cells[1]),n=G(i),a=s.cells[2].innerHTML
if(W(n,a)){V=!1
break}Q.push([100*q+t,n,i,a,C(a)])}}(t)}function K(t){!function(t){_=m(t)
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=J.checks[t.getAttribute("item")]}function at(){l("input",D).forEach(nt),Z()}function ot(t,e){return t[0]-e[0]}function dt(){V&&Q.sort(ot),f("Loading complete.",M),J.log=Q.filter(n(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){U=j({id:"fshInjectHere",className:"width_full"}),y(U,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const s=u("fshInjectHere")
r.replaceChild(U,s),e("myGuildLog",1),t()}()}function ct(t){K(t),function(){const t=[]
...
J.checks[e]=!J.checks[e],Z(),Q.forEach(n(rt,e,!J.checks[e]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){J.checks=O.slice(0),at(),Q.forEach(ft)}function pt(t){N(t[5]),N(t[6])}function mt(){J.checks=B.slice(0),at(),Q.forEach(pt)}function gt(){J.log=!1,Z(),f("Loading Page 1 ...",M),Q=[],V=!0,c("",u("fshInjectHere")),P(1).then(ct)}function bt(t){!function(t){J=t||J,J.checks=J.checks||O.slice(0)}(t),c(E,r),D=u("fshNewGuildLog"),M=u("fshOutput"),h(D,L([[t=>"INPUT"===t.tagName,ht],[v("fshAll"),ut],[v("fshNone"),mt],[v("rfsh"),gt]])),at(),F=Number(p("newGuildLogHistoryPages")),$=F,P(1).then(ct)}function kt(){d()||H("fsh_guildLog").then(bt)}export default kt
//# sourceMappingURL=newGuildLog-1c3b4dc7.js.map
